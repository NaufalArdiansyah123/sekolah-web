...
<div class="announcement-container">
    ...
    <div class="form-container">
        ...
        <form action="{{ route('admin.announcements.update', $announcement->id) }}" method="POST" id="announcementForm" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                    ...
                    <div class="form-section">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('judul', $announcement->title) }}" 
                                   required
                                   maxlength="200"
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload-container">
                                ...
                                <input type="hidden" 
                                       name="gambar" 
                                       id="gambar" 
                                       value="{{ old('gambar', $announcement->image ?? $announcement->featured_image) }}">
                            </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="info-panel">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value">{{ $announcement->slug }}</span>
                            </div>
                            <div class="info-item">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori" id="kategori" class="form-select @error('kategori') is-invalid @enderror" required>
                                ...
                                <option value="akademik" {{ old('kategori', $announcement->category) === 'akademik' ? 'selected' : '' }}>Academic</option>
                                <option value="kegiatan" {{ old('kategori', $announcement->category) === 'kegiatan' ? 'selected' : '' }}>Activities</option>
                                <option value="administrasi" {{ old('kategori', $announcement->category) === 'administrasi' ? 'selected' : '' }}>Administration</option>
                                <option value="umum" {{ old('kategori', $announcement->category) === 'umum' ? 'selected' : '' }}>General</option>
                            </select>
                            @error('kategori')
                                <div class="invalid-feedback">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('penulis', $announcement->author) }}" 
                                   required
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" 
                                   ...
                                   class="form-input @error('tanggal_publikasi') is-invalid @enderror" 
                                   value="{{ old('tanggal_publikasi', $announcement->published_at ? $announcement->published_at->format('Y-m-d\TH:i') : '') }}">
