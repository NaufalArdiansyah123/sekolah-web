...
<div class="container-fluid">
    ...
    <div class="form-container">
        ...
        <form class="form-body" action="{{ route('admin.posts.blog.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Masukkan judul yang menarik dan deskriptif" required value="{{ old('title') }}">
                    @error('title')
