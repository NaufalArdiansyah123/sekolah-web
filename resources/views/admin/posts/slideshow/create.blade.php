...
@section('content')
<div class="slideshow-create-page">
    <div class="slideshow-container">
        ...
        <div class="page-header">
            <div class="header-content">
                ...
                <div>
                    <h1 class="page-title">Create Slideshow</h1>
                    <p class="page-subtitle">Add a new slideshow for the homepage</p>
                </div>
            </div>
        </div>
                ...
                <div class="form-content">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" 
                                  ...
                                  placeholder="Enter slideshow description (optional)">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <label for="image" class="form-label">
                            Slideshow Image <span class="required">*</span>
                        </label>
                        <div id="upload-area" class="upload-area">
                            ...
                            <input id="image" name="image" type="file" class="hidden" accept="image/jpeg,image/png,image/jpg,image/gif" required>
                        </div>
                                ...
                                <div id="slideshow-preview" class="preview-content">
                                    <div class="slideshow-preview">
                                        ...
                                        <div class="slideshow-overlay">
                                            <div class="slideshow-title" id="slideshow-title-preview">Sample Slideshow Title</div>
                                            <div class="slideshow-description" id="slideshow-desc-preview">This is how your slideshow will appear on the homepage with title and description overlay.</div>
                                        </div>
                                    ...
                                    <div class="mobile-preview">
                                        <div class="mobile-screen">
                                            ...
                                            <div class="mobile-content">
                                                <div class="mobile-title" id="mobile-title-preview">Sample Title</div>
                                                <div class="mobile-description" id="mobile-desc-preview">This is how your slideshow will look on mobile devices.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="form-actions">
                    ...
                    <div style="display: flex; gap: 0.75rem;">
                        ...
                        <button type="submit" id="submit-btn" class="btn btn-primary">
                            <span id="submit-text">Save Slideshow</span>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM Content Loaded - Initializing slideshow create page');
    ...
    function handleImageSelect(file) {
        ...
        fileInfo.textContent = `Uploaded: ${file.name} (${fileSize} MB)`;
        ...
        reader.onload = function(e) {
            ...
            img.onload = function() {
                ...
                fileInfo.innerHTML = `Uploaded: ${file.name} (${fileSize} MB)<br>
                    <span style="font-size: 0.8rem; color: var(--text-tertiary);">Ready for slideshow • ${width}x${height}px</span>`;
            };
            img.src = imageSrc;
        };
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!image) {
            e.preventDefault();
            showAlert('Slideshow image is required.', 'danger');
            resetSubmitButton();
            return;
        }
    ...
    function resetSubmitButton() {
        ...
        submitText.textContent = 'Save Slideshow';
    ...
    function updatePreviewText() {
        const title = titleInput.value.trim() || 'Sample Slideshow Title';
        const description = descriptionInput.value.trim() || 'This is how your slideshow will appear on the homepage with title and description overlay.';
