...
@section('content')
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.posts.agenda.create') }}" class="btn btn-primary">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-number">{{ $agendas->total() }}</div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-number">{{ $agendas->where('status', 'published')->count() }}</div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-number">{{ $agendas->where('event_date', '>=', now())->count() }}</div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-number">{{ $agendas->whereNotNull('location')->count() }}</div>
        ...
        <div class="filter-section">
            ...
            <form method="GET" action="{{ route('admin.posts.agenda') }}">
                <div class="filter-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="period" class="form-input">
                            ...
                            <option value="upcoming" {{ request('period') == 'upcoming' ? 'selected' : '' }}>Mendatang
                            </option>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        @if($agenda->content)
                                            <div class="text-sm text-gray-500 mt-1">
                                                {{ Str::limit(strip_tags($agenda->content), 100) }}
                                            </div>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <div class="text-xs text-gray-400">
                                            {{ $agenda->user->name ?? 'Admin' }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('admin.posts.agenda.show', $agenda->id) }}"
                                            ...
                                            <form method="POST" action="{{ route('admin.posts.agenda.destroy', $agenda->id) }}"
                                                class="inline"
