                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <div class="color-input-wrapper">
                                            <input type="color" 
                                                   ...
                                                   value="{{ old('navbar_bg_color', $settings['navbar_bg_color']->value ?? '#1a202c') }}"
                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <div class="color-input-wrapper">
                                            <input type="color" 
                                                   ...
                                                   value="{{ old('navbar_text_color', $settings['navbar_text_color']->value ?? '#ffffff') }}"
                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <div class="color-input-wrapper">
                                            <input type="color" 
                                                   ...
                                                   value="{{ old('navbar_hover_color', $settings['navbar_hover_color']->value ?? '#3182ce') }}"
                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <div class="color-input-wrapper">
                                            <input type="color" 
                                                   ...
                                                   value="{{ old('navbar_active_color', $settings['navbar_active_color']->value ?? '#4299e1') }}"
