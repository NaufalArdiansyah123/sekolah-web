...
<div class="extracurricular-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p class="page-subtitle">Buat program ekstrakurikuler baru untuk melibatkan siswa dalam berbagai kegiatan</p>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('admin.extracurriculars.store') }}" method="POST" enctype="multipart/form-data" id="extracurricularForm">
            @csrf
            ...
            <div class="form-body">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group required floating-label">
                        ...
                        @error('coach')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="char-counter" id="coachCounter">0/100</div>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group floating-label">
                        ...
                        @error('jadwal')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="char-counter" id="jadwalCounter">0/100</div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    @error('gambar')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <div class="form-text">Upload gambar untuk mempresentasikan ekstrakurikuler (opsional)</div>
                </div>
            </div>

            <!-- Form Actions -->
            <div class="form-actions">
                <a href="{{ route('admin.extracurriculars.index') }}" class="btn btn-outline">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    resetBtn.addEventListener('click', function() {
        if (confirm('Apakah Anda yakin ingin mereset form? Semua data yang telah diisi akan hilang.')) {
            ...
            counters.forEach(item => {
                const counter = document.getElementById(item.counter);
                if (counter) {
                    counter.textContent = `0/${item.max}`;
                    counter.classList.remove('warning', 'danger');
                }
            });
    ...
    if (!document.querySelector('#create-animations')) {
    ...
    console.log('✅ Extracurricular create form initialized');
});
</script>
