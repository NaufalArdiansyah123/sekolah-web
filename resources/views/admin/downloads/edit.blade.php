...
<div class="container-fluid p-6">
    ...
    <div class="page-header">
        <div class="header-content">
            <h1 class="header-title">
                <i class="fas fa-edit me-3"></i>Edit File Download
            </h1>
            <p class="header-subtitle">Perbarui informasi file download</p>
    ...
    <div class="form-container">
        <form action="{{ route('admin.downloads.update', $download) }}" method="POST" enctype="multipart/form-data" class="upload-form">
            @csrf
            @method('PUT')
            ...
            <div class="current-file-section">
                ...
                <div class="current-file-card">
                    ...
                    <div class="file-details">
                        ...
                        <p>{{ $download->formatted_file_size }} • {{ $download->download_count }} downloads</p>
            ...
            <div class="upload-section">
                <h2 class="section-title">
                    <i class="fas fa-sync-alt me-2"></i>Ganti File (Opsional)
                </h2>
                ...
                <div class="file-upload-area" id="fileUploadArea">
                    <div class="upload-placeholder" id="uploadPlaceholder">
                        ...
                        <h3>Drag & Drop file baru di sini</h3>
                        <p>atau <span class="upload-link">klik untuk memilih file pengganti</span></p>
                        <p class="upload-info">Kosongkan jika tidak ingin mengganti file • Maksimal 10MB</p>
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="4" 
                                  placeholder="Berikan deskripsi singkat tentang file ini...">{{ old('description', $download->description) }}</textarea>
                        @error('description')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" 
                            ...
                            <option value="materi" {{ old('category', $download->category) == 'materi' ? 'selected' : '' }}>
                                📚 Materi Pembelajaran
                            </option>
                            <option value="foto" {{ old('category', $download->category) == 'foto' ? 'selected' : '' }}>
                                📸 Foto & Galeri
                            </option>
                            <option value="video" {{ old('category', $download->category) == 'video' ? 'selected' : '' }}>
                                🎥 Video
                            </option>
                            <option value="dokumen" {{ old('category', $download->category) == 'dokumen' ? 'selected' : '' }}>
                                📄 Dokumen
                            </option>
                            <option value="formulir" {{ old('category', $download->category) == 'formulir' ? 'selected' : '' }}>
                                📋 Formulir
                            </option>
                            <option value="panduan" {{ old('category', $download->category) == 'panduan' ? 'selected' : '' }}>
                                📖 Panduan
                            </option>
                        </select>
                        @error('category')
                        ...
                        <div class="radio-group">
                            <label class="radio-option">
                                <input type="radio" 
                                       name="status" 
                                       value="active" 
                                       {{ old('status', $download->status) == 'active' ? 'checked' : '' }}>
                            ...
                            <label class="radio-option">
                                <input type="radio" 
                                       name="status" 
                                       value="inactive" 
                                       {{ old('status', $download->status) == 'inactive' ? 'checked' : '' }}>
                                <span class="radio-custom"></span>
                                <div class="radio-content">
                    ...
                    <div class="stats-card">
                        <h3>Statistik Download</h3>
                        <div class="stats-grid">
                            <div class="stat-item">
                                <span class="stat-number">{{ $download->download_count }}</span>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('admin.downloads.show', $download) }}" class="btn btn-info btn-lg">
...
<style>
    ...
    .file-preview .file-details h4 {
        font-weight: 600;
        margin-bottom: 0.25rem;
        color: var(--dark);
    }

    .file-preview .file-details p {
        color: var(--gray);
        font-size: 0.875rem;
        margin-bottom: 0.5rem;
    }
