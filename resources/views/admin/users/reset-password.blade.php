...
<div class="reset-password-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p class="page-subtitle">Reset password for user: {{ $user->name }}</p>
        </div>
    ...
    <div class="main-content">
        ...
        <div class="form-container">
            ...
            <form action="{{ route('admin.users.reset-password.store', $user) }}" method="POST" id="resetPasswordForm">
                @csrf
        ...
        <div class="user-info-card">
            ...
            <div style="text-align: left; font-size: 0.875rem; color: var(--text-secondary);">
                ...
                <div style="margin-bottom: 0.5rem;">
                    ...
                    <span style="color: {{ $user->email_verified_at ? '#059669' : '#6b7280' }};">
