...
@section('content')
<style>
    /* Enhanced Dark Mode Compatible Edit Form Styles */
    :root {
        /* Light Mode Colors */
        --bg-primary: #ffffff;
        --bg-secondary: #f8fafc;
    ...
    .form-group.changed .change-indicator {
        display: block;
    }
...
<div class="edit-page">
    <div class="form-container">
        <div class="form-header">
            ...
            <p class="form-subtitle">Perbarui informasi prestasi "{{ $achievement->title }}"</p>
        </div>
        ...
        <form action="{{ route('admin.achievements.update', $achievement) }}" method="POST" enctype="multipart/form-data" id="achievementForm">
            ...
            <div class="form-grid">
                <div class="form-main">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  placeholder="Jelaskan detail prestasi yang diraih..." required>{{ old('description', $achievement->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-help">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('level') is-invalid @enderror" 
                                    ...
                                    @foreach($levels as $key => $value)
                                        <option value="{{ $key }}" {{ old('level', $achievement->level) == $key ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('year') is-invalid @enderror" 
                                       id="year" name="year" value="{{ old('year', $achievement->year) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('organizer') is-invalid @enderror" 
                                       id="organizer" name="organizer" value="{{ old('organizer', $achievement->organizer) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('participant') is-invalid @enderror" 
                                       id="participant" name="participant" value="{{ old('participant', $achievement->participant) }}"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('position') is-invalid @enderror" 
                            ...
                            @foreach($positions as $key => $value)
                                <option value="{{ $key }}" {{ old('position', $achievement->position) == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('additional_info') is-invalid @enderror" 
                                  ...
                                  placeholder="Informasi tambahan tentang prestasi...">{{ old('additional_info', $achievement->additional_info) }}</textarea>
                ...
                <div class="form-sidebar">
                    ...
                    <div class="sidebar-card">
                        ...
                        <img src="{{ asset($achievement->image) }}" alt="{{ $achievement->title }}" class="current-image">
                    </div>
                    @endif
                    ...
                    <div class="sidebar-card">
                        <h4 class="sidebar-card-title">
                            ...
                            {{ $achievement->image ? 'Ganti Gambar' : 'Upload Gambar' }}
                        </h4>
                    ...
                    <div class="sidebar-card">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="is_featured" 
                                   name="is_featured" value="1" {{ old('is_featured', $achievement->is_featured) ? 'checked' : '' }}>
                            <label class="form-check-label" for="is_featured">Prestasi Unggulan</label>
                        </div>
                        
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="is_active" 
                                   name="is_active" value="1" {{ old('is_active', $achievement->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                   id="sort_order" name="sort_order" value="{{ old('sort_order', $achievement->sort_order) }}" 
                                   min="0" placeholder="0">
                            @error('sort_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="sidebar-card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('meta_title') is-invalid @enderror" 
                                   id="meta_title" name="meta_title" value="{{ old('meta_title', $achievement->meta_title) }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                      ...
                                      placeholder="Deskripsi untuk SEO">{{ old('meta_description', $achievement->meta_description) }}</textarea>
            ...
            <div class="form-actions">
                <a href="{{ route('admin.achievements.show', $achievement) }}" class="btn btn-secondary">
...
<script>
// Enhanced JavaScript with change tracking
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('title').addEventListener('input', function() {
        ...
        if (!metaTitleInput.value || metaTitleInput.value === originalFormData.title) {
            metaTitleInput.value = this.value;
            markFieldAsChanged(metaTitleInput);
        }
    });
    ...
    document.getElementById('description').addEventListener('input', function() {
        ...
        if (!metaDescInput.value || metaDescInput.value === originalFormData.description?.substring(0, 160)) {
            const truncated = this.value.substring(0, 160);
            metaDescInput.value = truncated;
            markFieldAsChanged(metaDescInput);
        }
    });
    
    // Track changes on all form inputs
    const trackableInputs = form.querySelectorAll('input, textarea, select');
...
function markFieldAsChanged(input) {
...
function unmarkFieldAsChanged(input) {
    const formGroup = input.closest('.form-group');
    if (formGroup) {
...
function hasChanges() {
    return document.querySelectorAll('.form-group.changed').length > 0;
}
