            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select class="form-select @error('position') is-invalid @enderror" 
                        ...
                        <option value="Guru Kelas" {{ old('position', $teacher->position) == 'Guru Kelas' ? 'selected' : '' }}>Guru Kelas</option>
                        ...
                        <option value="Staff Administrasi" {{ old('position', $teacher->position) == 'Staff Administrasi' ? 'selected' : '' }}>Staff Administrasi</option>
                        <option value="Staff Perpustakaan" {{ old('position', $teacher->position) == 'Staff Perpustakaan' ? 'selected' : '' }}>Staff Perpustakaan</option>
