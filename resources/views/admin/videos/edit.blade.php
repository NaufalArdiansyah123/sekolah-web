    ...
    <div class="current-video-info">
        ...
        <div class="video-info-grid">
            ...
            <div class="info-item">
                ...
                <span class="info-value">{{ $video->formatted_file_size }}</span>
            </div>
            <div class="info-item">
                <span class="info-label">Format</span>
                <span class="info-value">{{ strtoupper(pathinfo($video->filename, PATHINFO_EXTENSION)) }}</span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
                ...
                <span class="info-value">{{ $video->created_at->format('d M Y H:i') }}</span>
            </div>
        </div>
    </div>
                ...
                <div class="form-group">
                    ...
                    <select name="category" 
                        ...
                        @foreach($categories as $key => $label)
                            <option value="{{ $key }}" {{ old('category', $video->category) == $key ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="status" 
                        ...
                        @foreach($statuses as $key => $label)
                            <option value="{{ $key }}" {{ old('status', $video->status) == $key ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                ...
                @if($video->thumbnail_url)
                    <div class="mt-2">
                        ...
                        <img src="{{ $video->thumbnail_url }}" alt="Current thumbnail" class="w-32 h-20 object-cover rounded-lg mt-1">
                    </div>
                @endif
                @error('thumbnail')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
