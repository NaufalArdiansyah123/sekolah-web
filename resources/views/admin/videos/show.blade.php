...
<div class="space-y-6">
    ...
    <div class="video-detail-container">
        ...
        <!-- Video Title -->
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">{{ $video->title }}</h2>

        <!-- Video Badges -->
        <div class="video-badges">
            <span class="badge badge-category">{{ $categories[$video->category] ?? $video->category }}</span>
            <span class="badge badge-status-{{ $video->status }}">{{ $statuses[$video->status] ?? $video->status }}</span>
        ...
        <div class="video-info-grid">
            ...
            @if($video->formatted_duration)
                <div class="info-card">
                    <h3>Duration</h3>
                    <div class="value">{{ $video->formatted_duration }}</div>
                </div>
            @endif
        </div>
