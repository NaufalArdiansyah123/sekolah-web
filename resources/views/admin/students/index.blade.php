...
<div class="students-container">
    <div class="content-wrapper">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <div class="stat-number">{{ $stats['graduated'] }}</div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4 filter-group">
                        ...
                        <div class="filter-actions">
                            ...
                            <a href="{{ route('admin.students.index') }}" class="btn btn-filter btn-reset" title="Reset Filter">
                ...
                @if(request()->hasAny(['grade', 'major', 'class', 'status', 'search']))
                    <div class="filter-stats">
                        ...
                        <span class="filter-stats-text">
                            ...
                            @endif
                            - Menampilkan {{ $students->total() }} dari {{ $stats['total'] }} siswa
                        </span>
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" class="form-check-input student-checkbox" 
                                           value="{{ $student->id }}" name="student_ids[]">
                                </td>
                                <td>
                                    @if($student->photo)
                                ...
                                <td>
                                    <span class="status-badge status-{{ $student->status }}" 
                                          title="@if($student->status === 'inactive')Dapat diaktifkan kembali@elseif($student->status === 'graduated')Dapat diaktifkan kembali@else{{ $student->status_label }}@endif">
                                ...
                                <td>
                                    <div class="birth-info">
                                        ...
                                        <div class="birth-place" title="{{ $student->birth_place }}">
                                            {{ $student->birth_place }}
                                        </div>
                                    </div>
                                </td>
...
<!-- Floating Add Button -->
<a href="{{ route('admin.students.create') }}" class="add-student-btn" title="➕ Tambah Siswa Baru">
