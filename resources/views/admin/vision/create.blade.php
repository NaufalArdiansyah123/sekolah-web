...
<div class="create-vision-page">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p class="page-subtitle">Create comprehensive vision, mission, and strategic goals for your institution</p>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('admin.vision.store') }}" method="POST" id="visionForm" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="form-section">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('title', 'Vision & Mission') }}" 
                                   required
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="vision_text" 
                                      ...
                                      required
                                      placeholder="Enter school vision statement...">{{ old('vision_text') }}</textarea>
                            @error('vision_text')
                                <div class="invalid-feedback">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            ...
                            <div class="dynamic-body">
                                ...
                                <div class="form-group" style="margin-top: 1rem;">
                                    ...
                                    <textarea class="form-input @error('mission_items_json') is-invalid @enderror" 
                                              ...
                                              placeholder='Mission data will appear here automatically'>{{ old('mission_items_json', '[]') }}</textarea>
                            ...
                            <div class="dynamic-body">
                                ...
                                <div class="form-group" style="margin-top: 1rem;">
                                    ...
                                    <textarea class="form-input @error('goals_json') is-invalid @enderror" 
                                              ...
                                              placeholder='Goals data will appear here automatically'>{{ old('goals_json', '[]') }}</textarea>
                            ...
                            <div class="dynamic-body">
                                ...
                                <div class="form-group" style="margin-top: 1rem;">
                                    ...
                                    <textarea class="form-input @error('values_json') is-invalid @enderror" 
                                              ...
                                              placeholder='Values data will appear here automatically'>{{ old('values_json', '[]') }}</textarea>
                            ...
                            <div class="dynamic-body">
                                ...
                                <div class="form-group" style="margin-top: 1rem;">
                                    ...
                                    <textarea class="form-input @error('focus_areas_json') is-invalid @enderror" 
                                              ...
                                              placeholder='Focus areas data will appear here automatically'>{{ old('focus_areas_json', '[]') }}</textarea>
                            ...
                            <div class="dynamic-body">
                                ...
                                <div class="form-group" style="margin-top: 1rem;">
                                    ...
                                    <textarea class="form-input @error('roadmap_phases_json') is-invalid @enderror" 
                                              ...
                                              placeholder='Roadmap data will appear here automatically'>{{ old('roadmap_phases_json', '[]') }}</textarea>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('hero_title', 'Vision & Mission') }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="hero_subtitle" 
                                      ...
                                      rows="3"
                                      placeholder="Description for hero section...">{{ old('hero_subtitle') }}</textarea>
                            @error('hero_subtitle')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-help">JPG, PNG, GIF. Max 10MB.</div>
                            @error('hero_image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="meta_description" 
                                      ...
                                      rows="3"
                                      placeholder="Description for SEO...">{{ old('meta_description') }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    // Initialize data from old input if exists
    initializeOldData();
...
function initializeOldData() {
    // Initialize mission items from old data
    const oldMissionJson = document.getElementById('mission_items_json').value;
    if (oldMissionJson && oldMissionJson !== '[]') {
        try {
            missionData = JSON.parse(oldMissionJson);
            missionData.forEach(mission => {
                addMissionToDOM(mission);
            });
        } catch (e) {
            console.error('Error parsing mission JSON:', e);
        }
    }

    // Initialize goals from old data
    const oldGoalsJson = document.getElementById('goals_json').value;
    if (oldGoalsJson && oldGoalsJson !== '[]') {
        try {
            goalsData = JSON.parse(oldGoalsJson);
            goalsData.forEach(goal => {
                addGoalToDOM(goal);
            });
        } catch (e) {
            console.error('Error parsing goals JSON:', e);
        }
    }

    // Initialize values from old data
    const oldValuesJson = document.getElementById('values_json').value;
    if (oldValuesJson && oldValuesJson !== '[]') {
        try {
            valuesData = JSON.parse(oldValuesJson);
    ...
    // Initialize focus areas from old data
    const oldFocusAreasJson = document.getElementById('focus_areas_json').value;
    if (oldFocusAreasJson && oldFocusAreasJson !== '[]') {
        try {
            focusAreasData = JSON.parse(oldFocusAreasJson);
            focusAreasData.forEach(area => {
                addFocusAreaToDOM(area);
            });
        } catch (e) {
            console.error('Error parsing focus areas JSON:', e);
        }
    }

    // Initialize roadmap from old data
    const oldRoadmapJson = document.getElementById('roadmap_phases_json').value;
    if (oldRoadmapJson && oldRoadmapJson !== '[]') {
        try {
            roadmapData = JSON.parse(oldRoadmapJson);
...
function addMissionToDOM(mission) {
    ...
    missionDiv.setAttribute('data-mission-id', mission.id || ++missionCounter);
    
    missionDiv.innerHTML = `
        <div class="dynamic-item-header">
            <h6 style="margin: 0; font-size: 0.875rem;">Mission #${mission.id || missionCounter}</h6>
            <button type="button" class="btn-remove" onclick="removeMission(${mission.id || missionCounter})">
        ...
        <div class="dynamic-item-body">
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="${mission.title || ''}" 
                       onchange="updateMissionData(${mission.id || missionCounter}, 'title', this.value)" 
...
function addGoalToDOM(goal) {
    ...
    goalDiv.setAttribute('data-goal-id', goal.id || ++goalsCounter);
    
    goalDiv.innerHTML = `
        <div class="dynamic-item-header">
            <h6 style="margin: 0; font-size: 0.875rem;">Goal #${goal.id || goalsCounter}</h6>
            <button type="button" class="btn-remove" onclick="removeGoal(${goal.id || goalsCounter})">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1-1H8a1 1 0 00-1 1v3M4 7h16"/>
                </svg>
                Remove
        ...
        <div class="dynamic-item-body">
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="${goal.title || ''}" 
                       onchange="updateGoalData(${goal.id || goalsCounter}, 'title', this.value)" 
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem;">
                <div class="form-group">
                    <label class="form-label">Icon</label>
                    <select class="form-input" onchange="updateGoalData(${goal.id || goalsCounter}, 'icon', this.value)">
                ...
                <div class="form-group">
                    ...
                    <select class="form-input" onchange="updateGoalData(${goal.id || goalsCounter}, 'color', this.value)">
...
function addValueToDOM(value) {
    ...
    valueDiv.setAttribute('data-value-id', value.id || ++valuesCounter);
    
    valueDiv.innerHTML = `
        <div class="dynamic-item-header">
            <h6 style="margin: 0; font-size: 0.875rem;">Value #${value.id || valuesCounter}</h6>
            <button type="button" class="btn-remove" onclick="removeValue(${value.id || valuesCounter})">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1-1H8a1 1 0 00-1 1v3M4 7h16"/>
                </svg>
                Remove
        ...
        <div class="dynamic-item-body">
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="${value.title || ''}" 
                       onchange="updateValueData(${value.id || valuesCounter}, 'title', this.value)" 
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem;">
                <div class="form-group">
                    <label class="form-label">Icon</label>
                    <select class="form-input" onchange="updateValueData(${value.id || valuesCounter}, 'icon', this.value)">
                ...
                <div class="form-group">
                    <label class="form-label">Color</label>
                    <select class="form-input" onchange="updateValueData(${value.id || valuesCounter}, 'color', this.value)">
...
function addFocusAreaToDOM(focusArea) {
    ...
    focusAreaDiv.setAttribute('data-focus-area-id', focusArea.id || ++focusAreasCounter);
    ...
    const itemsHtml = (focusArea.items || []).map((item, index) => 
        `<div class="focus-area-item" style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem;">
            <input type="text" class="form-input" value="${item}" 
                   onchange="updateFocusAreaItem(${focusArea.id || focusAreasCounter}, ${index}, this.value)" 
                   placeholder="Focus area item..." style="flex: 1;">
            <button type="button" class="btn-remove" style="padding: 0.375rem; font-size: 0.75rem;" 
                    onclick="removeFocusAreaItem(${focusArea.id || focusAreasCounter}, ${index})">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1-1H8a1 1 0 00-1 1v3M4 7h16"/>
                </svg>
            </button>
    ...
    focusAreaDiv.innerHTML = `
        <div class="dynamic-item-header">
            <h6 style="margin: 0; font-size: 0.875rem;">Focus Area #${focusArea.id || focusAreasCounter}</h6>
            <button type="button" class="btn-remove" onclick="removeFocusArea(${focusArea.id || focusAreasCounter})">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1-1H8a1 1 0 00-1 1v3M4 7h16"/>
                </svg>
                Remove
        ...
        <div class="dynamic-item-body">
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="${focusArea.title || ''}" 
                       onchange="updateFocusAreaData(${focusArea.id || focusAreasCounter}, 'title', this.value)" 
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem;">
                <div class="form-group">
                    <label class="form-label">Icon</label>
                    <select class="form-input" onchange="updateFocusAreaData(${focusArea.id || focusAreasCounter}, 'icon', this.value)">
                ...
                <div class="form-group">
                    <label class="form-label">Color</label>
                    <select class="form-input" onchange="updateFocusAreaData(${focusArea.id || focusAreasCounter}, 'color', this.value)">
            ...
            <div class="form-group">
                ...
                <div id="focus-area-items-${focusArea.id || focusAreasCounter}">
                    ${itemsHtml}
                </div>
                <button type="button" class="btn-add" style="margin-top: 0.5rem; padding: 0.5rem 1rem; font-size: 0.75rem;" 
                        onclick="addFocusAreaItem(${focusArea.id || focusAreasCounter})">
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/>
                    </svg>
                    Add Item
...
function addRoadmapPhaseToDOM(phase) {
    ...
    phaseDiv.setAttribute('data-roadmap-id', phase.id || ++roadmapCounter);
    
    phaseDiv.innerHTML = `
        <div class="dynamic-item-header">
            <h6 style="margin: 0; font-size: 0.875rem;">Phase #${phase.id || roadmapCounter}</h6>
            <button type="button" class="btn-remove" onclick="removeRoadmapPhase(${phase.id || roadmapCounter})">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1-1H8a1 1 0 00-1 1v3M4 7h16"/>
                </svg>
                Remove
        ...
        <div class="dynamic-item-body">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" value="${phase.year || ''}" 
                           onchange="updateRoadmapData(${phase.id || roadmapCounter}, 'year', this.value)" 
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="${phase.title || ''}" 
                       onchange="updateRoadmapData(${phase.id || roadmapCounter}, 'title', this.value)" 
            ...
            <div class="form-group">
                ...
                <textarea class="form-input" rows="2" 
                          onchange="updateRoadmapData(${phase.id || roadmapCounter}, 'target', this.value)" 
                          placeholder="Target to achieve in this phase...">${phase.target || ''}</textarea>
            </div>
            <div class="form-group">
                <label class="form-label">Timeline Color</label>
                <select class="form-input" onchange="updateRoadmapData(${phase.id || roadmapCounter}, 'color', this.value)">
