...
<div class="announcement-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <a href="{{ route('teacher.posts.announcement.create') }}" class="btn-primary">
    ...
    <div class="stats-container">
        ...
        <div class="stat-item">
            ...
            <div class="stat-value">{{ $announcements->sum('views_count') ?? 0 }}</div>
            ...
            <div class="filters-row">
                ...
                <div class="filter-group">
                    ...
                    <div style="display: flex; gap: 0.5rem;">
                        ...
                        <a href="{{ route('teacher.posts.announcement') }}" class="btn-reset">Reset</a>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div class="table-container">
                    ...
                    <tr>
                        ...
                        <td>
                             <div class="action-dropdown">
                                <button type="button" class="dropdown-toggle" onclick="toggleDropdown({{ $announcement->id }})" style="background: #e5e7eb; border: 1px solid #d1d5db; padding: 8px; border-radius: 6px;">
                                    ⋮
                                </button>
                                <div class="dropdown-menu" id="dropdown-{{ $announcement->id }}" style="background: white; border: 2px solid #000; min-width: 150px; padding: 8px;">
                                    <a class="dropdown-item" href="{{ route('teacher.posts.announcement.show', $announcement->id) }}" style="display: block; padding: 8px; color: #000; text-decoration: none;">
                                        👁️ View
                                    </a>
                                    <a class="dropdown-item" href="{{ route('teacher.posts.announcement.edit', $announcement->id) }}" style="display: block; padding: 8px; color: #000; text-decoration: none;">
                                        ✏️ Edit
                                    </a>
                                    <hr class="dropdown-divider" style="margin: 8px 0; border: 1px solid #ccc;">
                                    <form action="{{ route('teacher.posts.announcement.destroy', $announcement->id) }}" 
        ...
        @else
            ...
            <div class="empty-state">
                ...
                @else
                    <a href="{{ route('teacher.posts.announcement') }}" class="btn-reset">
                        Clear Filters
                    </a>
                @endif
            </div>
