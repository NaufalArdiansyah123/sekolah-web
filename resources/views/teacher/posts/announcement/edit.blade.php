...
<div class="announcement-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p class="page-subtitle">Update your announcement information</p>
        </div>
    </div>
    ...
    <div class="form-container">
        <form action="{{ route('teacher.posts.announcement.update', $announcement->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" 
                                  ...
                                  required
                                  placeholder="Tulis konten pengumuman Anda di sini...">{{ old('content', $announcement->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        @if($announcement->featured_image)
                            <div class="current-image">
                                <img src="{{ asset('storage/' . $announcement->featured_image) }}" alt="Current image">
                                <div class="current-image-info">
                                    Current image: {{ basename($announcement->featured_image) }}
                                </div>
                            </div>
                        @endif
                ...
                <div>
                    <div class="form-group">
                        ...
                        <select name="category" 
                            ...
                            <option value="akademik" {{ old('category', $announcement->category) === 'akademik' ? 'selected' : '' }}>Academic</option>
                            <option value="kegiatan" {{ old('category', $announcement->category) === 'kegiatan' ? 'selected' : '' }}>Activities</option>
                            <option value="administrasi" {{ old('category', $announcement->category) === 'administrasi' ? 'selected' : '' }}>Administration</option>
                            <option value="umum" {{ old('category', $announcement->category) === 'umum' ? 'selected' : '' }}>General</option>
                        </select>
                        @error('category')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
