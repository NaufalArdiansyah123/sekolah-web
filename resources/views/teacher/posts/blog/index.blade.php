...
<div class="blog-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <a href="{{ route('teacher.posts.blog.create') }}" class="btn-primary">
    ...
    <div class="filters-container">
        <form method="GET" action="{{ route('teacher.posts.blog.index') }}">
            <div class="filters-row">
                ...
                <div class="filter-group">
                    ...
                    <div style="display: flex; gap: 0.5rem;">
                        ...
                        <a href="{{ route('teacher.posts.blog.index') }}" class="btn-reset">Reset</a>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div class="blog-grid">
                ...
                <div class="card-content">
                    ...
                    <div class="card-meta">
                        <div class="card-meta-item">
                            ...
                            {{ $blog->author ?? $blog->user->name ?? 'Teacher' }}
                        </div>
                        <div class="card-meta-item">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="card-actions">
                        <a href="{{ route('teacher.posts.blog.edit', $blog->slug ?: $blog->id) }}" class="action-btn btn-edit" title="Edit">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                            </svg>
                        </a>
                        <a href="{{ route('teacher.posts.blog.show', $blog->slug ?: $blog->id) }}" class="action-btn btn-view" title="View">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                            </svg>
                        </a>
                        <form action="{{ route('teacher.posts.blog.destroy', $blog->slug ?: $blog->id) }}" method="POST" style="display: inline;" class="delete-form">
                            @csrf
                            @method('DELETE')
        ...
        @else
            ...
            <div class="empty-state">
                ...
                @else
                    <a href="{{ route('teacher.posts.blog.index') }}" class="btn-reset">
                        Clear Filters
                    </a>
                @endif
            </div>
