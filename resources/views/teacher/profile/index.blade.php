...
<style>
/* Teacher Profile Page Styles - Dark Mode Compatible */
.profile-container {
    max-width: 1200px;
    margin: 0 auto;
}
...
.profile-activity-icon.teaching {
        ...
        <div class="profile-header-content">
            <div class="profile-avatar-section">
                <img src="{{ auth()->user()->avatar_url }}" 
                     ...
                     onerror="this.src='https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&color=10B981&background=EBF4FF&size=120'">
            ...
            <div class="profile-info">
                ...
                <div class="profile-stats">
                    ...
                    <div class="profile-stat">
                        <div class="profile-stat-value">0</div>
                        <div class="profile-stat-label">Siswa</div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="changePasswordModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('teacher.profile.password') }}" method="POST" id="passwordForm">
                @csrf
                @method('PUT')
...
function uploadAvatar(file) {
    ...
    fetch('{{ route("teacher.profile.avatar") }}', {
        method: 'POST',
        body: formData
    })
...
function logoutAllDevices() {
    ...
    fetch('{{ route("teacher.profile.logout-devices") }}', {
        method: 'POST',
        headers: {
...
function loadActivity() {
    fetch('{{ route("teacher.profile.activity") }}')
    .then(response => response.json())
    .then(data => {
        if (data.success) {
