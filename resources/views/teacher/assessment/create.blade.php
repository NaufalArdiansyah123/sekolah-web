    ...
    <div class="content-wrapper">
        ...
        <div class="main-content">
            <div class="form-container">
                ...
                <form action="{{ route('teacher.assessment.store') }}" method="POST" id="assessmentForm" class="needs-validation" novalidate>
                    @csrf
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="class" class="form-select" required>
                                        ...
                                        <option value="VII A" {{ old('class') == 'VII A' ? 'selected' : '' }}>VII A</option>
                                        <option value="VII B" {{ old('class') == 'VII B' ? 'selected' : '' }}>VII B</option>
                                        <option value="VII C" {{ old('class') == 'VII C' ? 'selected' : '' }}>VII C</option>
                                        <option value="VIII A" {{ old('class') == 'VIII A' ? 'selected' : '' }}>VIII A</option>
                                        <option value="VIII B" {{ old('class') == 'VIII B' ? 'selected' : '' }}>VIII B</option>
                                        <option value="VIII C" {{ old('class') == 'VIII C' ? 'selected' : '' }}>VIII C</option>
                                        <option value="IX A" {{ old('class') == 'IX A' ? 'selected' : '' }}>IX A</option>
                                        <option value="IX B" {{ old('class') == 'IX B' ? 'selected' : '' }}>IX B</option>
                                        <option value="IX C" {{ old('class') == 'IX C' ? 'selected' : '' }}>IX C</option>
                                    </select>
                                    @error('class')
                                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-textarea" rows="4"
                                          placeholder="Describe what this assessment covers and its objectives...">{{ old('description') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="instructions" class="form-textarea" rows="4"
                                          placeholder="Enter specific instructions for students (e.g., 'Read each question carefully', 'Show your work', etc.)...">{{ old('instructions') }}</textarea>
