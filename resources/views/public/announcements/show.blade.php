                        ...
                        <div class="announcement-meta">
                            ...
                            <div class="meta-item">
                                ...
                                <div>
                                    ...
                                    <div>{{ $announcement->published_at ? $announcement->published_at->format('d F Y, H:i') : $announcement->created_at->format('d F Y, H:i') }}</div>
                                </div>
                            </div>
                        ...
                        <div class="sidebar-content">
                            @foreach($relatedAnnouncements as $related)
                                <div class="related-item">
                                    <a href="{{ route('announcements.show', $related->id) }}" 
                                       class="related-title">
                                        {{ $related->title }}
                                    </a>
