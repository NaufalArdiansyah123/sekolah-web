    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('public.videos.index') }}">Video</a></li>
            ...
            <div class="video-controls">
                <div class="video-title-section">
                    ...
                    <div class="video-badges">
                        <span class="video-badge badge-category">{{ $categories[$video->category] ?? $video->category }}</span>
                ...
                <div class="video-actions">
                    <a href="{{ route('public.videos.download', $video) }}" class="btn-video-action btn-download">
                ...
                <div class="info-card fade-in-right" style="animation-delay: 0.2s;">
                    ...
                    <div class="list-group list-group-flush">
                        <div class="list-group-item d-flex justify-content-between align-items-center border-0 px-0">
                            ...
                            <span class="badge bg-primary rounded-pill">{{ $categories[$video->category] ?? $video->category }}</span>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center border-0 px-0">
                            <strong>Format:</strong>
                            <span>{{ strtoupper(pathinfo($video->filename, PATHINFO_EXTENSION)) }}</span>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center border-0 px-0">
    ...
    <div class="container">
        <div class="section-title">
            ...
            <p class="text-muted fade-in-up" style="animation-delay: 0.2s;">
                Video lainnya dalam kategori {{ $categories[$video->category] ?? $video->category }}
            </p>
        </div>
        ...
        <div class="row g-4">
            @foreach($relatedVideos as $index => $relatedVideo)
                <div class="col-lg-4 col-md-6">
                    <div class="related-video-card fade-in-up" style="animation-delay: {{ $index * 0.2 }}s;">
                        <div class="related-video-thumbnail">
                            ...
                            @else
                                <div class="related-video-placeholder">
                                    ...
                                    <span class="fw-bold">{{ strtoupper($relatedVideo->category) }}</span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="related-video-info">
                            ...
                            <div class="related-video-meta">
                                <i class="fas fa-eye me-1"></i> {{ number_format($relatedVideo->views) }} views •
                                <i class="fas fa-calendar me-1"></i> {{ $relatedVideo->created_at->format('d M Y') }}
                            </div>
                            <a href="{{ route('public.videos.show', $relatedVideo) }}" class="related-video-link">
        ...
        <div class="text-center mt-4">
            <a href="{{ route('public.videos.index') }}" class="btn btn-outline-primary btn-lg">
...
function shareVideo() {
    if (navigator.share) {
        navigator.share({
            title: '{{ $video->title }}',
            text: 'Tonton video ini: {{ $video->title }}',
