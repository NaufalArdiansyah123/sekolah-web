...
(function() {
    ...
    window.mobileDebug = {
        ...
        // Fix navbar dropdown issues
        fixNavbarDropdowns: function() {
            console.log('🔧 Fixing navbar dropdowns for mobile...');
            ...
            if (window.innerWidth < 992) {
                ...
                this.showMessage('Navbar dropdowns fixed for mobile!', 'success');
            }
        },
        ...
        testDropdowns: function() {
            ...
            dropdowns.forEach((toggle, index) => {
                console.log(`Dropdown ${index + 1}:`, {
                    ...
                    isVisible: toggle.offsetParent !== null,
                    computedStyle: window.getComputedStyle(toggle)
                });
            });
    ...
    if (isMobile || window.location.search.includes('debug=mobile')) {
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Auto-fix navbar dropdowns on mobile
            setTimeout(() => {
                window.mobileDebug.fixNavbarDropdowns();
            }, 2000);
    ...
    // Always fix dropdowns on mobile, even without debug mode
    if (isMobile) {
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(() => {
                window.mobileDebug.fixNavbarDropdowns();
