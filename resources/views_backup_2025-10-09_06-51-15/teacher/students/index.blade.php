...
<div class="students-container">
    ...
    <div class="stats-container">
        ...
        <div class="stat-item">
            ...
            <div class="stat-value">{{ collect($students->items())->where('gender', 'L')->count() }}</div>
        ...
        <div class="stat-item">
            ...
            <div class="stat-value">{{ collect($students->items())->where('gender', 'P')->count() }}</div>
            ...
            <div class="filters-row">
                ...
                <div class="filter-group">
                    ...
                    <select name="sort" class="filter-input">
                        ...
                        <option value="enrollment_date" {{ request('sort') == 'enrollment_date' ? 'selected' : '' }}>Enrollment Date</option>
                    </select>
                </div>
                <div class="filter-group">
                    ...
                    <div style="display: flex; gap: 0.5rem;">
                        ...
                        <a href="{{ route('teacher.students.index') }}" class="btn-reset">Reset</a>
                    </div>
                </div>
            </div>
        </form>
            ...
            <div class="student-card">
                ...
                <div class="student-details">
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{ $student->gender == 'L' ? 'Male' : 'Female' }}</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">Tanggal Lahir</div>
                        <div class="detail-value">{{ \Carbon\Carbon::parse($student->birth_date)->format('d M Y') }}</div>
                    </div>
                    <div class="detail-item">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{ \Carbon\Carbon::parse($student->enrollment_date)->format('d M Y') }}</div>
                    </div>
                </div>
                ...
                <div class="student-actions">
                    <a href="{{ route('teacher.students.show', $student->id) }}" class="action-btn btn-view" title="View Details">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                        </svg>
                    </a>
                    <a href="{{ route('teacher.students.edit', $student->id) }}" class="action-btn btn-edit" title="Edit Student">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                        </svg>
                    </a>
                    <button class="action-btn btn-delete" title="Delete Student" onclick="deleteStudent({{ $student->id }})">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
