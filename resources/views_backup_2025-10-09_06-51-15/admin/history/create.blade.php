...
@section('title', 'Buat Sejarah Sekolah')
...
<div class="create-history-page">
    ...
    <div class="page-header">
        <div class="header-content">
            <h1 class="page-title">
                ...
                Buat Sejarah Sekolah
            </h1>
            <p class="page-subtitle">Buat dokumentasi sejarah, timeline, dan pencapaian sekolah</p>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('admin.history.store') }}" method="POST" id="historyForm" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="form-section">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('title', 'Sejarah Sekolah') }}" 
                                   required
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" 
                                      ...
                                      required
                                      rows="8"
                                      placeholder="Masukkan konten sejarah sekolah...">{{ old('content') }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            ...
                            <div class="dynamic-body">
                                ...
                                <div class="form-group" style="margin-top: 1rem;">
                                    ...
                                    <textarea class="form-input @error('timeline_events_json') is-invalid @enderror" 
                                              ...
                                              placeholder='Data timeline akan muncul di sini secara otomatis'>{{ old('timeline_events_json', '[]') }}</textarea>
                            ...
                            <div class="dynamic-body">
                                ...
                                <div class="form-group" style="margin-top: 1rem;">
                                    ...
                                    <textarea class="form-input @error('milestones_json') is-invalid @enderror" 
                                              ...
                                              placeholder='Data tonggak akan muncul di sini secara otomatis'>{{ old('milestones_json', '[]') }}</textarea>
                            ...
                            <div class="dynamic-body">
                                ...
                                <div class="form-group" style="margin-top: 1rem;">
                                    ...
                                    <textarea class="form-input @error('achievements_json') is-invalid @enderror" 
                                              ...
                                              placeholder='Data prestasi akan muncul di sini secara otomatis'>{{ old('achievements_json', '[]') }}</textarea>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('hero_title', 'Sejarah Sekolah') }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="hero_subtitle" 
                                      ...
                                      rows="3"
                                      placeholder="Deskripsi untuk bagian hero...">{{ old('hero_subtitle') }}</textarea>
                            @error('hero_subtitle')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-help">JPG, PNG, GIF. Maksimal 10MB.</div>
                            @error('hero_image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
...
function initializeOldData() {
    // Initialize timeline from old data
    const oldTimelineJson = document.getElementById('timeline_events_json').value;
    if (oldTimelineJson && oldTimelineJson !== '[]') {
        try {
            timelineData = JSON.parse(oldTimelineJson);
    ...
    // Initialize milestones from old data
    const oldMilestonesJson = document.getElementById('milestones_json').value;
    if (oldMilestonesJson && oldMilestonesJson !== '[]') {
        try {
            milestonesData = JSON.parse(oldMilestonesJson);
    ...
    // Initialize achievements from old data
    const oldAchievementsJson = document.getElementById('achievements_json').value;
    if (oldAchievementsJson && oldAchievementsJson !== '[]') {
        try {
            achievementsData = JSON.parse(oldAchievementsJson);
...
function addTimelineEventToDOM(event) {
    ...
    eventDiv.setAttribute('data-timeline-id', event.id || ++timelineCounter);
    
    eventDiv.innerHTML = `
        <div class="dynamic-item-header">
            <h6 style="margin: 0; font-size: 0.875rem;">Peristiwa #${event.id || timelineCounter}</h6>
            <button type="button" class="btn-remove" onclick="removeTimelineEvent(${event.id || timelineCounter})">
        ...
        <div class="dynamic-item-body">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" value="${event.year || ''}" 
                           onchange="updateTimelineData(${event.id || timelineCounter}, 'year', this.value)" 
                           placeholder="Contoh: 1985">
                </div>
                <div class="form-group">
                    <label class="form-label">Jenis</label>
                    <select class="form-input" onchange="updateTimelineData(${event.id || timelineCounter}, 'type', this.value)">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="${event.title || ''}" 
                       onchange="updateTimelineData(${event.id || timelineCounter}, 'title', this.value)" 
                       placeholder="Contoh: Pendirian Sekolah">
            </div>
            <div class="form-group">
                <label class="form-label">Deskripsi</label>
                <textarea class="form-input" rows="3" 
                          onchange="updateTimelineData(${event.id || timelineCounter}, 'description', this.value)" 
...
function addMilestoneToDOM(milestone) {
    ...
    milestoneDiv.setAttribute('data-milestone-id', milestone.id || ++milestonesCounter);
    
    milestoneDiv.innerHTML = `
        <div class="dynamic-item-header">
            <h6 style="margin: 0; font-size: 0.875rem;">Tonggak #${milestone.id || milestonesCounter}</h6>
            <button type="button" class="btn-remove" onclick="removeMilestone(${milestone.id || milestonesCounter})">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1-1H8a1 1 0 00-1 1v3M4 7h16"/>
                </svg>
                Hapus
        ...
        <div class="dynamic-item-body">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" value="${milestone.year || ''}" 
                           onchange="updateMilestoneData(${milestone.id || milestonesCounter}, 'year', this.value)" 
                           placeholder="Contoh: 1990">
                </div>
                <div class="form-group">
                    <label class="form-label">Warna</label>
                    <select class="form-input" onchange="updateMilestoneData(${milestone.id || milestonesCounter}, 'color', this.value)">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="${milestone.title || ''}" 
                       onchange="updateMilestoneData(${milestone.id || milestonesCounter}, 'title', this.value)" 
                       placeholder="Contoh: Akreditasi A">
            </div>
            <div class="form-group">
                <label class="form-label">Deskripsi</label>
                <textarea class="form-input" rows="3" 
                          onchange="updateMilestoneData(${milestone.id || milestonesCounter}, 'description', this.value)" 
...
function addAchievementToDOM(achievement) {
    ...
    achievementDiv.setAttribute('data-achievement-id', achievement.id || ++achievementsCounter);
    
    achievementDiv.innerHTML = `
        <div class="dynamic-item-header">
            <h6 style="margin: 0; font-size: 0.875rem;">Prestasi #${achievement.id || achievementsCounter}</h6>
            <button type="button" class="btn-remove" onclick="removeAchievement(${achievement.id || achievementsCounter})">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1-1H8a1 1 0 00-1 1v3M4 7h16"/>
                </svg>
                Hapus
        ...
        <div class="dynamic-item-body">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem;">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" value="${achievement.year || ''}" 
                           onchange="updateAchievementData(${achievement.id || achievementsCounter}, 'year', this.value)" 
                           placeholder="Contoh: 2020">
                </div>
                <div class="form-group">
                    <label class="form-label">Tingkat</label>
                    <select class="form-input" onchange="updateAchievementData(${achievement.id || achievementsCounter}, 'level', this.value)">
            ...
            <div class="form-group">
                ...
                <select class="form-input" onchange="updateAchievementData(${achievement.id || achievementsCounter}, 'category', this.value)">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="${achievement.title || ''}" 
                       onchange="updateAchievementData(${achievement.id || achievementsCounter}, 'title', this.value)" 
                       placeholder="Contoh: Juara 1 Olimpiade Matematika">
            </div>
            <div class="form-group">
                <label class="form-label">Deskripsi</label>
                <textarea class="form-input" rows="3" 
                          onchange="updateAchievementData(${achievement.id || achievementsCounter}, 'description', this.value)" 
