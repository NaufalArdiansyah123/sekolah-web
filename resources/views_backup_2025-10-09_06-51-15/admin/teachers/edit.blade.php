...
<div class="edit-container">
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Update teacher profile information</p>
        </div>
    ...
    <!-- Form -->
    <form action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST" enctype="multipart/form-data" class="form-container" id="teacherForm">
        @csrf
        @method('PUT')
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control textarea @error('address') is-invalid @enderror" 
                          id="address" 
                          name="address" 
                          placeholder="Enter complete address">{{ old('address', $teacher->address) }}</textarea>
                @error('address')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select class="form-select @error('position') is-invalid @enderror" 
                        ...
                        @php
                            // Check if Kepala Sekolah already exists (excluding current teacher)
                            $hasKepalaSekolah = \App\Models\Teacher::where('position', 'Kepala Sekolah')
                                                                  ->where('status', 'active')
                                                                  ->where('id', '!=', $teacher->id)
                                                                  ->exists();
                            
                            // Check if Wakil Kepala Sekolah already exists (excluding current teacher)
                        ...
                        @if(!$hasKepalaSekolah || $teacher->position == 'Kepala Sekolah')
                            <option value="Kepala Sekolah" {{ old('position', $teacher->position) == 'Kepala Sekolah' ? 'selected' : '' }}>Kepala Sekolah</option>
                        @endif
                        
                        @if(!$hasWakilKepalaSekolah || $teacher->position == 'Wakil Kepala Sekolah')
                        ...
                        <option value="Guru Bengkel" {{ old('position', $teacher->position) == 'Guru Bengkel' ? 'selected' : '' }}>Guru Bengkel</option>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <div class="file-upload-area" id="fileUploadArea">
                    ...
                    <div class="upload-text">Drop new photo here or click to browse</div>
