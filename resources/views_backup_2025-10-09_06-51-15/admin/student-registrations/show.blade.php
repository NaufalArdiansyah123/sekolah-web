...
<div class="student-detail-container">
    ...
    <div class="detail-sections">
        ...
        <div class="detail-section">
            ...
            @endif
            @if(isset($registration->religion))
            <div class="detail-item">
        ...
        <div class="detail-section">
            ...
            @endif
            @if(isset($registration->enrollment_date))
            <div class="detail-item">
                <span class="detail-label">Tanggal Masuk</span>
                <span class="detail-value">{{ \Carbon\Carbon::parse($registration->enrollment_date)->format('d/m/Y') }}</span>
            </div>
            @endif
        </div>
        ...
        <div class="detail-section">
            ...
            @endif
            @if(isset($registration->parent_email))
            <div class="detail-item">
                <span class="detail-label">Email</span>
    ...
    @if($registration->status == 'rejected' && isset($registration->rejection_reason) && $registration->rejection_reason)
