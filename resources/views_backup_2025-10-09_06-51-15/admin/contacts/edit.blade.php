...
@section('title', 'Edit Contact - ' . $contact->title)
...
<div class="edit-contact-page">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p class="page-subtitle">Update contact information and settings</p>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('admin.contacts.update', $contact) }}" method="POST" id="contactForm" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" 
                                      ...
                                      placeholder="Brief description about this contact...">{{ old('description', $contact->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" 
                                      ...
                                      rows="2"
                                      placeholder="Complete address...">{{ old('address', $contact->address) }}</textarea>
                            @error('address')
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div class="form-group">
                                ...
                                <input type="url" 
                                       ...
                                       value="{{ old('facebook', $contact->social_media['facebook'] ?? '') }}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" 
                                       ...
                                       value="{{ old('instagram', $contact->social_media['instagram'] ?? '') }}" 
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('whatsapp', $contact->social_media['whatsapp'] ?? '') }}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" 
                                       ...
                                       value="{{ old('youtube', $contact->social_media['youtube'] ?? '') }}" 
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                            <div class="form-group">
                                ...
                                <input type="url" 
                                       ...
                                       value="{{ old('twitter', $contact->social_media['twitter'] ?? '') }}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" 
                                       ...
                                       value="{{ old('linkedin', $contact->social_media['linkedin'] ?? '') }}" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   name="telegram" 
                                   id="telegram" 
                                   class="form-input @error('telegram') is-invalid @enderror" 
                                   value="{{ old('telegram', $contact->social_media['telegram'] ?? '') }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="map_embed" 
                                      ...
                                      rows="3"
                                      placeholder="Paste Google Maps embed code or iframe URL here...">{{ old('map_embed', $contact->map_embed) }}</textarea>
                            @error('map_embed')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-help">
                        ...
                        <div class="form-group">
                            ...
                            @if($contact->hero_image_url)
                            <div style="margin-bottom: 1rem;">
                                <p style="font-size: 0.875rem; color: var(--text-secondary); margin-bottom: 0.5rem;">Current Image:</p>
                                <img src="{{ $contact->hero_image_url }}" alt="Current Hero Image" style="max-width: 100%; height: 150px; object-fit: cover; border-radius: 8px; border: 1px solid var(--border-color);">
                            </div>
                            @endif
                            ...
                            <div class="form-help">
                                ...
                                Upload a new image to replace the current hero background. Recommended size: 1920x600px. Max file size: 2MB.
                            </div>
                            
                            <!-- Image Preview -->
                            <div id="heroImagePreview" style="margin-top: 1rem; display: none;">
                                <p style="font-size: 0.875rem; color: var(--text-secondary); margin-bottom: 0.5rem;">New Image Preview:</p>
                        ...
                        <div style="border-top: 2px solid var(--border-color); padding-top: 2rem; margin-top: 2rem;">
                            ...
                            <div class="form-help">
                                ...
                                Icon classes use Font Awesome format (e.g., fas fa-icon-name). Visit <a href="https://fontawesome.com/icons" target="_blank" style="color: var(--accent-color);">fontawesome.com</a> for available icons.
                            </div>
                        </div>
                        @else
                        <div style="border-top: 2px solid var(--border-color); padding-top: 2rem; margin-top: 2rem;">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: flex; align-items: center; gap: 0.5rem; margin-top: 0.5rem;">
                                <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $contact->is_active) ? 'checked' : '' }}>
                        ...
                        <!-- Quick Cards Preview -->
                        <div style="background: var(--bg-secondary); padding: 1.5rem; border-radius: 12px; border: 1px solid var(--border-color); margin-bottom: 1.5rem;">
                        ...
                        <div style="background: var(--bg-secondary); padding: 1rem; border-radius: 8px; border: 1px solid var(--border-color);">
                            <h4 style="margin: 0 0 0.75rem 0; font-size: 0.875rem; font-weight: 600; color: var(--text-primary);">Current Status</h4>
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                                <span style="font-size: 0.75rem; color: var(--text-secondary);">Status</span>
                                <span style="padding: 0.25rem 0.5rem; border-radius: 4px; font-size: 0.75rem; font-weight: 500; {{ $contact->is_active ? 'background: rgba(16, 185, 129, 0.1); color: #059669;' : 'background: rgba(107, 114, 128, 0.1); color: #6b7280;' }}">
                                    {{ $contact->is_active ? 'Active' : 'Inactive' }}
                                </span>
                            </div>
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                                <span style="font-size: 0.75rem; color: var(--text-secondary);">Created</span>
            ...
            <div class="form-actions">
                <div style="display: flex; gap: 0.75rem;">
                    ...
                    <a href="{{ route('admin.contacts.show', $contact) }}" class="btn-secondary">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                        </svg>
                ...
                <div style="display: flex; gap: 0.75rem;">
                    <button type="submit" class="btn-primary" id="submitBtn" form="contactForm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div style="margin-top: 1rem; text-align: center;">
            <form action="{{ route('admin.contacts.destroy', $contact) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this contact? This action cannot be undone.')">
                @csrf
                @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    for (let i = 1; i <= 3; i++) {
        ['icon', 'title', 'description'].forEach(field => {
            const element = document.getElementById(`quick_card_${i}_${field}`);
            if (element) {
                element.addEventListener('input', updateCardsPreview);
            }
        });
    }
...
// Dynamic Quick Cards Management
let cardCounter = 0;
const maxCards = 10;
const existingCards = @json($contact->formatted_quick_cards);

function initializeQuickCards() {
    // Add existing cards from database
    if (existingCards && existingCards.length > 0) {
        existingCards.forEach(cardData => {
            addQuickCard(cardData);
        });
    } else {
        // Add default cards if no existing cards
        const defaultCards = [
...
function addQuickCard(cardData = null) {
    ...
    // Set values from cardData or defaults
    if (cardData) {
