            ...
            @if($announcements->count() > 0)
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <small class="text-muted">Menampilkan {{ $announcements->firstItem() }}-{{ $announcements->lastItem() }}
                            dari {{ $announcements->total() }} pengumuman</small>
                    </div>
                </div>
            @endif
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="announcement-card fade-in-up" style="animation-delay: {{ $index * 0.1 }}s;">
                                @if($announcement->featured_image)
                                    <img src="{{ asset('storage/' . $announcement->featured_image) }}" alt="{{ $announcement->title }}"
                                ...
                                <!-- Priority Badge -->
                                <div class="priority-badge priority-{{ $announcement->prioritas ?? 'sedang' }}">
                                    @if($announcement->prioritas === 'tinggi') 🚨 Tinggi
                                    @elseif($announcement->prioritas === 'sedang') ⚠️ Sedang
                                    @else 📝 Rendah
                                    @endif
                                </div>
                                ...
                                <div class="announcement-content">
                                    ...
                                    <div class="announcement-meta">
                                        ...
                                        <div class="announcement-meta-item">
                                            ...
                                            <span>{{ $announcement->tanggal_publikasi ? $announcement->tanggal_publikasi->format('d M Y, H:i') : $announcement->created_at->format('d M Y, H:i') }}</span>
                                        </div>
                                        <div class="announcement-meta-item">
