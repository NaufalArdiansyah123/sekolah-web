    ...
    <section class="breadcrumb-section">
        <div class="container">
            <nav class="breadcrumb">
                ...
                <a href="{{ route('public.facilities.index') }}">Facilities</a>
                <span class="breadcrumb-separator">/</span>
                    ...
                    <div class="sidebar-card">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 1rem;">
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem; background: var(--bg-light); border-radius: 8px;">
                                <span style="color: var(--text-gray); font-size: 0.875rem;">Category</span>
                                <span style="font-weight: 600; color: var(--text-dark);">{{ $facility->category_label }}</span>
                            </div>
                            
                            @if($facility->location)
                                <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem; background: var(--bg-light); border-radius: 8px;">
                                    <span style="color: var(--text-gray); font-size: 0.875rem;">Location</span>
                            ...
                            @if($facility->capacity)
                                <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem; background: var(--bg-light); border-radius: 8px;">
                                    <span style="color: var(--text-gray); font-size: 0.875rem;">Capacity</span>
