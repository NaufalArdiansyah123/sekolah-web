            ...
            <div class="card shadow-lg border-0" style="border-radius: 20px; backdrop-filter: blur(10px); background: rgba(255, 255, 255, 0.95);">
                <div class="card-body p-5">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mt-3 pt-3" style="border-top: 1px solid rgba(239, 68, 68, 0.2);">
                                <small class="text-muted">
                                    ...
                                    Ditolak pada: {{ $user->rejected_at->format('d F Y, H:i') }}
                                </small>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        <a href="{{ route('home') }}" class="btn btn-outline-secondary btn-lg px-4" style="border-radius: 25px;">
                            <i class="fas fa-home me-2"></i>
                            Kembali ke Beranda
                        </a>
                        <a href="{{ route('login') }}" class="btn btn-secondary btn-lg px-4" style="border-radius: 25px;">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 15px;">
            ...
            <div class="modal-body p-4">
                <form action="{{ route('auth.rejection.contact') }}" method="POST">
                    @csrf
                    <div class="row">
