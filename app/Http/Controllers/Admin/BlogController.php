...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.posts.blog')->with('success', 'Berita berhasil ditambahkan!');
    }
    ...
    {
        return view('admin.posts.blog.show', compact('blog'));
    }
    ...
    public function update(Request $request, BlogPost $blog)
    {
        ...
        return redirect()->route('admin.posts.blog')->with('success', 'Berita berhasil diperbarui!');
    }
    ...
    public function destroy(BlogPost $blog)
    {
        ...
        return redirect()->route('admin.posts.blog')->with('success', 'Berita berhasil dihapus!');
    }
}
