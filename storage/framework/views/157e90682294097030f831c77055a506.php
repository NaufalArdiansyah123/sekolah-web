...
<div class="registration-container">
    ...
    <div class="stats-container">
        ...
        <div class="stat-item approved">
            ...
            <div class="stat-value"><?php echo e($stats['approved'] ?? 0); ?></div>
    ...
    <div class="filter-container">
        ...
        <div class="filter-tabs">
            ...
            <a href="<?php echo e(route('admin.student-registrations.index', ['status' => 'pending'])); ?>" 
               class="filter-tab <?php echo e(request('status') == 'pending' ? 'active' : ''); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                Menunggu Konfirmasi
                <span class="badge"><?php echo e($stats['pending'] ?? 0); ?></span>
            </a>
            <a href="<?php echo e(route('admin.student-registrations.index', ['status' => 'active'])); ?>" 
               class="filter-tab <?php echo e(request('status') == 'active' ? 'active' : ''); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
                Disetujui
                <span class="badge"><?php echo e($stats['approved'] ?? 0); ?></span>
            </a>
            <a href="<?php echo e(route('admin.student-registrations.index', ['status' => 'rejected'])); ?>" 
               class="filter-tab <?php echo e(request('status') == 'rejected' ? 'active' : ''); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                </svg>
                Ditolak
                <span class="badge"><?php echo e($stats['rejected'] ?? 0); ?></span>
            </a>
        </div>
        
        <!-- Search Form -->
        <form method="GET" action="<?php echo e(route('admin.student-registrations.index')); ?>" class="row g-3">
            <div class="col-md-8">
    ...
    <div class="table-container">
        <div class="table-header">
            <h3 class="table-title">
                ...
                Daftar Pendaftaran
                <span class="badge" style="background: #4f46e5; color: white; padding: 0.25rem 0.5rem; border-radius: 6px; font-size: 0.75rem; margin-left: 0.5rem;"><?php echo e($registrations->total() ?? 0); ?></span>
            </h3>
        </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $registrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registration): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <div style="color: var(--text-primary);"><?php echo e($registration->email); ?></div>
                                    <?php if($registration->phone): ?>
                                        <small style="color: var(--text-secondary);"><?php echo e($registration->phone); ?></small>
                                    <?php endif; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div style="font-size: 0.8rem; color: var(--text-primary);"><?php echo e($registration->created_at->format('d/m/Y')); ?></div>
                                    <small style="color: var(--text-secondary);"><?php echo e($registration->created_at->format('H:i')); ?></small>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn-action btn-view" 
                                                onclick="viewRegistration(<?php echo e($registration->id); ?>)"
                                                title="Lihat Detail">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <?php if($registration->status == 'pending'): ?>
                                            <button class="btn-action btn-approve" 
                                                    onclick="approveRegistration(<?php echo e($registration->id); ?>)"
                                                    title="Setujui">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <button class="btn-action btn-reject" 
                                                    onclick="rejectRegistration(<?php echo e($registration->id); ?>)"
                                                    title="Tolak">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                                                </svg>
            ...
            <?php if($registrations->hasPages()): ?>
                <div class="d-flex justify-content-between align-items-center p-3" style="border-top: 1px solid var(--border-color);">
                    <div style="color: var(--text-secondary);">
                        Showing <?php echo e($registrations->firstItem()); ?>-<?php echo e($registrations->lastItem()); ?> of <?php echo e($registrations->total()); ?> registrations
                    </div>
        ...
        <?php else: ?>
            ...
            <div class="empty-state">
                ...
                <?php if(request()->hasAny(['search', 'status'])): ?>
                    <a href="<?php echo e(route('admin.student-registrations.index')); ?>" class="btn-secondary">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                        </svg>
                        Reset Filter
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/student-registrations/index.blade.php ENDPATH**/ ?>