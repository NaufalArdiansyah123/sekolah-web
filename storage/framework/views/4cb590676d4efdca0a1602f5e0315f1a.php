        ...
        <div class="nav-section-title">
            ...
            <div class="nav-dropdown" x-data="{ open: <?php echo e(request()->routeIs('teacher.assessment.*') ? 'true' : 'false'); ?> }">
                ...
                <a href="<?php echo e(route('teacher.daily-tests.index')); ?>" 
                   class="nav-dropdown-item <?php echo e(request()->routeIs('teacher.daily-tests.*') ? 'active' : ''); ?>"
                   @click="sidebarOpen = false">
                    📝 Ulangan Harian
                </a>
            </div>
            ...
            <!-- Grades & Reports -->
            <div class="nav-dropdown" x-data="{ open: <?php echo e(request()->routeIs('teacher.grades.*') ? 'true' : 'false'); ?> }">
                <button @click="open = !open" 
                        class="nav-dropdown-btn flex items-center px-4 py-3 text-sm font-medium rounded-lg w-full <?php echo e(request()->routeIs('teacher.grades.*') ? 'active' : ''); ?>"
                        :class="{ 'active': open }">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-show="open" 
                 ...
                 x-transition:leave-end="opacity-0 transform scale-95"
                 class="nav-dropdown-content">
                <a href="<?php echo e(route('teacher.grades.index')); ?>" 
                   class="nav-dropdown-item <?php echo e(request()->routeIs('teacher.grades.index') || request()->routeIs('teacher.grades.show') || request()->routeIs('teacher.grades.edit') || request()->routeIs('teacher.grades.create') ? 'active' : ''); ?>"
                   @click="sidebarOpen = false">
                    📊 Nilai
                </a>
            </div>
