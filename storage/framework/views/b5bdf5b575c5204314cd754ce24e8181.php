...
<div class="user-container">
    ...
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e($users->total() ?? 0); ?></div>
        ...
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e($users->where('email_verified_at', '!=', null)->count() ?? 0); ?></div>
        ...
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e($roles->count() ?? 0); ?></div>
        ...
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e($users->where('created_at', '>=', now()->subDays(30))->count() ?? 0); ?></div>
        ...
        <form method="GET" action="<?php echo e(route('admin.users.index')); ?>" class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <select name="status" class="form-select">
                    ...
                    <option value="verified" <?php echo e(request('status') == 'verified' ? 'selected' : ''); ?>>Active</option>
                    <option value="unverified" <?php echo e(request('status') == 'unverified' ? 'selected' : ''); ?>>Inactive</option>
                </select>
            </div>
            <div class="col-md-2">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="btn-test btn-test-secondary">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="table-container">
        <div class="table-header">
            <h3 class="table-title">
                ...
                User List
                <span class="role-badge role-student"><?php echo e($users->total() ?? 0); ?></span>
            </h3>
...
function exportData() {
    ...
    link.href = `<?php echo e(route('admin.users.index')); ?>?${params.toString()}`;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/users/index.blade.php ENDPATH**/ ?>