<?php
// resources/views/layouts/teacher.blade.php - Enhanced with Admin-like Design & Dark Mode
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo e($title ?? 'Teacher'); ?> - <?php echo e(config('app.name')); ?></title>
    ...
    <!-- Enhanced Styles for Dark Mode & Mobile (Same as Admin) -->
    <style>
        ...
        :root {
            ...
            --accent-light: #059669; /* Teacher green theme */
            ...
            --accent-dark: #10b981; /* Teacher green theme dark */
        ...
        .main-content {
            position: relative;
            z-index: 25; /* Even higher z-index */
            background: var(--bg-secondary); /* Ensure background covers sidebar */
        }
        
        /* Navbar positioning */
        header {
            position: relative;
            z-index: 30; /* Higher than content to ensure dropdown visibility */
            background: var(--bg-primary); /* Ensure background covers sidebar */
        }
...
<body class="font-sans antialiased main-content" x-data="teacherApp()">
    <div x-data="{ sidebarOpen: false }" class="flex h-screen">
        ...
        <div class="main-content-wrapper flex-1 flex flex-col overflow-hidden">
            <!-- Top Navigation -->
            <?php echo $__env->make('layouts.teacher.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/layouts/teacher.blade.php ENDPATH**/ ?>