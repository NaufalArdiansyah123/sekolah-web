<?php if($members->count() > 0): ?>
    ...
    <div class="action-bar mb-4">
        <div class="action-stats">
            <div class="stat-item">
                ...
                <div class="stat-content">
                    <div class="stat-number"><?php echo e($members->count()); ?></div>
            ...
            <div class="stat-item">
                ...
                <div class="stat-content">
                    <div class="stat-number"><?php echo e($extracurricular->coach); ?></div>
        ...
        <div class="action-buttons">
            <button class="action-btn export-btn" onclick="exportMembers(<?php echo e($extracurricular->id); ?>)" title="Export Member List">
                <div class="btn-icon">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button class="action-btn broadcast-btn" onclick="sendBroadcast(<?php echo e($extracurricular->id); ?>)" title="Send Broadcast Message">
                <div class="btn-icon">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button class="action-btn certificate-btn" onclick="generateCertificate(<?php echo e($extracurricular->id); ?>)" title="Generate Certificates">
                <div class="btn-icon">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <td class="dark:text-gray-200">
                            <div class="d-flex align-items-center">
                                <div class="avatar-circle me-3">
                                    <?php echo e(strtoupper(substr($member->student_name, 0, 2))); ?>

                                </div>
                                <div>
                                    <div class="fw-bold"><?php echo e($member->student_name); ?></div>
                                    <div class="text-muted small dark:text-gray-400">NIS: <?php echo e($member->student_nis); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="dark:text-gray-200">
                            <span class="badge bg-primary dark:bg-blue-600"><?php echo e($member->student_class); ?></span>
                            <span class="badge bg-secondary dark:bg-gray-600"><?php echo e($member->student_major); ?></span>
                        </td>
                        <td class="dark:text-gray-200">
                            <div class="small">
                                <div><i class="fas fa-envelope me-1"></i> <?php echo e(Str::limit($member->email, 25)); ?></div>
                                <div><i class="fas fa-phone me-1"></i> <?php echo e($member->phone); ?></div>
                            </div>
                        </td>
                        <td class="dark:text-gray-200">
                            <div class="small">
                                <?php echo e($member->approved_at ? $member->approved_at->format('d M Y') : 'N/A'); ?>

                                <?php if($member->approved_at): ?>
                                    <div class="text-muted dark:text-gray-400"><?php echo e($member->approved_at->format('H:i')); ?></div>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <button class="btn btn-sm btn-outline-info dark:btn-outline-blue-400" 
                                        onclick="showRegistrationDetail(<?php echo e($member->id); ?>)" title="Detail">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <button class="btn btn-sm btn-outline-primary dark:btn-outline-blue-400" 
                                        onclick="contactMember(<?php echo e($member->id); ?>)" title="Kontak">
                                    <i class="fas fa-envelope"></i>
                                </button>
                                <button class="btn btn-sm btn-outline-warning dark:btn-outline-yellow-400" 
                                        onclick="removeFromExtracurricular(<?php echo e($member->id); ?>)" title="Keluarkan">
    ...
    <div class="members-summary">
        <div class="summary-content">
            ...
            <span><?php echo e($members->count()); ?> active members in <?php echo e($extracurricular->name); ?></span>
        </div>
    </div>
<?php else: ?>
    <div class="text-center py-5">
        ...
        <p class="text-muted dark:text-gray-500">
            <strong><?php echo e($extracurricular->name); ?></strong> belum memiliki anggota aktif.
        </p>
        <div class="mt-3">
            ...
            <?php else: ?>
                ...
                <a href="<?php echo e(route('admin.extracurriculars.edit', $extracurricular)); ?>" class="btn btn-warning btn-sm">
...
</script><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/extracurriculars/partials/members-simple.blade.php ENDPATH**/ ?>