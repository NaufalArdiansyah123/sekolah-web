<?php $__env->startSection('title', 'Daftar ' . $extracurricular->name . ' - Ekstrakurikuler - SMA Negeri 99'); ?>
    ...
    <div class="container">
        <div class="hero-content">
            ...
            <nav class="breadcrumb fade-in-up">
                ...
                <a href="<?php echo e(route('public.extracurriculars.index')); ?>">Ekstrakurikuler</a>
                <span class="breadcrumb-separator">/</span>
                <a href="<?php echo e(route('public.extracurriculars.show', $extracurricular)); ?>"><?php echo e($extracurricular->name); ?></a>
                <span class="breadcrumb-separator">/</span>
                <span>Pendaftaran</span>
            </nav>

            <h1 class="hero-title fade-in-up">Daftar <?php echo e($extracurricular->name); ?></h1>
    ...
    <div class="container">
        <div class="registration-container">
            ...
            <div class="registration-form fade-in-left">
                ...
                <form action="<?php echo e(route('public.extracurriculars.store-registration', $extracurricular)); ?>" 
                      method="POST" 
                      id="registrationForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       name="student_name" 
                                       class="form-input <?php $__errorArgs = ['student_name'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       name="student_nis" 
                                       class="form-input <?php $__errorArgs = ['student_nis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       value="<?php echo e(old('student_nis')); ?>" 
                                       placeholder="Nomor Induk Siswa"
                                       required>
                                <?php $__errorArgs = ['student_nis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select name="student_class" 
                                        class="form-input <?php $__errorArgs = ['student_class'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="X" <?php echo e(old('student_class') == 'X' ? 'selected' : ''); ?>>X</option>
                                    <option value="XI" <?php echo e(old('student_class') == 'XI' ? 'selected' : ''); ?>>XI</option>
                                    <option value="XII" <?php echo e(old('student_class') == 'XII' ? 'selected' : ''); ?>>XII</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="student_major" 
                                        class="form-input <?php $__errorArgs = ['student_major'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="IPA" <?php echo e(old('student_major') == 'IPA' ? 'selected' : ''); ?>>IPA</option>
                                    <option value="IPS" <?php echo e(old('student_major') == 'IPS' ? 'selected' : ''); ?>>IPS</option>
                                    <option value="Bahasa" <?php echo e(old('student_major') == 'Bahasa' ? 'selected' : ''); ?>>Bahasa</option>
                                </select>
                                <?php $__errorArgs = ['student_major'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" 
                                       name="parent_name" 
                                       class="form-input <?php $__errorArgs = ['parent_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" 
                                       name="parent_phone" 
                                       class="form-input <?php $__errorArgs = ['parent_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="reason" 
                                      class="form-input form-textarea <?php $__errorArgs = ['reason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="experience" 
                                      class="form-input form-textarea <?php $__errorArgs = ['experience'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                      placeholder="Ceritakan pengalaman Anda yang berkaitan dengan ekstrakurikuler ini (jika ada)"><?php echo e(old('experience')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-actions">
                        <a href="<?php echo e(route('public.extracurriculars.show', $extracurricular)); ?>" class="btn-back">
            ...
            <div class="info-sidebar fade-in-right">
                <div class="extracurricular-info">
                    ...
                    <?php endif; ?>
                    <h3 class="extracurricular-name"><?php echo e($extracurricular->name); ?></h3>
                    <p class="extracurricular-coach">
                        <i class="fas fa-user-tie me-2"></i>
                        <?php echo e($extracurricular->coach); ?>
                ...
                <div class="info-section">
                    ...
                    <?php if($extracurricular->schedule): ?>
                        <div class="info-item">
                            <i class="fas fa-clock info-icon"></i>
                            <div class="info-text">
                                <strong>Jadwal:</strong><br>
                                <?php echo e($extracurricular->schedule); ?>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            ...
                            <?php echo e($extracurricular->registration_count); ?> siswa
                        </div>
                    </div>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-text">
                            ...
                            <?php echo e($extracurricular->status === 'active' ? 'Menerima Pendaftaran' : 'Tutup'); ?>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/public/extracurriculars/register.blade.php ENDPATH**/ ?>