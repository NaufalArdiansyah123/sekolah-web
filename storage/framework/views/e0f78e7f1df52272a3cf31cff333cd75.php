...
<head>
    ...
    <title>Daftar Siswa - <?php echo e(config('app.name', 'SMA Negeri 1')); ?></title>
...
<body>
    <div class="register-container">
        ...
        <div class="register-card">
            ...
            <!-- Registration Form -->
            <form method="POST" action="<?php echo e(route('student.register')); ?>" class="register-form" x-data="registrationForm()">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" 
                                   ...
                                   class="form-input <?php $__errorArgs = ['birth_place'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="address" 
                                      name="address" 
                                      class="form-textarea <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <select id="class" 
                                    name="class" 
                                    class="form-select <?php $__errorArgs = ['class'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="10 TKJ 1" <?php echo e(old('class') == '10 TKJ 1' ? 'selected' : ''); ?>>Kelas 10 TKJ 1 - Teknik Komputer dan Jaringan</option>
                                <option value="10 TKJ 2" <?php echo e(old('class') == '10 TKJ 2' ? 'selected' : ''); ?>>Kelas 10 TKJ 2 - Teknik Komputer dan Jaringan</option>
                                <option value="10 RPL 1" <?php echo e(old('class') == '10 RPL 1' ? 'selected' : ''); ?>>Kelas 10 RPL 1 - Rekayasa Perangkat Lunak</option>
                                <option value="10 RPL 2" <?php echo e(old('class') == '10 RPL 2' ? 'selected' : ''); ?>>Kelas 10 RPL 2 - Rekayasa Perangkat Lunak</option>
                                <option value="10 DKV 1" <?php echo e(old('class') == '10 DKV 1' ? 'selected' : ''); ?>>Kelas 10 DKV 1 - Desain Komunikasi Visual</option>
                            </select>
                            <!-- Hidden input to ensure value is submitted when auto-filled -->
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" 
                                   ...
                                   class="form-input <?php $__errorArgs = ['parent_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="login-link">
                    <p>Sudah memiliki akun? <a href="<?php echo e(route('login')); ?>">Masuk di sini</a></p>
                </div>
            </form>
        </div>
    </div>
            ...
            return {
                ...
                async checkNisAndData() {
                    ...
                    try {
                        ...
                        const nisResponse = await fetch(`<?php echo e(route('student.check-nis')); ?>?nis=${this.form.nis}`);
                        ...
                        if (nisData.available) {
                            const dataResponse = await fetch(`<?php echo e(route('student.check-data')); ?>?nis=${this.form.nis}`);
                ...
                async checkEmail() {
                    ...
                    try {
                        const response = await fetch(`<?php echo e(route('student.check-email')); ?>?email=${this.form.email}`);
...
</html><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/auth/student-register.blade.php ENDPATH**/ ?>