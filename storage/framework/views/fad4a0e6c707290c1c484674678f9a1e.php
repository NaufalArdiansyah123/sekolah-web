...
<div class="gallery-container">
    ...
    <div class="page-header">
        ...
        <a href="<?php echo e(route('admin.gallery.upload')); ?>" class="btn-primary">
    ...
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e(count($photos)); ?></div>
        ...
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e(array_sum(array_column($photos, 'photo_count'))); ?></div>
        ...
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e(count(array_unique(array_column($photos, 'category')))); ?></div>
    ...
    <?php if(count($photos) > 0): ?>
        <div class="albums-container">
            <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="album-item">
                    <?php if(isset($album['photos'][0])): ?>
                        <img src="<?php echo e(asset('storage/' . $album['photos'][0]['thumbnail_path'])); ?>" 
                             alt="<?php echo e($album['title']); ?>" 
                             class="album-image"
                             onerror="this.src='<?php echo e(asset('images/placeholder-image.png')); ?>'">
                    <?php else: ?>
                    ...
                    <div class="album-body">
                        <h3 class="album-name"><?php echo e($album['title']); ?></h3>
                        
                        <?php if($album['description']): ?>
                            <p class="album-desc"><?php echo e($album['description']); ?></p>
                        <?php endif; ?>
                        
                        <div class="album-info">
                            <span class="category-tag category-<?php echo e($album['category']); ?>">
                                <?php echo e(ucfirst(str_replace('_', ' ', $album['category']))); ?>

                            </span>
                            <span><?php echo e($album['photo_count']); ?> photos</span>
                        </div>
                        
                        <div class="album-info">
                            <span><?php echo e(\Carbon\Carbon::parse($album['created_at'])->format('M d, Y')); ?></span>
                            <span>by <?php echo e($album['created_by']); ?></span>
                        </div>
                        
                        <div class="album-controls">
                            <a href="<?php echo e(route('gallery.index', $album['slug'])); ?>" 
                               target="_blank"
                            ...
                            <form action="<?php echo e(route('admin.gallery.destroy', $album['id'])); ?>" 
                                  method="POST" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/gallery/index.blade.php ENDPATH**/ ?>