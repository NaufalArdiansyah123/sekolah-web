...
<div class="space-y-6">
    ...
    <div class="form-container">
        <form method="POST" action="<?php echo e(route('admin.posts.agenda.store')); ?>" id="agendaForm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="content" style="display: none;" required><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select name="status" id="status" class="form-input form-select" required>
                    ...
                    <option value="published" <?php echo e(old('status') == 'published' ? 'selected' : ''); ?>>Dipublikasi</option>
                    <option value="archived" <?php echo e(old('status') == 'archived' ? 'selected' : ''); ?>>Diarsipkan</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <a href="<?php echo e(route('admin.posts.agenda')); ?>" class="btn btn-secondary">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/posts/agenda/create.blade.php ENDPATH**/ ?>