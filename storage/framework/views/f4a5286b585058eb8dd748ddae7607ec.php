...
<?php if($notifications && $notifications->count() > 0): ?>
    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="notification-item <?php echo e($notification->is_read ? 'read' : 'unread'); ?>" 
            ...
            <div class="flex items-start p-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200 group <?php echo e(!$notification->is_read ? 'bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500' : ''); ?>">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-500">
                        <div class="flex items-center">
                            ...
                            <?php echo e($notification->user->name ?? 'System'); ?>
...
</script><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/partials/notifications.blade.php ENDPATH**/ ?>