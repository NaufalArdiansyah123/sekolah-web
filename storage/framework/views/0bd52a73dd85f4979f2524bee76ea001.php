                                        ...
                                        <div class="toggle-item">
                                            ...
                                            <div class="toggle-switch">
                                                ...
                                                <input type="checkbox" id="maintenance_mode" name="maintenance_mode" value="1"
                                                       <?php echo e(old('maintenance_mode', $settings['maintenance_mode']->value ?? '0') == '1' ? 'checked' : ''); ?>>
                                        ...
                                        <div class="toggle-item">
                                            ...
                                            <div class="toggle-switch">
                                                ...
                                                <input type="checkbox" id="allow_registration" name="allow_registration" value="1"
                                                       <?php echo e(old('allow_registration', $settings['allow_registration']->value ?? '1') == '1' ? 'checked' : ''); ?>>
                                        ...
                                        <div class="toggle-item">
                                            ...
                                            <div class="toggle-switch">
                                                ...
                                                <input type="checkbox" id="auto_backup_enabled" name="auto_backup_enabled" value="1"
                                                       <?php echo e(old('auto_backup_enabled', $settings['auto_backup_enabled']->value ?? '0') == '1' ? 'checked' : ''); ?>>
                            ...
                            <div class="setting-card actions-card">
                                ...
                                <div class="card-content">
                                    <div class="actions-grid">
                                        <button type="button" class="action-btn primary" onclick="window.open('<?php echo e(route('admin.backup.index')); ?>', '_blank')">
