...
<div class="announcement-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <a href="<?php echo e(route('admin.announcements.create')); ?>" class="btn-primary">
    ...
    <div class="stats-container">
        ...
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e($announcements->sum('views_count')); ?></div>
    ...
    <div class="filters-container">
        <form method="GET" action="<?php echo e(route('admin.announcements.index')); ?>">
            <div class="filters-row">
                ...
                <div class="filter-group">
                    ...
                    <div style="display: flex; gap: 0.5rem;">
                        ...
                        <a href="<?php echo e(route('admin.announcements.index')); ?>" class="btn-reset">Reset</a>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div class="table-container">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-dropdown">
                                <button type="button" class="dropdown-toggle" onclick="toggleDropdown(<?php echo e($announcement->id); ?>)">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"/>
                                    </svg>
                                </button>
                                <div class="dropdown-menu" id="dropdown-<?php echo e($announcement->id); ?>">
                                    <a class="dropdown-item" href="<?php echo e(route('admin.announcements.show', $announcement->id)); ?>">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                        </svg>
                                    ...
                                    <button class="dropdown-item toggle-status" 
                                        ...
                                        <?php echo e($announcement->status === 'published' ? 'Set Draft' : 'Publish'); ?>
        ...
        <?php else: ?>
            ...
            <div class="empty-state">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('admin.announcements.index')); ?>" class="btn-reset">
                        Clear Filters
                    </a>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/posts/announcement/index.blade.php ENDPATH**/ ?>