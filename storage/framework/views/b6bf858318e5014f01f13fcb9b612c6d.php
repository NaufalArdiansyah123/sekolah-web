...
<div class="user-show-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p class="page-subtitle">Complete information for: <?php echo e($user->name); ?></p>
        </div>
        <div class="header-actions">
            <a href="<?php echo e(route('admin.users.edit', $user)); ?>" class="btn-header primary">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                </svg>
                Edit User
            </a>
            <a href="<?php echo e(route('admin.users.index')); ?>" class="btn-header">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="profile-container">
                ...
                <div class="status-badge <?php echo e($user->email_verified_at ? 'status-active' : 'status-inactive'); ?>">
                    <?php echo e($user->email_verified_at ? 'Active Account' : 'Inactive Account'); ?>
                ...
                <div class="quick-actions">
                    ...
                    <?php if($user->id !== auth()->id()): ?>
                        <button class="quick-action-btn <?php echo e($user->email_verified_at ? 'quick-action-secondary' : 'quick-action-success'); ?> toggle-status-btn"
                                data-user-id="<?php echo e($user->id); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="info-container">
                ...
                <div class="stats-grid">
                    <div class="stat-item">
                        <div class="stat-value"><?php echo e($user->created_at->diffInDays()); ?></div>
                        <div class="stat-label">Days Joined</div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-value"><?php echo e($user->updated_at->diffInHours()); ?>h</div>
            ...
            <div class="info-container">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-meta"><?php echo e($user->created_at->format('H:i')); ?> • <?php echo e($user->created_at->diffForHumans()); ?></div>
                    </div>
                    
                    <div class="info-item">
                        <div class="info-label">Last Updated</div>
                        <div class="info-value"><?php echo e($user->updated_at->format('M d, Y')); ?></div>
                        <div class="info-meta"><?php echo e($user->updated_at->format('H:i')); ?> • <?php echo e($user->updated_at->diffForHumans()); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="info-container">
                ...
                <div class="timeline">
                    <div class="timeline-item">
                        ...
                        <div class="timeline-time"><?php echo e($user->created_at->format('M d, Y \a\t H:i')); ?></div>
                    </div>
                    ...
                    <?php if($user->updated_at != $user->created_at): ?>
                        <div class="timeline-item">
                            ...
                            <div class="timeline-time"><?php echo e($user->updated_at->format('M d, Y \a\t H:i')); ?></div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($user->email_verified_at): ?>
                        <div class="timeline-item">
                            ...
                            <div class="timeline-time"><?php echo e($user->email_verified_at->format('M d, Y \a\t H:i')); ?></div>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/users/show.blade.php ENDPATH**/ ?>