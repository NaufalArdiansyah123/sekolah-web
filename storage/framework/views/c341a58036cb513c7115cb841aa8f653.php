...
<div class="sidebar-nav w-64 flex-shrink-0 md:flex md:flex-col sidebar-content"
    ...
    <div class="nav-section flex-1">
        ...
        <!-- Media & Files -->
        <div class="nav-dropdown" x-data="{ open: <?php echo e(request()->routeIs('admin.downloads.*', 'admin.gallery.*') ? 'true' : 'false'); ?> }">
            <button @click="open = !open" 
                    class="nav-dropdown-btn group flex items-center justify-between px-4 py-3 text-sm font-medium rounded-lg w-full"
                    :class="{ 'active': open }">
                <div class="flex items-center">
            ...
            <div x-show="open" 
                ...
                <a href="<?php echo e(route('admin.downloads.index')); ?>" 
                   class="nav-dropdown-item <?php echo e(request()->routeIs('admin.downloads.*') ? 'active' : ''); ?>"
                   @click="sidebarOpen = false">
                    📥 Downloads
                </a>
