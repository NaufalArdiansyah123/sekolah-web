<?php $__env->startSection('title', $agenda->title); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('agenda.index')); ?>">Agenda</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?php echo e($agenda->title); ?></li>
                </ol>
            </nav>
        </div>
    </section>
        ...
        <div class="container">
            <div class="agenda-detail-container fade-in-up">
                ...
                <div class="agenda-header">
                    <div class="container">
                        <h1 class="agenda-title"><?php echo e($agenda->title); ?></h1>
                        ...
                        <div class="agenda-meta-grid">
                            <?php if($agenda->event_date): ?>
                                <div class="meta-card">
                                    ...
                                    <div class="meta-value">
                                        <?php echo e($agenda->event_date->format('l, d F Y')); ?><br>
                                        <small><?php echo e($agenda->event_date->format('H:i')); ?> WIB</small>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($agenda->location): ?>
                                <div class="meta-card">
                                    ...
                                    <div class="meta-value"><?php echo e($agenda->location); ?></div>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="meta-card">
                                ...
                                <div class="meta-value"><?php echo e($agenda->user->name ?? 'Admin'); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="agenda-actions">
                    <a href="<?php echo e(route('agenda.index')); ?>" class="btn-agenda-action btn-secondary-action">
                    ...
                    <?php if($agenda->event_date && $agenda->event_date->isFuture()): ?>
    ...
    <?php if($relatedAgendas->count() > 0): ?>
        <section class="related-agenda-section">
            <div class="container">
                ...
                <div class="row g-4">
                    <?php $__currentLoopData = $relatedAgendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $relatedAgenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6">
                            <div class="related-agenda-card fade-in-up" style="animation-delay: <?php echo e($index * 0.2); ?>s;">
                                <div class="related-agenda-date">
                                    <?php echo e($relatedAgenda->event_date ? $relatedAgenda->event_date->format('d M Y') : 'TBD'); ?>

                                </div>

                                <div class="related-agenda-content">
                                    <h4 class="related-agenda-title"><?php echo e($relatedAgenda->title); ?></h4>
                                    <div class="related-agenda-meta">
                                        <?php if($relatedAgenda->event_date): ?>
                                            <i class="fas fa-clock me-1"></i> <?php echo e($relatedAgenda->event_date->format('H:i')); ?> WIB
                                        <?php endif; ?>
                                        <?php if($relatedAgenda->location): ?>
                                            • <i class="fas fa-map-marker-alt me-1"></i> <?php echo e($relatedAgenda->location); ?>

                                        <?php endif; ?>
                                    </div>
                                    <a href="<?php echo e(route('agenda.show', $relatedAgenda->id)); ?>" class="related-agenda-link">
                ...
                <div class="text-center mt-4">
                    <a href="<?php echo e(route('agenda.index')); ?>" class="btn-agenda-action btn-primary-action">
    ...
    <script>
        ...
        function shareAgenda() {
            if (navigator.share) {
                navigator.share({
                    title: '<?php echo e($agenda->title); ?>',
                    text: 'Lihat agenda ini: <?php echo e($agenda->title); ?>',
        ...
        function fallbackShare() {
            ...
            const title = encodeURIComponent('<?php echo e($agenda->title); ?>');
        ...
        function addToCalendar() {
            <?php if($agenda->event_date): ?>
                const startDate = new Date('<?php echo e($agenda->event_date->format('Y-m-d\TH:i:s')); ?>');
                ...
                const title = encodeURIComponent('<?php echo e($agenda->title); ?>');
                const description = encodeURIComponent('<?php echo e(strip_tags($agenda->content)); ?>');
                const location = encodeURIComponent('<?php echo e($agenda->location ?? ''); ?>');
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/public/agenda/show.blade.php ENDPATH**/ ?>