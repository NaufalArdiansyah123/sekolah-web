...
<head>
    ...
    <title>Mode Maintenance - <?php echo e($school_name); ?></title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-md w-full">
            ...
            <div class="maintenance-card rounded-2xl p-8 text-center shadow-2xl">
                ...
                <?php if($school_logo): ?>
                    <div class="mb-6">
                        <img src="<?php echo e(asset('storage/' . $school_logo)); ?>" 
                             alt="Logo <?php echo e($school_name); ?>" 
                        ...
                        <div class="space-y-2">
                            <?php if($school_email): ?>
                                <div class="flex items-center justify-center text-white">
                                    ...
                                    <a href="mailto:<?php echo e($school_email); ?>" 
                            ...
                            <?php if($school_phone): ?>
                                <div class="flex items-center justify-center text-white">
                                    ...
                                    <a href="tel:<?php echo e($school_phone); ?>" 
                                       class="hover:text-blue-200 transition-colors">
                                        <?php echo e($school_phone); ?>
...
</html><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/maintenance.blade.php ENDPATH**/ ?>