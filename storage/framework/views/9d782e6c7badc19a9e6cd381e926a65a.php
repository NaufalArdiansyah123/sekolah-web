...
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                    Hasil Kuis: <?php echo e($attempt->quiz->title); ?>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div class="text-center">
                        <div class="text-4xl font-bold mb-2 <?php echo e($attempt->score >= 80 ? 'text-green-600 dark:text-green-400' : ($attempt->score >= 60 ? 'text-yellow-600 dark:text-yellow-400' : 'text-red-600 dark:text-red-400')); ?>">
                    ...
                    <div class="text-center">
                        <div class="text-4xl font-bold mb-2 <?php echo e($attempt->score >= 80 ? 'text-green-600 dark:text-green-400' : ($attempt->score >= 60 ? 'text-yellow-600 dark:text-yellow-400' : 'text-red-600 dark:text-red-400')); ?>">
                            <?php echo e($attempt->grade_letter ?? 'N/A'); ?>
                    ...
                    <div class="text-center">
                        <div class="text-4xl font-bold text-purple-600 dark:text-purple-400 mb-2">
                            <?php echo e($attempt->completed_at ? $attempt->completed_at->format('H:i') : 'N/A'); ?>
        ...
        <!-- Detailed Results -->
        <?php if($attempt->quiz->show_results): ?>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-start justify-between mb-4">
                                ...
                                <div class="flex items-center space-x-2">
                                    <span class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($question->points); ?> poin</span>
                                    <?php if($isCorrect): ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="p-3 rounded-lg <?php echo e($isCorrect ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800' : 'bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800'); ?>">
                                        <span class="<?php echo e($isCorrect ? 'text-green-800 dark:text-green-200' : 'text-red-800 dark:text-red-200'); ?>">
                                            <?php echo e($answer->answer ?? 'Tidak dijawab'); ?>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/student/quizzes/result.blade.php ENDPATH**/ ?>