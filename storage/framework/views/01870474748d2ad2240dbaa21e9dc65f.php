...
<link rel="stylesheet" href="<?php echo e(asset('css/public-template.css')); ?>">
<style>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div class="fade-in-up">
                    <a href="<?php echo e(route('about.profile')); ?>" class="btn btn-hero btn-hero-primary me-3">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-center">
                <a href="<?php echo e(route('about.profile')); ?>" class="btn btn-light btn-lg px-4 py-2 btn-enhanced scale-in me-3" style="animation-delay: 0.4s;">
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/public/about/vision.blade.php ENDPATH**/ ?>