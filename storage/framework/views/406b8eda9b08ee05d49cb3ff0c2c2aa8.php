<?php $__env->startSection('title', 'Manajemen Ekstrakurikuler'); ?>
    ...
    <div class="extracurricular-container">
        ...
        <div class="page-header">
            <div class="header-content">
                ...
                <a href="<?php echo e(route('admin.extracurriculars.create')); ?>" class="btn-primary">
        ...
        <div class="stats-container">
            <div class="stat-item">
                ...
                <div class="stat-value"><?php echo e($extracurriculars->total()); ?></div>
            ...
            <div class="stat-item">
                ...
                <div class="stat-value"><?php echo e($activeExtracurriculars); ?></div>
            ...
            <div class="stat-item">
                ...
                <div class="stat-value"><?php echo e($totalMembers); ?></div>
            ...
            <div class="stat-item">
                ...
                <div class="stat-value"><?php echo e($pendingRegistrations); ?></div>
                ...
                <div class="test-buttons">
                    ...
                    <?php if($pendingRegistrations > 0): ?>
                        <button class="btn-test btn-test-warning" onclick="showPendingRegistrations()">
                            ...
                            View <?php echo e($pendingRegistrations); ?> Registrations
                        </button>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <?php if($pendingRegistrations > 0): ?>
            <div class="alert alert-warning" role="alert">
                ...
                <div class="flex-grow-1">
                    <strong>Attention!</strong> There are <?php echo e($pendingRegistrations); ?> registrations waiting for approval.
                </div>
                <button class="btn-test btn-test-warning" onclick="showPendingRegistrations()">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $extracurriculars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $extracurricular): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($extracurriculars->firstItem() + $index); ?></td>
                                    <td>
                                        <div class="extracurricular-title"><?php echo e($extracurricular->name); ?></div>
                                        <div class="extracurricular-description"><?php echo e(Str::limit($extracurricular->description, 80)); ?>
                                    ...
                                    <td><?php echo e($extracurricular->coach); ?></td>
                                    <td>
                                        <span class="badge badge-<?php echo e($extracurricular->status == 'aktif' ? 'active' : 'inactive'); ?>">
                                    ...
                                    <td>
                                        <div>
                                            <span class="stats-badge">
                                                <?php echo e($extracurricular->registrations->where('status', 'approved')->count()); ?>
                                    ...
                                    <td>
                                        <div style="font-size: 0.8rem; color: var(--text-secondary);">
                                            <?php echo e($extracurricular->jadwal ?? 'Not scheduled'); ?>

                                        </div>
                                    </td>
                                    <td>
                                        <div style="font-size: 0.8rem; color: var(--text-secondary);">
                                            <?php echo e($extracurricular->created_at->format('M d, Y')); ?>

                                        </div>
                                        <div style="font-size: 0.75rem; color: var(--text-tertiary);">
                                            <?php echo e($extracurricular->created_at->format('H:i')); ?>
                                    ...
                                    <td>
                                        ...
                                        <div class="action-dropdown">
                                            <button type="button" class="dropdown-toggle"
                                                onclick="toggleDropdown(<?php echo e($extracurricular->id); ?>)" title="Actions">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            <div class="dropdown-menu" id="dropdown-<?php echo e($extracurricular->id); ?>">
                                                <!-- View Action -->
                                                <a class="dropdown-item action-view"
                                                    href="<?php echo e(route('admin.extracurriculars.show', $extracurricular->id)); ?>"
                                                    title="View Details">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                            d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                                ...
                                                <a class="dropdown-item action-edit"
                                                    href="<?php echo e(route('admin.extracurriculars.edit', $extracurricular->id)); ?>"
                                                ...
                                                <button class="dropdown-item action-members"
                                                    onclick="showMembers(<?php echo e($extracurricular->id); ?>)" title="View Members">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                            d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                                    </svg>
                                                    <span>View Members
                                                        (<?php echo e($extracurricular->registrations->where('status', 'approved')->count()); ?>)</span>
                                                </button>
                                                ...
                                                <?php if($extracurricular->registrations->where('status', 'pending')->count() > 0): ?>
                                                    <button class="dropdown-item action-registrations"
                                                        onclick="showRegistrations(<?php echo e($extracurricular->id); ?>)"
                                                        ...
                                                        <span>Pending Registrations
                                                            (<?php echo e($extracurricular->registrations->where('status', 'pending')->count()); ?>)</span>
                                                    </button>
                                                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/extracurriculars/index.blade.php ENDPATH**/ ?>