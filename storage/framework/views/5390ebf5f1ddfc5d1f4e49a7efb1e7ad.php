...
<div class="announcement-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p class="page-subtitle">Update and manage your announcement details</p>
    ...
    <div class="form-container">
        ...
        <form action="<?php echo e(route('admin.announcements.update', $announcement->id)); ?>" method="POST" id="announcementForm" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('judul', $announcement->title)); ?>" 
                                   required
                                   maxlength="200"
...
unset($__errorArgs, $__bag); ?>" 
                                      required
                                      placeholder="Write your announcement content here..."><?php echo e(old('isi', $announcement->content)); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload-container">
                                ...
                                <input type="hidden" 
                                       name="gambar" 
                                       id="gambar" 
                                       value="<?php echo e(old('gambar', $announcement->image ?? $announcement->featured_image)); ?>">
                            </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="info-panel">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value">#<?php echo e($announcement->id); ?></span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Views</span>
                                <span class="info-value"><?php echo e($announcement->views_count ?? 0); ?></span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Slug</span>
                                <span class="info-value"><?php echo e($announcement->slug); ?></span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Created</span>
                                <span class="info-value"><?php echo e($announcement->created_at->format('M d, Y H:i')); ?></span>
                            </div>
                            <div class="info-item">
                                <span class="info-label">Updated</span>
                                <span class="info-value"><?php echo e($announcement->updated_at->format('M d, Y H:i')); ?></span>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="akademik" <?php echo e(old('kategori', $announcement->category) === 'akademik' ? 'selected' : ''); ?>>Academic</option>
                                <option value="kegiatan" <?php echo e(old('kategori', $announcement->category) === 'kegiatan' ? 'selected' : ''); ?>>Activities</option>
                                <option value="administrasi" <?php echo e(old('kategori', $announcement->category) === 'administrasi' ? 'selected' : ''); ?>>Administration</option>
                                <option value="umum" <?php echo e(old('kategori', $announcement->category) === 'umum' ? 'selected' : ''); ?>>General</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="low" <?php echo e(old('prioritas', $announcement->priority) === 'low' ? 'selected' : ''); ?>>Low</option>
                                <option value="normal" <?php echo e(old('prioritas', $announcement->priority) === 'normal' ? 'selected' : ''); ?>>Normal</option>
                                <option value="high" <?php echo e(old('prioritas', $announcement->priority) === 'high' ? 'selected' : ''); ?>>High</option>
                                <option value="urgent" <?php echo e(old('prioritas', $announcement->priority) === 'urgent' ? 'selected' : ''); ?>>Urgent</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('penulis', $announcement->author)); ?>" 
                                   required
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="draft" <?php echo e(old('status', $announcement->status) === 'draft' ? 'selected' : ''); ?>>Draft</option>
                                <option value="published" <?php echo e(old('status', $announcement->status) === 'published' ? 'selected' : ''); ?>>Published</option>
                                <option value="archived" <?php echo e(old('status', $announcement->status) === 'archived' ? 'selected' : ''); ?>>Archived</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('tanggal_publikasi', $announcement->published_at ? $announcement->published_at->format('Y-m-d\TH:i') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-actions">
                <div style="display: flex; gap: 0.5rem;">
                    ...
                    <a href="<?php echo e(route('admin.announcements.show', $announcement->id)); ?>" class="btn-secondary">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // File Upload Functionality (same as create page)
    ...
    if (gambarInput.value) {
        ...
        imagePreviewContainer.style.display = 'block';
        imageUrl.value = gambarInput.value;
        imageInfo.innerHTML = `
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/posts/announcement/edit.blade.php ENDPATH**/ ?>