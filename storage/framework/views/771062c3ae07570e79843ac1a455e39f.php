...
<div class="space-y-6">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-value"><?php echo e($videos->where('status', 'active')->count()); ?></div>
            <div class="stat-label">Active Videos</div>
        </div>
        <div class="stat-card">
            <div class="stat-value"><?php echo e($videos->where('is_featured', true)->count()); ?></div>
            <div class="stat-label">Featured Videos</div>
        </div>
        <div class="stat-card">
            <div class="stat-value"><?php echo e(number_format($videos->sum('views'))); ?></div>
                ...
                <div class="video-card">
                    ...
                    <div class="video-thumbnail">
                        ...
                        <?php else: ?>
                            <div class="flex flex-col items-center text-white">
                                ...
                                <span class="text-sm"><?php echo e(strtoupper($video->category)); ?></span>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="video-info">
                        ...
                        <div class="video-meta">
                            ...
                            <span class="video-badge badge-status-<?php echo e($video->status); ?>"><?php echo e($statuses[$video->status]); ?></span>
                        ...
                        <div class="video-stats">
                            <span>👁️ <?php echo e(number_format($video->views)); ?> views</span>
                        ...
                        <div class="video-actions">
                            <a href="<?php echo e(route('admin.videos.show', $video)); ?>" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/videos/index.blade.php ENDPATH**/ ?>