...
<script src="<?php echo e(asset('js/assignment-realtime.js')); ?>"></script>
<?php $__env->stopPush(); ?>
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-300">
                        <?php echo e($assignment->title); ?> • <?php echo e($assignment->subject); ?>

                    </p>
                </div>
                
                <div class="mt-6 lg:mt-0 flex space-x-3">
                    <a href="<?php echo e(route('teacher.assignments.submissions', $assignment->id)); ?>" 
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
                    ...
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <span class="bg-<?php echo e($assignment->status === 'published' || $assignment->status === 'active' ? 'green' : ($assignment->status === 'draft' ? 'yellow' : 'red')); ?>-100 text-<?php echo e($assignment->status === 'published' || $assignment->status === 'active' ? 'green' : ($assignment->status === 'draft' ? 'yellow' : 'red')); ?>-800 dark:bg-<?php echo e($assignment->status === 'published' || $assignment->status === 'active' ? 'green' : ($assignment->status === 'draft' ? 'yellow' : 'red')); ?>-900 dark:text-<?php echo e($assignment->status === 'published' || $assignment->status === 'active' ? 'green' : ($assignment->status === 'draft' ? 'yellow' : 'red')); ?>-200 px-3 py-1 rounded-full text-sm font-medium">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                            ...
                            <div class="flex items-center text-gray-600 dark:text-gray-400">
                                ...
                                <?php echo e($assignment->class ?? 'Semua Kelas'); ?>
                            ...
                            <div class="flex items-center <?php echo e($assignment->due_date < now() ? 'text-red-600 dark:text-red-400' : 'text-gray-600 dark:text-gray-400'); ?>">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-6">
                        ...
                        <?php if($assignment->attachment_path): ?>
                            <div>
                                ...
                                <a href="<?php echo e(Storage::url($assignment->attachment_path)); ?>" 
                                   target="_blank"
                                   class="inline-flex items-center px-4 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-colors">
                                    ...
                                    <?php echo e($assignment->attachment_name ?? 'Download File'); ?>
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-sm text-gray-600 dark:text-gray-400">
                                    <?php echo e($submissionStats['submitted']); ?>/<?php echo e($submissionStats['total_students']); ?> siswa
                                </span>
                            </div>
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                                <div class="bg-gradient-to-r from-blue-500 to-green-500 h-3 rounded-full transition-all duration-500" 
                                     style="width: <?php echo e($submissionStats['submission_percentage']); ?>%"></div>
                            </div>
                            <div class="flex justify-between text-xs text-gray-600 dark:text-gray-400 mt-1">
                                <span><?php echo e($submissionStats['submission_percentage']); ?>% terkumpul</span>
                                <span><?php echo e($submissionStats['pending']); ?> belum mengumpulkan</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-sm text-gray-600 dark:text-gray-400">
                                    <?php echo e($submissionStats['graded']); ?>/<?php echo e($submissionStats['submitted']); ?> dinilai
                                </span>
                            </div>
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                                <div class="bg-gradient-to-r from-purple-500 to-pink-500 h-3 rounded-full transition-all duration-500" 
                                     style="width: <?php echo e($submissionStats['grading_percentage']); ?>%"></div>
                            </div>
                            <div class="flex justify-between text-xs text-gray-600 dark:text-gray-400 mt-1">
                                <span><?php echo e($submissionStats['grading_percentage']); ?>% dinilai</span>
                                <span><?php echo e($submissionStats['ungraded']); ?> belum dinilai</span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                            <div class="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                <div class="text-2xl font-bold text-blue-600 dark:text-blue-400"><?php echo e($submissionStats['submitted']); ?></div>
                                <div class="text-sm text-gray-600 dark:text-gray-400">Terkumpul</div>
                            </div>
                            <div class="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                <div class="text-2xl font-bold text-green-600 dark:text-green-400"><?php echo e($submissionStats['graded']); ?></div>
                                <div class="text-sm text-gray-600 dark:text-gray-400">Dinilai</div>
                            </div>
                            <div class="text-center p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                                <div class="text-2xl font-bold text-yellow-600 dark:text-yellow-400"><?php echo e($submissionStats['ungraded']); ?></div>
                                <div class="text-sm text-gray-600 dark:text-gray-400">Belum Dinilai</div>
                            </div>
                            <div class="text-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                                <div class="text-2xl font-bold text-purple-600 dark:text-purple-400"><?php echo e(round($submissionStats['average_score'], 1)); ?></div>
                                        ...
                                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                            <div class="flex items-center">
                                                <img class="h-8 w-8 rounded-full" 
                                                     src="<?php echo e($submission->student->avatar ?? 'https://ui-avatars.com/api/?name='.urlencode($submission->student->name).'&color=7C3AED&background=EDE9FE'); ?>" 
                                                     alt="<?php echo e($submission->student->name); ?>">
                                                <div class="ml-3">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <?php if($submission->graded_at): ?>
                                                    <span class="text-xs bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 px-2 py-1 rounded">
                                                        <?php echo e($submission->score); ?>/<?php echo e($assignment->max_score); ?>
                                                ...
                                                <?php endif; ?>
                                                <a href="<?php echo e(route('teacher.assignments.grade', [$assignment->id, $submission->id])); ?>" 
                                                   class="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 text-sm">
                                                    <?php echo e($submission->graded_at ? 'Edit' : 'Nilai'); ?>
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="font-medium text-gray-900 dark:text-white"><?php echo e($assignment->max_score); ?> poin</div>
                        </div>
                        
                        <div>
                            <span class="text-sm text-gray-600 dark:text-gray-400">Total Siswa:</span>
                            <div class="font-medium text-gray-900 dark:text-white"><?php echo e($submissionStats['total_students']); ?> siswa</div>
                        </div>
                        
                        <div>
                            <span class="text-sm text-gray-600 dark:text-gray-400">Dibuat pada:</span>
                            <div class="font-medium text-gray-900 dark:text-white"><?php echo e($assignment->created_at->format('d M Y')); ?></div>
                        </div>
                        
                        <div>
                            <span class="text-sm text-gray-600 dark:text-gray-400">Deadline:</span>
                            <div class="font-medium text-gray-900 dark:text-white"><?php echo e($assignment->due_date->format('d M Y, H:i')); ?></div>
                        </div>
                        
                        <?php if($assignment->due_date < now()): ?>
                            <div class="p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                                <div class="text-sm text-red-800 dark:text-red-200 font-medium">
                                    Deadline terlewat <?php echo e($assignment->due_date->diffForHumans()); ?>
                        ...
                        <?php else: ?>
                            <div class="p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                                <div class="text-sm text-blue-800 dark:text-blue-200 font-medium">
                                    Deadline <?php echo e($assignment->due_date->diffForHumans()); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <?php if($submissionStats['ungraded'] > 0): ?>
                            <button onclick="window.location.href='<?php echo e(route('teacher.assignments.submissions', $assignment->id)); ?>?grading_status=ungraded'" 
                                    class="w-full bg-purple-600 hover:bg-purple-700 text-white text-center py-2 px-4 rounded-lg font-medium transition-colors">
                                Nilai Tugas (<?php echo e($submissionStats['ungraded']); ?>)
                            </button>
                        <?php endif; ?>
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
        <div class="mt-3 text-center">
            ...
            <div class="items-center px-4 py-3">
                <form action="<?php echo e(route('teacher.assignments.destroy', $assignment->id)); ?>" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/teacher/learning/assignments/show.blade.php ENDPATH**/ ?>