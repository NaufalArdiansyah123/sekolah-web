            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($stats['total_assignments']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($stats['draft']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900 dark:text-white"><?php echo e($stats['total_submissions']); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form method="GET" class="flex flex-col lg:flex-row gap-4">
                ...
                <div class="flex-1">
                    ...
                    <select name="status" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                        ...
                        <option value="draft" <?php echo e($currentFilters['status'] == 'draft' ? 'selected' : ''); ?>>Draft</option>
                        <option value="published" <?php echo e($currentFilters['status'] == 'published' ? 'selected' : ''); ?>>Published</option>
                        <option value="active" <?php echo e($currentFilters['status'] == 'active' ? 'selected' : ''); ?>>Active</option>
                        <option value="completed" <?php echo e($currentFilters['status'] == 'completed' ? 'selected' : ''); ?>>Completed</option>
                    </select>
                </div>
                    ...
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="mb-4">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($totalSubmissions); ?>/<?php echo e($totalStudents); ?></span>
                            </div>
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                <div class="bg-blue-500 h-2 rounded-full transition-all duration-300" style="width: <?php echo e($submissionPercentage); ?>%"></div>
                            </div>
                            <div class="text-xs text-gray-600 dark:text-gray-400 mt-1"><?php echo e($submissionPercentage); ?>% siswa mengumpulkan</div>
                        </div>
                        ...
                        <?php if($totalSubmissions > 0): ?>
                            <div class="mb-4">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <span class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($gradedSubmissions); ?>/<?php echo e($totalSubmissions); ?></span>
                                </div>
                                <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                    <div class="bg-green-500 h-2 rounded-full transition-all duration-300" style="width: <?php echo e($gradingPercentage); ?>%"></div>
                                </div>
                                <div class="text-xs text-gray-600 dark:text-gray-400 mt-1"><?php echo e($gradingPercentage); ?>% sudah dinilai</div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="grid grid-cols-3 gap-2 text-center">
                            <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-2">
                                <div class="text-lg font-bold text-blue-600 dark:text-blue-400"><?php echo e($totalSubmissions); ?></div>
                            ...
                            <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-2">
                                <div class="text-lg font-bold text-green-600 dark:text-green-400"><?php echo e($gradedSubmissions); ?></div>
                            ...
                            <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-2">
                                <div class="text-lg font-bold text-yellow-600 dark:text-yellow-400"><?php echo e($totalSubmissions - $gradedSubmissions); ?></div>
                            ...
                            <?php if($totalSubmissions > 0): ?>
                                <a href="<?php echo e(route('teacher.assignments.submissions', $assignment->id)); ?>" 
                                   class="flex-1 bg-green-600 hover:bg-green-700 text-white text-center py-2 px-3 rounded-lg font-medium transition-colors text-sm">
                                    Kelola (<?php echo e($totalSubmissions); ?>)
                                </a>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/teacher/learning/assignments/index.blade.php ENDPATH**/ ?>