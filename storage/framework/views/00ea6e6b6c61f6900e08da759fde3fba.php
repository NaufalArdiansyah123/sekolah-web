        ...
        <div class="hero-content">
            ...
            <?php if(isset($albums) && count($albums) > 0): ?>
                <div class="hero-stats">
                    <div class="hero-stat">
                        <div class="hero-stat-number"><?php echo e(count($albums)); ?></div>
                        <div class="hero-stat-label">Total Album</div>
                    </div>
                    <div class="hero-stat">
                        <div class="hero-stat-number" id="totalPhotos">
                            <?php echo e(array_sum(array_column($albums, 'photo_count')) ?: array_sum(array_map(function ($album) {
                return count($album['photos'] ?? []); }, $albums))); ?>
                    ...
                    <div class="hero-stat">
                        <div class="hero-stat-number"><?php echo e(count(array_unique(array_column($albums, 'category')))); ?></div>
        ...
        <?php if(isset($albums) && count($albums) > 0): ?>
            ...
            <div class="filter-section">
                ...
                <div class="category-filters">
                    <button class="filter-btn active" data-category="all">
                        ...
                        Semua Album
                        <span class="filter-count"><?php echo e(count($albums)); ?></span>
                    </button>
                    <?php
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <button class="filter-btn" data-category="<?php echo e($category); ?>">
                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="<?php echo e($categoryIcons[$category] ?? 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10'); ?>" />
                            </svg>
                            <?php echo e($categoryLabels[$category] ?? ucfirst(str_replace('_', ' ', $category))); ?>

                            <span class="filter-count"><?php echo e($count); ?></span>
                        </button>
            ...
            <div class="results-info">
                <div class="results-count">
                    Menampilkan <span id="visibleCount"><?php echo e(count($albums)); ?></span> dari <span
                        id="totalCount"><?php echo e(count($albums)); ?></span> album
                </div>
            ...
            <div class="albums-grid grid-view" id="albumsGrid">
                <?php $__currentLoopData = $albums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="album-card" data-category="<?php echo e($album['category']); ?>" data-title="<?php echo e(strtolower($album['title'])); ?>"
                        data-description="<?php echo e(strtolower($album['description'] ?? '')); ?>"
                        data-date="<?php echo e($album['created_at'] ?? ''); ?>"
                        data-photos="<?php echo e($album['photo_count'] ?? count($album['photos'] ?? [])); ?>"
                        onclick="window.location.href='<?php echo e(route('gallery.show', $album['slug'])); ?>'">
                        <?php if(isset($album['photos'][0])): ?>
                            <img src="<?php echo e(asset('storage/' . $album['photos'][0]['thumbnail_path'])); ?>" alt="<?php echo e($album['title']); ?>"
                                class="album-thumbnail" loading="lazy"
                                onerror="this.src='<?php echo e(asset('images/placeholder-gallery.jpg')); ?>'">
                        <?php else: ?>
                        ...
                        <div class="album-content">
                            ...
                            <?php if(!empty($album['description'])): ?>
                                <p class="album-description"><?php echo e(Str::limit($album['description'], 120)); ?></p>
                            <?php endif; ?>

                            <div class="album-meta">
                                <span class="category-badge category-<?php echo e($album['category']); ?>">
                                    <?php echo e($categoryLabels[$album['category']] ?? ucfirst(str_replace('_', ' ', $album['category']))); ?>
                                ...
                                <div class="photo-count">
                                    ...
                                    <?php echo e($album['photo_count'] ?? count($album['photos'] ?? [])); ?> Foto
                                </div>
                            </div>
                            ...
                            <div class="album-date">
                                ...
                                <?php echo e(isset($album['created_at']) ? \Carbon\Carbon::parse($album['created_at'])->locale('id')->isoFormat('D MMMM Y') : 'Tanggal tidak tersedia'); ?>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/public/gallery/index.blade.php ENDPATH**/ ?>