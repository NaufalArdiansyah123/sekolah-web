<?php $__env->startSection('title', 'Edit Ekstrakurikuler - ' . $extracurricular->name); ?>
...
<div class="extracurricular-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <div class="header-actions">
                ...
                <a href="<?php echo e(route('admin.extracurriculars.show', $extracurricular->id)); ?>" class="btn-info">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="form-container">
        ...
        <form action="<?php echo e(route('admin.extracurriculars.update', $extracurricular->id)); ?>" method="POST" enctype="multipart/form-data" id="extracurricularForm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               id="name" 
                               name="name" 
                               value="<?php echo e(old('name', $extracurricular->name)); ?>" 
                               placeholder=" "
                               maxlength="100"
                               required>
...
unset($__errorArgs, $__bag); ?>
                        <div class="char-counter" id="nameCounter"><?php echo e(strlen($extracurricular->name)); ?>/100</div>
                    </div>

                    <!-- Coach -->
                    <div class="form-group required floating-label">
                        <input type="text" 
                               class="form-control <?php $__errorArgs = ['coach'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               id="coach" 
                               name="coach" 
                               value="<?php echo e(old('coach', $extracurricular->coach)); ?>" 
                               placeholder=" "
                               maxlength="100"
                               required>
...
unset($__errorArgs, $__bag); ?>
                        <div class="char-counter" id="coachCounter"><?php echo e(strlen($extracurricular->coach)); ?>/100</div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" 
                              ...
                              maxlength="500"
                              required><?php echo e(old('description', $extracurricular->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    <div class="char-counter" id="descriptionCounter"><?php echo e(strlen($extracurricular->description)); ?>/500</div>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group floating-label">
                        <input type="text" 
                               class="form-control <?php $__errorArgs = ['jadwal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                               id="jadwal" 
                               name="jadwal" 
                               value="<?php echo e(old('jadwal', $extracurricular->jadwal)); ?>" 
                               placeholder=" "
                               maxlength="100">
...
unset($__errorArgs, $__bag); ?>
                        <div class="char-counter" id="jadwalCounter"><?php echo e(strlen($extracurricular->jadwal ?? '')); ?>/100</div>
                    </div>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="aktif" <?php echo e(old('status', $extracurricular->status) == 'aktif' ? 'selected' : ''); ?>>Aktif</option>
                            <option value="tidak_aktif" <?php echo e(old('status', $extracurricular->status) == 'tidak_aktif' ? 'selected' : ''); ?>>Tidak Aktif</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload-container" id="fileUploadContainer">
                        <input type="file" 
                               class="file-upload-input <?php $__errorArgs = ['gambar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                        ...
                        <div class="file-upload-content">
                            ...
                            <div class="file-upload-text">
                                <?php echo e($extracurricular->gambar ? 'Klik untuk mengganti gambar' : 'Klik untuk upload atau drag & drop'); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-actions">
                <a href="<?php echo e(route('admin.extracurriculars.show', $extracurricular->id)); ?>" class="btn btn-outline">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const originalValues = {
        name: '<?php echo e($extracurricular->name); ?>',
        coach: '<?php echo e($extracurricular->coach); ?>',
        description: '<?php echo e($extracurricular->description); ?>',
        jadwal: '<?php echo e($extracurricular->jadwal ?? ''); ?>',
        status: '<?php echo e($extracurricular->status); ?>'
    };
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/extracurriculars/edit.blade.php ENDPATH**/ ?>