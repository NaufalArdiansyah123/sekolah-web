    ...
    <div class="content-wrapper">
            ...
            <div class="header-content">
                <div>
                    ...
                    <p class="header-subtitle">
                        Pantau semua aktivitas sistem - <?php echo e($stats['total']); ?> total, <?php echo e($stats['unread']); ?> belum dibaca
                    </p>
                </div>
        ...
        <div class="main-content-inner">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($stats['unread']); ?></div>
            ...
            <div class="filter-section">
                ...
                <div class="filter-tabs">
                    <a href="<?php echo e(route('admin.notifications.index')); ?>" 
                       class="filter-tab <?php echo e(!request('type') ? 'active' : ''); ?>">
                        <i class="fas fa-list"></i>
                        Semua 
                        <span class="badge"><?php echo e($stats['total']); ?></span>
                    </a>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('admin.notifications.index', ['type' => $type])); ?>" 
                           class="filter-tab <?php echo e(request('type') == $type ? 'active' : ''); ?>">
                            <i class="fas fa-<?php echo e($type == 'student' ? 'user-graduate' : ($type == 'teacher' ? 'chalkboard-teacher' : ($type == 'gallery' ? 'images' : ($type == 'video' ? 'video' : 'bell')))); ?>"></i>
                            <?php echo e($label); ?> 
                            <?php if(isset($categoryStats[$type])): ?>
                                <span class="badge"><?php echo e($categoryStats[$type]); ?></span>
                            <?php endif; ?>
                        </a>
                ...
                <div class="advanced-filters">
                    <form method="GET" action="<?php echo e(route('admin.notifications.index')); ?>" class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="search" class="form-control" placeholder="Cari notifikasi..." value="<?php echo e(request('search')); ?>">
                        </div>
                        <div class="col-md-2">
                    ...
                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="notification-item <?php echo e($notification->is_read ? 'read' : 'unread'); ?>" 
                            ...
                            <div class="notification-content">
                                <div class="notification-icon <?php echo e($notification->color_class); ?>">
                                ...
                                <div class="notification-details">
                                    ...
                                    <div class="notification-meta">
                                        <span class="notification-user"><?php echo e($notification->user->name); ?></span>
                                        <span class="notification-time"><?php echo e($notification->time_ago); ?></span>
                                    </div>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/notifications/index.blade.php ENDPATH**/ ?>