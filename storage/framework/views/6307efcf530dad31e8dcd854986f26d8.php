<?php $__env->startSection('title', 'Student Attendance Management'); ?>
...
<div class="attendance-container">
        ...
        <div class="header-content">
            <div class="header-info">
                ...
                <div style="display: flex; gap: 1rem; margin-top: 1rem; font-size: 0.875rem;">
                    <span>📅 <?php echo e(\Carbon\Carbon::parse($selectedDate)->format('l, d F Y')); ?></span>
                    <span>🏫 Class <?php echo e($selectedClass); ?></span>
                    <span>👥 <?php echo e(count($students)); ?> Students</span>
                </div>
            </div>
    ...
    <div class="controls-section">
        <form method="GET" action="<?php echo e(route('teacher.attendance.index')); ?>" id="attendanceForm">
                ...
                <div class="control-group">
                    ...
                    <select name="class" 
                        ...
                        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($class); ?>" <?php echo e($selectedClass == $class ? 'selected' : ''); ?>>
                                <?php echo e($class); ?>
    ...
    <div class="stats-container">
        <div class="stat-card">
            <div class="stat-header">
                ...
                <div class="stat-percentage percentage-high"><?php echo e($statistics['present_percentage']); ?>%</div>
            </div>
            <div class="stat-value"><?php echo e($statistics['present']); ?></div>
        ...
        <div class="stat-card">
            <div class="stat-header">
                ...
                <div class="stat-percentage percentage-low"><?php echo e(round(($statistics['absent'] / $statistics['total']) * 100, 1)); ?>%</div>
            </div>
            <div class="stat-value"><?php echo e($statistics['absent']); ?></div>
        ...
        <div class="stat-card">
            <div class="stat-header">
                ...
                <div class="stat-percentage percentage-medium"><?php echo e(round(($statistics['sick'] / $statistics['total']) * 100, 1)); ?>%</div>
            </div>
            <div class="stat-value"><?php echo e($statistics['sick']); ?></div>
        ...
        <div class="stat-card">
            <div class="stat-header">
                ...
                <div class="stat-percentage percentage-medium"><?php echo e(round(($statistics['permission'] / $statistics['total']) * 100, 1)); ?>%</div>
            </div>
            <div class="stat-value"><?php echo e($statistics['permission']); ?></div>
    ...
    <div class="students-section">
        ...
        <div class="students-grid">
            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <div class="student-card" data-student-id="<?php echo e($student->id); ?>">
                    <div class="attendance-status status-<?php echo e($status); ?>"></div>
                    ...
                    <div class="attendance-controls">
                        <button class="status-btn present <?php echo e($status == 'present' ? 'active' : ''); ?>" 
                                onclick="markAttendance(<?php echo e($student->id); ?>, 'present', this)">
                            ✓ Hadir
                        </button>
                        <button class="status-btn absent <?php echo e($status == 'absent' ? 'active' : ''); ?>" 
                                onclick="markAttendance(<?php echo e($student->id); ?>, 'absent', this)">
                            ✗ Alpha
                        </button>
                        <button class="status-btn sick <?php echo e($status == 'sick' ? 'active' : ''); ?>" 
                                onclick="markAttendance(<?php echo e($student->id); ?>, 'sick', this)">
                            🏥 Sakit
                        </button>
                        <button class="status-btn permission <?php echo e($status == 'permission' ? 'active' : ''); ?>" 
                                onclick="markAttendance(<?php echo e($student->id); ?>, 'permission', this)">
                            📋 Izin
                        </button>
                    </div>

                    <div class="attendance-details" id="details-<?php echo e($student->id); ?>">
                        <div class="detail-row">
                            <span class="detail-label">Status:</span>
                            <span class="detail-value" id="status-text-<?php echo e($student->id); ?>">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value"><?php echo e($attendance->time_in); ?></span>
                        </div>
                        <?php endif; ?>
                        <?php if($attendance && $attendance->time_out): ?>
                        <div class="detail-row">
                            <span class="detail-label">Time Out:</span>
                            <span class="detail-value"><?php echo e($attendance->time_out); ?></span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="time-inputs">
                            <input type="time" 
                                   class="time-input" 
                                   placeholder="Time In"
                                   value="<?php echo e($attendance && $attendance->time_in ? $attendance->time_in : ''); ?>"
                                   id="time-in-<?php echo e($student->id); ?>">
                            <input type="time" 
                                   class="time-input" 
                                   placeholder="Time Out"
                                   value="<?php echo e($attendance && $attendance->time_out ? $attendance->time_out : ''); ?>"
                                   id="time-out-<?php echo e($student->id); ?>">
                        </div>
                        
                        <textarea class="notes-input" 
                                  placeholder="Add notes or remarks..."
                                  id="notes-<?php echo e($student->id); ?>"><?php echo e($attendance ? $attendance->notes : ''); ?></textarea>
                    </div>

                    <div style="margin-top: 0.5rem; text-align: center;">
                        <button class="btn-control" 
                                style="font-size: 0.7rem; padding: 0.25rem 0.5rem;"
                                onclick="toggleDetails(<?php echo e($student->id); ?>)">
                            <span id="toggle-text-<?php echo e($student->id); ?>">Show Details</span>
                        </button>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.markAttendance = function(studentId, status, button) {
        ...
        fetch('<?php echo e(route("teacher.attendance.mark")); ?>', {
            method: 'POST',
            headers: {
    ...
    window.bulkMarkAttendance = function(status) {
        ...
        // Send bulk request
        fetch('<?php echo e(route("teacher.attendance.bulk-mark")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            ...
            body: JSON.stringify({
                date: '<?php echo e($selectedDate); ?>',
                class: '<?php echo e($selectedClass); ?>',
                status: status,
    ...
    window.exportAttendance = function() {
        ...
        if (format) {
            fetch(`<?php echo e(route("teacher.attendance.export")); ?>?date=<?php echo e($selectedDate); ?>&class=<?php echo e($selectedClass); ?>&format=${format}`)
            .then(response => response.json())
            .then(data => {
                if (data.success) {
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/teacher/attendance/index.blade.php ENDPATH**/ ?>