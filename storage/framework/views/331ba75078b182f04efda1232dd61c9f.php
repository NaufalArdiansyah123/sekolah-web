            ...
            <div class="lg:col-span-2">
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <?php if($submission->graded_at): ?>
                                    <div>
                                        ...
                                        <div class="font-medium text-gray-900 dark:text-white">
                                            <?php echo e($submission->graded_at->format('d M Y, H:i')); ?>
                            ...
                            <?php if($submission->score !== null): ?>
                                ...
                                <div class="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        ?>
                                        <span class="text-2xl font-bold <?php echo e($gradeColor); ?>"><?php echo e($grade); ?></span>
                                    </div>
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <span class="text-lg font-semibold <?php echo e($gradeColor); ?>">
                                            <?php echo e($percentage); ?>%
                                        </span>
                                    </div>
                                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                                        <div class="<?php echo e($percentage >= 80 ? 'bg-green-500' : ($percentage >= 60 ? 'bg-yellow-500' : 'bg-red-500')); ?> h-3 rounded-full transition-all duration-500" 
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <?php echo nl2br(e($submission->content)); ?>

                                </div>
                            </div>
                            
                            <?php if($submission->file_path ?? false): ?>
                                <div class="mb-4">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">File yang dikumpulkan:</span>
                                    <div class="mt-2">
                                        <a href="<?php echo e(Storage::url($submission->file_path)); ?>" 
                                           target="_blank"
                                           class="inline-flex items-center px-4 py-2 bg-blue-100 hover:bg-blue-200 dark:bg-blue-900 dark:hover:bg-blue-800 text-blue-700 dark:text-blue-300 rounded-lg transition-colors">
                                            ...
                                            <?php echo e($submission->file_name ?? 'Download File'); ?>
                            ...
                            <?php if($submission->feedback ?? false): ?>
                                <div>
                                    ...
                                    <div class="mt-2 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                                        <?php echo nl2br(e($submission->feedback)); ?>
                ...
                <?php elseif($assignment->due_date >= now()): ?>
                    ...
                    <div class="mt-8 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                        ...
                        <form action="<?php echo e(route('student.assignments.submit', $assignment->id)); ?>" method="POST" enctype="multipart/form-data" class="p-6">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="content" id="content" rows="6" required
                                          ...
                                          placeholder="Tulis jawaban atau deskripsi tugas Anda di sini..."><?php echo e(old('content')); ?></textarea>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="font-medium text-gray-900 dark:text-white"><?php echo e(ucfirst($assignment->status)); ?></div>
                        </div>
                        ...
                        <?php if($assignment->due_date < now()): ?>
                            <div class="p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                                <div class="text-sm text-red-800 dark:text-red-200 font-medium">
                                    Terlambat <?php echo e($assignment->due_date->diffForHumans()); ?>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/student/assignments/show.blade.php ENDPATH**/ ?>