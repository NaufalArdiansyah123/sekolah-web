...
<div class="blog-show-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <div class="header-actions">
                <a href="<?php echo e(route('admin.posts.blog')); ?>" class="btn-header btn-secondary">
                    <i class="fas fa-arrow-left me-2"></i>Kembali
                </a>
                <a href="<?php echo e(route('admin.posts.blog.edit', $blog->slug)); ?>" class="btn-header">
    ...
    <div class="content-layout">
        ...
        <div class="article-main">
            ...
            <div class="article-header">
                <div class="article-badges">
                    <span class="badge badge-<?php echo e($blog->category ?? 'berita'); ?>">
                        <?php switch($blog->category ?? 'berita'):
                            case ('berita'): ?>
                                📰 Berita
                                <?php break; ?>
                            <?php case ('pengumuman'): ?>
                    ...
                    <span class="badge badge-<?php echo e($blog->status ?? 'published'); ?>">
                        <?php switch($blog->status ?? 'published'):
                            case ('published'): ?>
                                ✅ Published
                                <?php break; ?>
                            <?php case ('draft'): ?>
                ...
                <div class="article-meta">
                    <div class="meta-item">
                        ...
                        <span><?php echo e($blog->author ?? $blog->user->name ?? 'Unknown'); ?></span>
                    </div>
                    <div class="meta-item">
                        <i class="fas fa-calendar"></i>
                        <span><?php echo e($blog->created_at->format('d M Y, H:i')); ?></span>
                    </div>
                    <?php if($blog->published_at): ?>
                        <div class="meta-item">
                            <i class="fas fa-globe"></i>
                            <span>Published: <?php echo e($blog->published_at->format('d M Y, H:i')); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <?php if($blog->meta_description): ?>
                    <p class="article-excerpt"><?php echo e($blog->meta_description); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="article-footer">
                <?php if($blog->keywords): ?>
                    <div class="keywords-section">
                        ...
                        <div class="keywords-list">
                            <?php $__currentLoopData = explode(',', $blog->keywords); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyword): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="article-actions">
                    <a href="<?php echo e(route('admin.posts.blog.edit', $blog->slug)); ?>" class="btn-action btn-edit">
                        <i class="fas fa-edit me-2"></i>Edit Artikel
                    </a>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-card">
                ...
                <div class="card-content">
                    <div class="stat-item">
                        ...
                        <div class="stat-value"><?php echo e($blog->views_count ?? 0); ?></div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-label">Word Count</div>
                        <div class="stat-value"><?php echo e(str_word_count(strip_tags($blog->content))); ?></div>
                    </div>
                    <div class="stat-item">
                        <div class="stat-label">Reading Time</div>
                        <div class="stat-value"><?php echo e(ceil(str_word_count(strip_tags($blog->content)) / 200)); ?> min</div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-content">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">
                            <span class="badge badge-<?php echo e($blog->status ?? 'published'); ?>">
                                <?php echo e(ucfirst($blog->status ?? 'published')); ?>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">
                            <span class="badge badge-<?php echo e($blog->category ?? 'berita'); ?>">
                                <?php echo e(ucfirst($blog->category ?? 'berita')); ?>
                    ...
                    <?php if($blog->published_at): ?>
                        <div class="info-item">
                            ...
                            <div class="info-value"><?php echo e($blog->published_at->format('d M Y, H:i')); ?></div>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <!-- SEO Information -->
            <?php if($blog->meta_description || $blog->keywords): ?>
                <div class="sidebar-card">
                    <div class="card-header">
                        <h3 class="card-title">
                    ...
                    <div class="card-content">
                        <?php if($blog->meta_description): ?>
                            <div class="seo-item">
                                ...
                                <div class="seo-value"><?php echo e($blog->meta_description); ?></div>
                                <div class="seo-count"><?php echo e(strlen($blog->meta_description)); ?>/160 characters</div>
                            </div>
                        <?php endif; ?>
                        <?php if($blog->keywords): ?>
                            <div class="seo-item">
                                <div class="seo-label">Keywords</div>
                                <div class="seo-value"><?php echo e($blog->keywords); ?></div>
                                <div class="seo-count"><?php echo e(count(explode(',', $blog->keywords))); ?> keywords</div>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<!-- Delete Form (Hidden) -->
<form id="deleteForm" action="<?php echo e(route('admin.posts.blog.destroy', $blog->slug)); ?>" method="POST" style="display: none;">
    <?php echo csrf_field(); ?>
...
<script>
    ...
    document.addEventListener('keydown', function(e) {
        ...
        if ((e.ctrlKey || e.metaKey) && e.key === 'e') {
            e.preventDefault();
            window.location.href = '<?php echo e(route("admin.posts.blog.edit", $blog->slug)); ?>';
        }
        
        // Ctrl/Cmd + Backspace to go back
        if ((e.ctrlKey || e.metaKey) && e.key === 'Backspace') {
            e.preventDefault();
            window.location.href = '<?php echo e(route("admin.posts.blog")); ?>';
        }
    });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/posts/blog/show.blade.php ENDPATH**/ ?>