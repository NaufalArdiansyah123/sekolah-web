...
<div class="dashboard-container">
    ...
    <div class="welcome-section">
        <div class="welcome-content">
            ...
            <div class="welcome-time">
                ...
                <?php echo e(now()->format('l, d F Y - H:i')); ?>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-change positive">
                ...
                <?php echo e($stats['active_students']); ?> siswa aktif
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-change positive">
                ...
                <?php echo e($stats['active_teachers']); ?> guru aktif
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(number_format($stats['total_posts'])); ?></div>
            <div class="stat-label">Artikel & Berita</div>
            <div class="stat-change positive">
                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M3.293 9.707a1 1 0 010-1.414l6-6a1 1 0 011.414 0l6 6a1 1 0 01-1.414 1.414L11 5.414V17a1 1 0 11-2 0V5.414L4.707 9.707a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                </svg>
                <?php echo e($stats['published_posts']); ?> dipublikasi
            </div>
        </div>
    ...
    <div class="quick-actions">
        <a href="<?php echo e(route('admin.posts.blog')); ?>" class="quick-action">
        ...
        <a href="<?php echo e(route('admin.gallery.upload')); ?>" class="quick-action">
        ...
        <a href="<?php echo e(route('admin.settings.index')); ?>" class="quick-action">
    ...
    <div class="chart-grid">
        ...
        <div class="chart-card">
            <?php if (isset($component)) { $__componentOriginal835247408b748defaac509cd7d705981 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal835247408b748defaac509cd7d705981 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.upcoming-events-card','data' => ['limit' => 5,'showHeader' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('upcoming-events-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['limit' => 5,'showHeader' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal835247408b748defaac509cd7d705981)): ?>
<?php $attributes = $__attributesOriginal835247408b748defaac509cd7d705981; ?>
<?php unset($__attributesOriginal835247408b748defaac509cd7d705981); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal835247408b748defaac509cd7d705981)): ?>
<?php $component = $__componentOriginal835247408b748defaac509cd7d705981; ?>
<?php unset($__componentOriginal835247408b748defaac509cd7d705981); ?>
<?php endif; ?>
        </div>
                    ...
                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="activity-item">
                            <div class="activity-icon 
                                <?php if($notification->action == 'create'): ?> bg-green-100
                                <?php elseif($notification->action == 'update'): ?> bg-yellow-100
                                <?php elseif($notification->action == 'delete'): ?> bg-red-100
                                <?php elseif($notification->action == 'upload'): ?> bg-blue-100
                                <?php else: ?> bg-gray-100
                                <?php endif; ?>">
                                <i class="<?php echo e($notification->icon); ?> text-sm"></i>
                            </div>
                            <div class="activity-content">
                                <div class="activity-title"><?php echo e($notification->title); ?></div>
                                <div class="activity-description"><?php echo e(Str::limit($notification->message, 50)); ?></div>
                            </div>
                            <div class="activity-time"><?php echo e($notification->time_ago); ?></div>
                        </div>
    ...
    <div class="chart-grid">
        ...
        <div class="chart-card">
            ...
            <div class="text-center py-8">
                ...
                <div class="space-y-2">
                    <a href="<?php echo e(route('admin.calendar.index')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        Buka Kalender
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>