<?php $__env->startSection('title', 'Video Dokumentasi'); ?>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="stats-card card h-100 shadow-sm fade-in-up">
                    <div class="card-body p-4">
                        ...
                        <h2 class="stats-number display-4 fw-bold text-primary mb-2" data-target="<?php echo e($stats['total_videos']); ?>">0</h2>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="stats-card card h-100 shadow-sm fade-in-up" style="animation-delay: 0.2s;">
                    <div class="card-body p-4">
                        ...
                        <h2 class="stats-number display-4 fw-bold text-success mb-2" data-target="<?php echo e($stats['total_views']); ?>">0</h2>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="stats-card card h-100 shadow-sm fade-in-up" style="animation-delay: 0.4s;">
                    <div class="card-body p-4">
                        ...
                        <h2 class="stats-number display-4 fw-bold text-warning mb-2" data-target="<?php echo e($stats['total_downloads']); ?>">0</h2>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="stats-card card h-100 shadow-sm fade-in-up" style="animation-delay: 0.6s;">
                    <div class="card-body p-4">
                        ...
                        <h2 class="stats-number display-4 fw-bold text-info mb-2" data-target="<?php echo e($stats['categories_count']); ?>">0</h2>
...
<section class="featured-section">
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $featuredVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4 col-md-6">
                    <div class="video-card fade-in-up" style="animation-delay: <?php echo e($index * 0.2); ?>s;">
                        <div class="video-thumbnail">
                            ...
                            <?php else: ?>
                                <div class="video-placeholder">
                                    ...
                                    <span class="fw-bold"><?php echo e(strtoupper($video->category)); ?></span>
                                </div>
                            <?php endif; ?>
                        ...
                        <div class="video-info">
                            ...
                            <?php if($video->description): ?>
                                <p class="video-description"><?php echo e($video->description); ?></p>
                            <?php endif; ?>
                            
                            <div class="video-meta">
                                <span class="video-badge badge-category"><?php echo e($categories[$video->category]); ?></span>
                                <span class="video-badge badge-featured">Unggulan</span>
                            </div>
                            
                            <div class="video-stats">
                                <span><i class="fas fa-eye me-1"></i> <?php echo e(number_format($video->views)); ?></span>
                                <span><i class="fas fa-download me-1"></i> <?php echo e(number_format($video->downloads)); ?></span>
                                <span><i class="fas fa-hdd me-1"></i> <?php echo e($video->formatted_file_size); ?></span>
                            </div>
                            
                            <div class="video-actions">
                                <a href="<?php echo e(route('public.videos.show', $video)); ?>" class="btn-video btn-primary-video">
                                    <i class="fas fa-play"></i>
                                    Tonton
                                </a>
                                <a href="<?php echo e(route('public.videos.download', $video)); ?>" class="btn-video btn-secondary-video">
...
<section class="py-5">
    <div class="container">
        ...
        <div class="filter-section fade-in-up">
            ...
            <form method="GET" action="<?php echo e(route('public.videos.index')); ?>">
        ...
        <?php if($videos->count() > 0): ?>
            <div class="row g-4">
                <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6">
                        <div class="video-card fade-in-up" style="animation-delay: <?php echo e($index * 0.1); ?>s;">
                            <div class="video-thumbnail">
                                <?php if($video->thumbnail_url): ?>
                                    <img src="<?php echo e($video->thumbnail_url); ?>" alt="<?php echo e($video->title); ?>">
                                <?php else: ?>
        ...
        <?php else: ?>
            ...
            <div class="empty-state fade-in-up">
                ...
                <a href="<?php echo e(route('public.videos.index')); ?>" class="btn btn-filter">
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/public/videos/index.blade.php ENDPATH**/ ?>