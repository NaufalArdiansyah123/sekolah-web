...
<div class="announcement-container">
    ...
    <div class="page-header">
        ...
        <div class="header-actions">
            <a href="<?php echo e(route('admin.announcements.edit', $announcement->id)); ?>" class="btn-header btn-edit">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                </svg>
                Edit
            </a>
            <a href="<?php echo e(route('admin.announcements.index')); ?>" class="btn-header">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="announcement-card">
        ...
        <div class="card-header-custom">
            <h2 class="announcement-title"><?php echo e($announcement->title); ?></h2>
            <div class="status-badge-container">
                <span class="status-badge status-<?php echo e($announcement->status); ?>">
        ...
        <div class="card-body-custom">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        <?php echo e($announcement->author); ?>

                        <?php if($announcement->user): ?>
                            <br><small class="text-muted">(<?php echo e($announcement->user->name); ?>)</small>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        <span class="views-badge"><?php echo e($announcement->views_count ?? 0); ?> views</span>
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        <?php echo e($announcement->published_at ? $announcement->published_at->format('M d, Y H:i') : 'Not published'); ?>
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        <code class="code-snippet"><?php echo e($announcement->slug); ?></code>
                    </div>
                </div>
            </div>
            ...
            <div class="metadata-section">
                ...
                <div class="metadata-grid">
                    <div class="metadata-item">
                        ...
                        Created: <?php echo e($announcement->created_at->format('M d, Y H:i')); ?>
                    ...
                    <div class="metadata-item">
                        ...
                        Updated: <?php echo e($announcement->updated_at->format('M d, Y H:i')); ?>
                    ...
                    <?php if($announcement->expires_at): ?>
                        <div class="metadata-item">
                            ...
                            Expires: <?php echo e($announcement->expires_at->format('M d, Y H:i')); ?>
    ...
    <div class="action-section">
        <div class="action-buttons">
            <a href="<?php echo e(route('admin.announcements.edit', $announcement->id)); ?>" class="btn-action btn-edit-action">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                </svg>
                Edit Announcement
            ...
            <button class="btn-action btn-toggle toggle-status" 
                    ...
                    data-current-status="<?php echo e($announcement->status); ?>">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"/>
                </svg>
                <?php echo e($announcement->status === 'published' ? 'Set as Draft' : 'Publish'); ?>

            </button>

            <form action="<?php echo e(route('admin.announcements.destroy', $announcement->id)); ?>" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/posts/announcement/show.blade.php ENDPATH**/ ?>