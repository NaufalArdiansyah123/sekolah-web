...
<section class="slideshow-container" id="enhanced-slideshow">
        ...
        <?php $__currentLoopData = $slideshows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="slide <?php echo e($index === 0 ? 'active' : ''); ?>" 
                ...
                <div class="slide-content">
                    <div class="slide-subtitle fade-in-up"><?php echo e($slide->subtitle ?? 'DISIPLIN ADALAH KUNCI SUKSES'); ?></div>
                    <h1 class="fade-in-up"><?php echo e($slide->title ?? 'DISIPLIN'); ?></h1>
                    <p class="fade-in-up"><?php echo e($slide->description ?? 'Membangun karakter siswa yang bertanggung jawab dan berdisiplin tinggi untuk meraih prestasi terbaik dalam kehidupan'); ?></p>
                    <div class="slide-buttons fade-in-up">
                        <a href="<?php echo e(route('about.profile')); ?>" class="btn-slide btn-primary-slide">
        ...
        <div class="slideshow-dots">
            <?php $__currentLoopData = $slideshows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="dot <?php echo e($index === 0 ? 'active' : ''); ?>" 
                      onclick="currentSlideEnhanced(<?php echo e($index + 1); ?>)"></span>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    ...
    <div class="slideshow-bottom-buttons">
        <a href="<?php echo e(route('about.profile')); ?>" class="btn-slideshow-bottom btn-primary-slideshow">
            <i class="fas fa-info-circle"></i>
            Tentang Kami
        </a>
        ...
        <div class="row">
                            ...
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <?php if($news->featured_image): ?>
                                        <div class="news-image" style="background-image: url('<?php echo e(asset('storage/' . $news->featured_image)); ?>'); background-size: cover; background-position: center;">
                                        </div>
                                    <?php else: ?>
                                ...
                                <div class="col-md-8">
                                    <div class="card-body p-4">
                                        ...
                                        <p class="card-text"><?php echo e(Str::limit(strip_tags($news->content), 120)); ?></p>
                                        <p class="card-text">
                                            <small class="text-muted">
                                                <i class="fas fa-calendar me-1"></i><?php echo e($news->created_at->diffForHumans()); ?>

                                                <?php if($news->author): ?>
                                                    <i class="fas fa-user ms-2 me-1"></i><?php echo e($news->author); ?>
            ...
            <div class="col-md-4">
                <div class="sidebar-card fade-in-right">
                    ...
                    <div class="card-body">
                        <?php if($latestAnnouncements->count() > 0): ?>
                            <?php $__currentLoopData = $latestAnnouncements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="announcement-item <?php echo e($index < $latestAnnouncements->count() - 1 ? 'mb-3 pb-3 border-bottom' : ''); ?>">
                                    ...
                                    <p class="mb-1 small"><?php echo e(Str::limit(strip_tags($announcement->isi), 80)); ?></p>
                                    <small class="text-muted">
                                        <i class="fas fa-calendar me-1"></i><?php echo e($announcement->created_at->format('d M Y')); ?>

                                        <?php if($announcement->prioritas === 'tinggi'): ?>
                        ...
                        <?php if($latestAnnouncements->count() > 0): ?>
                            <a href="<?php echo e(route('announcements.index')); ?>" class="btn btn-outline-warning btn-enhanced mt-3 w-100">
                                <i class="fas fa-bullhorn me-2"></i>Lihat Semua Pengumuman
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('announcements.index')); ?>" class="btn btn-outline-secondary btn-enhanced mt-3 w-100">
                ...
                <div class="sidebar-card fade-in-right">
                    ...
                    <div class="card-body">
                        <?php if($upcomingAgendas->count() > 0): ?>
                            <?php $__currentLoopData = $upcomingAgendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="agenda-item <?php echo e($index < $upcomingAgendas->count() - 1 ? 'mb-3 pb-3 border-bottom' : ''); ?>">
                                    <div class="d-flex align-items-center">
                                        <div class="agenda-date me-3 text-center">
                                            <div class="fw-bold" style="color: var(--gold-color); font-size: 1.5rem;">
                                                <?php echo e($agenda->event_date ? $agenda->event_date->format('d') : '?'); ?>

                                            </div>
                                            <small class="text-muted">
                                                <?php echo e($agenda->event_date ? $agenda->event_date->format('M') : 'TBD'); ?>

                                            </small>
                                        </div>
                                        <div>
                                            <h6 class="mb-1 fw-bold"><?php echo e(Str::limit($agenda->title, 30)); ?></h6>
                                            <small class="text-muted">
                                                <?php if($agenda->event_date): ?>
                                                    <?php echo e($agenda->event_date->format('H:i')); ?> WIB
                                                <?php endif; ?>
                                                <?php if($agenda->location): ?>
                                                    • <?php echo e(Str::limit($agenda->location, 20)); ?>
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(route('agenda.index')); ?>" class="btn btn-outline-info btn-enhanced mt-3">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-3">
                           ...
                           <a href="<?php echo e(route('gallery.index')); ?>" class="btn btn-outline-secondary btn-enhanced">
                            ...
                            <a href="<?php echo e(route('public.extracurriculars.index')); ?>" class="btn btn-outline-secondary btn-enhanced">
                                <i class="fas fa-users me-2"></i>Ekstrakurikuler
                            </a>
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary-enhanced btn-enhanced">
...
(function() {
    ...
    function initHomePage() {
        ...
        try {
            const totalSlides = <?php echo e($slideshows->count()); ?>;
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/public/home.blade.php ENDPATH**/ ?>