<?php $__env->startSection('title', $album['title'] . ' - Gallery'); ?>
...
<div class="album-header">
    <div class="album-header-content">
        ...
        <nav class="breadcrumb">
            ...
            <span><?php echo e($album['title']); ?></span>
        </nav>

        <!-- Album Info -->
        <h1 class="album-title"><?php echo e($album['title']); ?></h1>
        
        <?php if(!empty($album['description'])): ?>
            <p class="album-description"><?php echo e($album['description']); ?></p>
        <?php endif; ?>
        ...
        <div class="album-meta">
            <div class="meta-item">
                ...
                <span><?php echo e(count($album['photos'] ?? [])); ?> Foto</span>
            </div>
            ...
            <div class="meta-item">
                ...
                <span><?php echo e(isset($album['created_at']) ? \Carbon\Carbon::parse($album['created_at'])->locale('id')->isoFormat('D MMMM Y') : 'Tanggal tidak tersedia'); ?></span>
            </div>
            
            <?php if(isset($album['category'])): ?>
                <div class="meta-item">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                    </svg>
                    <span><?php echo e(ucfirst(str_replace('_', ' ', $album['category']))); ?></span>
                </div>
            <?php endif; ?>
            
            <?php if(isset($album['created_by'])): ?>
                <div class="meta-item">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                    </svg>
                    <span><?php echo e($album['created_by']); ?></span>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<div class="gallery-container">
    <?php if(isset($album['photos']) && count($album['photos']) > 0): ?>
        <!-- Gallery Controls -->
        <div class="gallery-controls">
            <div class="controls-header">
                ...
                <div class="view-controls">
                    ...
                    <!-- Download Button -->
                    <a href="<?php echo e(route('gallery.download', $album['slug'])); ?>" class="download-btn">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="photos-grid grid-view" id="photosGrid">
            <?php $__currentLoopData = $album['photos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="photo-card" data-index="<?php echo e($index); ?>">
                    <img src="<?php echo e(asset('storage/' . $photo['path'])); ?>" 
                         alt="<?php echo e($photo['original_name'] ?? 'Photo ' . ($index + 1)); ?>" 
                         class="photo-image"
                         loading="lazy">
                    
                    <div class="photo-overlay">
                        <div class="photo-info">
                            <div class="photo-title"><?php echo e($photo['original_name'] ?? 'Photo ' . ($index + 1)); ?></div>
                            <div class="photo-meta">
                                <span><?php echo e(isset($photo['size']) ? number_format($photo['size'] / 1024, 1) . ' KB' : ''); ?></span>
                                <span><?php echo e(isset($photo['uploaded_at']) ? \Carbon\Carbon::parse($photo['uploaded_at'])->locale('id')->diffForHumans() : ''); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const photos = <?php echo json_encode($album['photos'] ?? [], 15, 512) ?>;
    ...
    function updateLightboxContent() {
        ...
        if (photo) {
            lightboxImage.src = '<?php echo e(asset("storage/")); ?>/' + photo.path;
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/public/gallery/show.blade.php ENDPATH**/ ?>