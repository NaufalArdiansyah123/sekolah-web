<?php $__env->startSection('title', 'Assessment & Grading Management'); ?>
...
<div class="assessment-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <div class="header-actions">
                <a href="<?php echo e(route('teacher.assessment.reports')); ?>" class="btn btn-secondary">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                    </svg>
                    View Reports
                </a>
                <a href="<?php echo e(route('teacher.assessment.create')); ?>" class="btn btn-primary">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="stats-container">
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($assessments->where('status', 'active')->count()); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($assessments->where('status', 'completed')->count()); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($assessments->where('status', 'scheduled')->count()); ?></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e($assessments->count()); ?></div>
    ...
    <div class="filters-container">
        <form method="GET" action="<?php echo e(route('teacher.assessment.index')); ?>">
            <div class="filters-row">
                ...
                <div class="filter-group">
                    ...
                    <select name="subject" class="filter-input">
                        ...
                        <option value="Fisika" <?php echo e(request('subject') == 'Fisika' ? 'selected' : ''); ?>>Fisika</option>
                        <option value="Biologi" <?php echo e(request('subject') == 'Biologi' ? 'selected' : ''); ?>>Biologi</option>
                        <option value="Bahasa Indonesia" <?php echo e(request('subject') == 'Bahasa Indonesia' ? 'selected' : ''); ?>>Bahasa Indonesia</option>
                    </select>
                </div>
                <div class="filter-group">
                ...
                <div class="filter-group">
                    ...
                    <select name="type" class="filter-input">
                        ...
                        <option value="test" <?php echo e(request('type') == 'test' ? 'selected' : ''); ?>>Test</option>
    ...
    <?php if($assessments->count() > 0): ?>
            ...
            <?php $__currentLoopData = $assessments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assessment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="assessment-card">
                    <div class="assessment-header">
                        <div class="assessment-icon icon-<?php echo e($assessment->type); ?>">
                            <?php echo e($assessment->type_icon); ?>

                        </div>
                        <div class="assessment-info">
                            <div class="assessment-title"><?php echo e($assessment->title); ?></div>
                            <div class="assessment-meta">
                                <span><?php echo e($assessment->subject); ?></span>
                                <span>•</span>
                                <span><?php echo e($assessment->class); ?></span>
                                <span>•</span>
                                <span><?php echo e($assessment->date->format('d M Y')); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="assessment-details">
                        <div class="detail-item">
                            ...
                            <div class="detail-value"><?php echo e($assessment->duration); ?> minutes</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Questions</div>
                            <div class="detail-value"><?php echo e($assessment->total_questions); ?> questions</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Max Score</div>
                            <div class="detail-value"><?php echo e($assessment->max_score); ?> points</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Participants</div>
                            <div class="detail-value"><?php echo e($assessment->participants); ?> students</div>
                        </div>
                    </div>
                    ...
                    <div class="assessment-progress">
                        <div class="progress-header">
                            ...
                            <span class="progress-value"><?php echo e($assessment->completed); ?>/<?php echo e($assessment->participants); ?> (<?php echo e($progressPercentage); ?>%)</span>
                        </div>
                    ...
                    <div class="assessment-status <?php echo e($assessment->status_badge_class); ?>">
                        <?php if($assessment->status == 'active'): ?>
                            🟢 Active
                        <?php elseif($assessment->status == 'completed'): ?>
                            ✅ Completed
                        <?php elseif($assessment->status == 'scheduled'): ?>
                            📅 Scheduled
                    ...
                    <div class="assessment-actions">
                        <a href="<?php echo e(route('teacher.assessment.show', $assessment->id)); ?>" class="action-btn btn-view" title="View Assessment">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                            </svg>
                        </a>
                        <a href="<?php echo e(route('teacher.assessment.edit', $assessment->id)); ?>" class="action-btn btn-edit" title="Edit Assessment">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                        </a>
                        <button class="action-btn btn-delete" title="Delete Assessment" onclick="deleteAssessment(<?php echo e($assessment->id); ?>)">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php if($assessments->hasPages()): ?>
            <div class="pagination-container" style="margin-top: 2rem; display: flex; justify-content: center;">
                <?php echo e($assessments->appends(request()->query())->links()); ?>
    ...
    <?php else: ?>
        ...
        <div class="empty-state">
            ...
            <p class="empty-description">
                <?php if(request()->hasAny(['search', 'subject', 'class', 'type', 'status'])): ?>
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/teacher/assessment/index.blade.php ENDPATH**/ ?>