        ...
        <div class="form-header">
            <div class="form-header-content">
                ...
                <div>
                    ...
                    <p class="form-subtitle">Perbarui konten artikel "<?php echo e(Str::limit($blog->title, 50)); ?>"</p>
                </div>
            </div>
        </div>

        <form class="form-body" action="<?php echo e(route('admin.posts.blog.update', $blog->slug)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="title" placeholder="Masukkan judul yang menarik dan deskriptif" required value="<?php echo e(old('title', $blog->title)); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="slug" id="slug" placeholder="url-friendly-slug" value="<?php echo e(old('slug', $blog->slug)); ?>">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="category">
                            <option value="berita" <?php echo e(old('category', $blog->category) == 'berita' ? 'selected' : ''); ?>>📰 Berita</option>
                            <option value="pengumuman" <?php echo e(old('category', $blog->category) == 'pengumuman' ? 'selected' : ''); ?>>📣 Pengumuman</option>
                            <option value="kegiatan" <?php echo e(old('category', $blog->category) == 'kegiatan' ? 'selected' : ''); ?>>🎯 Kegiatan</option>
                            <option value="prestasi" <?php echo e(old('category', $blog->category) == 'prestasi' ? 'selected' : ''); ?>>🏆 Prestasi</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="status">
                            ...
                            <option value="archived" <?php echo e(old('status', $blog->status) == 'archived' ? 'selected' : ''); ?>>📁 Archived</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="author" placeholder="Nama penulis" value="<?php echo e(old('author', $blog->author)); ?>">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <div class="editor-container">
                        <textarea class="form-control" name="content" rows="10" placeholder="Tulis konten artikel di sini..." required><?php echo e(old('content', $blog->content)); ?></textarea>
                    </div>
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="meta_description" rows="4" placeholder="Deskripsi singkat untuk mesin pencari (maksimal 160 karakter)"><?php echo e(old('meta_description', $blog->meta_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="keywords" placeholder="keyword1, keyword2, keyword3" value="<?php echo e(old('keywords', $blog->keywords)); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-section">
                ...
                <?php if($blog->featured_image): ?>
                    <div class="current-image-section">
                        ...
                        <div class="current-image-container">
                            <img src="<?php echo e(asset('storage/' . $blog->featured_image)); ?>" class="current-image" alt="Current Image">
                ...
                <div class="form-group">
                    <label class="form-label"><i class="fas fa-camera me-2"></i><?php echo e($blog->featured_image ? 'Ganti Gambar' : 'Pilih Gambar'); ?></label>
            ...
            <div class="form-section">
                ...
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <div class="info-value">#<?php echo e($blog->id); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Slug</div>
                        <div class="info-value"><?php echo e($blog->slug); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Dibuat</div>
                        <div class="info-value"><?php echo e($blog->created_at->format('d M Y, H:i')); ?></div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Terakhir Diupdate</div>
                        <div class="info-value"><?php echo e($blog->updated_at->format('d M Y, H:i')); ?></div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/posts/blog/edit.blade.php ENDPATH**/ ?>