        ...
        <?php if($announcements->count() > 0): ?>
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <small class="text-muted">Menampilkan <?php echo e($announcements->firstItem()); ?>-<?php echo e($announcements->lastItem()); ?> dari <?php echo e($announcements->total()); ?> pengumuman</small>
                </div>
            </div>
        <?php endif; ?>
                    ...
                    <div class="col-lg-6 col-md-6 mb-4">
                        <div class="announcement-card fade-in-up" style="animation-delay: <?php echo e($index * 0.1); ?>s;">
                            <?php if($announcement->featured_image): ?>
                                <img src="<?php echo e(asset('storage/' . $announcement->featured_image)); ?>" 
                            ...
                            <div class="priority-badge priority-<?php echo e($announcement->priority ?? 'normal'); ?>">
                                ...
                                <?php elseif($announcement->priority === 'high'): ?> ⚠️ High
                            ...
                            <div class="announcement-content">
                                ...
                                <p class="announcement-excerpt">
                                    <?php echo e(Str::limit(strip_tags($announcement->content), 120)); ?>
                                ...
                                <div class="announcement-meta">
                                    <div class="announcement-meta-item">
                                        ...
                                        <span><?php echo e($announcement->author); ?></span>
                                    ...
                                    <div class="announcement-meta-item">
                                        ...
                                        <span><?php echo e($announcement->published_at ? $announcement->published_at->format('d M Y, H:i') : $announcement->created_at->format('d M Y, H:i')); ?></span>
                                    </div>
                                    <div class="announcement-meta-item">
                                        <i class="fas fa-eye text-info"></i>
                                        <span><?php echo e($announcement->views_count ?? 0); ?> views</span>
                                    </div>
                                </div>
