<?php $__env->startSection('title', 'Pengumuman Sekolah'); ?>
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="filter-section fade-in-up">
                ...
                <form method="GET" action="<?php echo e(route('announcements.index')); ?>" id="filterForm">
                    <div class="row g-3 align-items-end">
                        <div class="col-lg-3 col-md-6">
                            <label class="form-label fw-semibold text-muted">Kata Kunci</label>
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>"
                                placeholder="Cari pengumuman..." class="form-control form-control-enhanced">
                        </div>
                        ...
                        <div class="col-lg-3 col-md-12">
                            <div class="d-flex gap-2">
                                ...
                                <?php if(request()->hasAny(['search', 'category', 'priority'])): ?>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="d-flex flex-wrap gap-2 mt-2">
                                ...
                                <?php if(request('category')): ?>
                                    <span class="badge bg-success">Kategori: <?php echo e(ucfirst(request('category'))); ?></span>
                                <?php endif; ?>
                                <?php if(request('priority')): ?>
                                    <span class="badge bg-info">Prioritas: <?php echo e(ucfirst(request('priority'))); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endif; ?>
            ...
            <?php if($announcements->count() > 0): ?>
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="mb-0">Ditemukan <?php echo e($announcements->total()); ?> pengumuman</h4>
                        <small class="text-muted">Menampilkan <?php echo e($announcements->firstItem()); ?>-<?php echo e($announcements->lastItem()); ?>

                            dari <?php echo e($announcements->total()); ?> pengumuman</small>
                    </div>
                </div>
            <?php endif; ?>
                ...
                <div class="row">
                    <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="announcement-card fade-in-up" style="animation-delay: <?php echo e($index * 0.1); ?>s;">
                                <?php if($announcement->featured_image): ?>
                                    <img src="<?php echo e(asset('storage/' . $announcement->featured_image)); ?>" alt="<?php echo e($announcement->title); ?>"
                                        class="announcement-image w-100">
                                <?php elseif($announcement->image): ?>
                                    <img src="<?php echo e($announcement->image); ?>" alt="<?php echo e($announcement->title); ?>"
                                        class="announcement-image w-100">
                                <?php endif; ?>

                                <!-- Priority Badge -->
                                <div class="priority-badge priority-<?php echo e($announcement->prioritas ?? 'sedang'); ?>">
                                    <?php if($announcement->prioritas === 'tinggi'): ?> 🚨 Tinggi
                                    <?php elseif($announcement->prioritas === 'sedang'): ?> ⚠️ Sedang
                                    <?php else: ?> 📝 Rendah
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="announcement-content">
                                    ...
                                    <span class="category-badge">
                                        📂 <?php echo e(ucfirst($announcement->kategori)); ?>

                                    </span>

                                    <!-- Title -->
                                    <h3 class="announcement-title"><?php echo e($announcement->judul); ?></h3>

                                    <!-- Content Preview -->
                                    <p class="announcement-excerpt">
                                        <?php echo e(Str::limit(strip_tags($announcement->isi), 120)); ?>
                                    ...
                                    <div class="announcement-meta">
                                        <div class="announcement-meta-item">
                                            ...
                                            <span><?php echo e($announcement->penulis); ?></span>
                                        </div>
                                        <div class="announcement-meta-item">
                                            <i class="fas fa-calendar text-success"></i>
                                            <span><?php echo e($announcement->tanggal_publikasi ? $announcement->tanggal_publikasi->format('d M Y, H:i') : $announcement->created_at->format('d M Y, H:i')); ?></span>
                                        </div>
                                        <div class="announcement-meta-item">
                                            <i class="fas fa-eye text-info"></i>
                                            <span><?php echo e($announcement->views ?? 0); ?> views</span>
                                        </div>
                                    </div>
            ...
            <?php else: ?>
                ...
                <div class="empty-state fade-in-up">
                    ...
                    <?php if(request()->hasAny(['search', 'category', 'priority'])): ?>
                        <a href="<?php echo e(route('announcements.index')); ?>" class="btn btn-filter">
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/public/announcements/index.blade.php ENDPATH**/ ?>