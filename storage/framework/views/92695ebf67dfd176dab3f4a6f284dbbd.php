...
<div class="announcement-container">
    ...
    <div class="form-container">
        <form action="<?php echo e(route('teacher.posts.announcement.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" 
                                  id="content" 
                                  class="form-control textarea-large <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                  required
                                  placeholder="Write your announcement content here..."><?php echo e(old('content')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="akademik" <?php echo e(old('category') === 'akademik' ? 'selected' : ''); ?>>Academic</option>
                            <option value="kegiatan" <?php echo e(old('category') === 'kegiatan' ? 'selected' : ''); ?>>Activities</option>
                            <option value="administrasi" <?php echo e(old('category') === 'administrasi' ? 'selected' : ''); ?>>Administration</option>
                            <option value="umum" <?php echo e(old('category') === 'umum' ? 'selected' : ''); ?>>General</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" 
                               value="<?php echo e(old('author', auth()->user()->name ?? '')); ?>" 
                               required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-actions">
                <a href="<?php echo e(route('teacher.posts.announcement')); ?>" class="btn btn-secondary">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/teacher/posts/announcement/create.blade.php ENDPATH**/ ?>