            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="<?php echo e(route('about.profile')); ?>" class="text-white-50 text-decoration-none">Profil Sekolah</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('facilities.index')); ?>" class="text-white-50 text-decoration-none">Fasilitas</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('achievements.index')); ?>" class="text-white-50 text-decoration-none">Prestasi</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('public.extracurriculars.index')); ?>" class="text-white-50 text-decoration-none">Ekstrakurikuler</a></li>
                    </ul>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const importantLinks = [
                ...
                '<?php echo e(route("about.profile")); ?>',
                '<?php echo e(route("news.index")); ?>'
            ];
