...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', \App\Models\Setting::get('school_name', 'SMK PGRI 2 PONOROGO')); ?></title>
...
<body class="loading">
    ...
    <div class="page-loader" id="pageLoader">
        ...
        <div class="loader-content">
            ...
            <div class="loader-text"><?php echo e(\App\Models\Setting::get('school_name', 'SMK PGRI 2 PONOROGO')); ?></div>
           ...
           <!-- Enhanced Brand -->
            <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
                <div class="brand-icon">
                    ...
                    ?>
                    <?php if($schoolLogo && !str_contains($schoolLogo, 'tmp')): ?>
                        <img src="<?php echo e(asset('storage/' . $schoolLogo)); ?>" alt="Logo <?php echo e($schoolName); ?>" onerror="this.src='<?php echo e(asset('images/logo-sterida.png')); ?>'; console.log('Logo fallback used');">
                    <?php else: ?>
                        <img src="<?php echo e(asset('images/logo-sterida.png')); ?>" alt="Logo <?php echo e($schoolName); ?>" onerror="this.style.display='none'">
                    <?php endif; ?>
                </div>
                <div class="brand-text">
                    <span class="brand-main"><?php echo e($schoolName); ?></span>
                    <span class="brand-sub d-none d-lg-block"><?php echo e($schoolSubtitle); ?></span>
                </div>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('about.*') ? 'active' : ''); ?>" href="javascript:void(0)"
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('about.profile')); ?>">
                                    <i class="fas fa-school me-3"></i>Profil Sekolah
                                </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('about.vision')); ?>">
                                    <i class="fas fa-eye me-3"></i>Visi & Misi
                                </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('about.sejarah')); ?>">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('public.academic.programs')); ?>">
                                    <i class="fas fa-graduation-cap me-3"></i>Program Studi
                                </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('academic.calendar')); ?>">
                                    <i class="fas fa-calendar-alt me-3"></i>Kalender Akademik
                                </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('public.extracurriculars.index')); ?>">
                    ...
                    <!-- Informasi Dropdown -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('news.*') || request()->routeIs('announcements.*') || request()->routeIs('agenda.*') ? 'active' : ''); ?>" href="javascript:void(0)" id="infoDropdown" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fas fa-newspaper me-2 d-lg-none"></i>Informasi
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('blog.index')); ?>">
                                    <i class="fas fa-newspaper me-3"></i>Berita
                                </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('announcements.index')); ?>">
                                    <i class="fas fa-bullhorn me-3"></i>Pengumuman
                                </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('agenda.index')); ?>">
                    ...
                    <!-- Media Dropdown -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('gallery.*') || request()->routeIs('public.videos.*') ? 'active' : ''); ?>" href="javascript:void(0)" id="mediaDropdown" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fas fa-photo-video me-2 d-lg-none"></i>Media
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('gallery.index')); ?>">
                                    <i class="fas fa-images me-3"></i>Galeri Foto
                                </a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('public.videos.index')); ?>">
                    ...
                    <!-- Lainnya Dropdown -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo e(request()->routeIs('facilities.*') || request()->routeIs('achievements.*') || request()->routeIs('public.teachers.*') ? 'active' : ''); ?>" href="javascript:void(0)" id="moreDropdown" role="button"
                            data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="<?php echo e(route('contact')); ?>">
                    ...
                    <li class="nav-item d-none d-xl-block">
                        <a class="nav-link <?php echo e(request()->routeIs('news.*') ? 'active' : ''); ?>" href="<?php echo e(route('blog.index')); ?>">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item me-2">
                            <a class="nav-link register-btn" href="<?php echo e(route('student.register.form')); ?>">
                        ...
                        <!-- Login Button -->
                        <li class="nav-item">
                            <a class="nav-link login-btn" href="<?php echo e(route('login')); ?>">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                    <h5><i class="fas fa-graduation-cap me-2"></i><?php echo e(\App\Models\Setting::get('school_name', 'SMK PGRI 2 PONOROGO')); ?></h5>
                    <p class="mb-3"><?php echo e(\App\Models\Setting::get('footer_description', 'Excellence in Education - Membentuk generasi yang berkarakter dan berprestasi untuk masa depan Indonesia yang gemilang.')); ?></p>
                    <div class="social-links">
                        ...
                        <?php if($facebookUrl): ?>
                            <a href="<?php echo e($facebookUrl); ?>" class="text-white me-3" aria-label="Facebook" target="_blank" rel="noopener">
                                <i class="fab fa-facebook fa-lg"></i>
                            </a>
                        <?php endif; ?>
                        
                        <?php if($instagramUrl): ?>
                            <a href="<?php echo e($instagramUrl); ?>" class="text-white me-3" aria-label="Instagram" target="_blank" rel="noopener">
                                <i class="fab fa-instagram fa-lg"></i>
                            </a>
                        <?php endif; ?>
                        
                        <?php if($youtubeUrl): ?>
                            <a href="<?php echo e($youtubeUrl); ?>" class="text-white me-3" aria-label="YouTube" target="_blank" rel="noopener">
                                <i class="fab fa-youtube fa-lg"></i>
                            </a>
                        <?php endif; ?>
                        
                        <?php if($twitterUrl): ?>
                            <a href="<?php echo e($twitterUrl); ?>" class="text-white" aria-label="Twitter" target="_blank" rel="noopener">
                                <i class="fab fa-twitter fa-lg"></i>
                            </a>
                        <?php endif; ?>
                        
                        <?php if(!$facebookUrl && !$instagramUrl && !$youtubeUrl && !$twitterUrl): ?>
                ...
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="<?php echo e(route('about.profile')); ?>" class="text-white-50 text-decoration-none">Profil
                                Sekolah</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('facilities.index')); ?>" class="text-white-50 text-decoration-none">Fasilitas</a>
                        </li>
                        <li class="mb-2"><a href="<?php echo e(route('public.achievements')); ?>" class="text-white-50 text-decoration-none">Prestasi</a>
                        </li>
                        <li class="mb-2"><a href="<?php echo e(route('public.extracurriculars.index')); ?>" class="text-white-50 text-decoration-none">Ekstrakurikuler</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="<?php echo e(route('public.academic.programs')); ?>" class="text-white-50 text-decoration-none">Program
                                Studi</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('academic.calendar')); ?>" class="text-white-50 text-decoration-none">Kalender</a>
                        </li>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <?php if($footerAddress): ?>
                        <p class="mb-2">
                            ...
                            <small><?php echo nl2br(e($footerAddress)); ?></small>
                        </p>
                    <?php endif; ?>
                    ...
                    <?php if($footerPhone): ?>
                        <p class="mb-2">
                            ...
                            <small><?php echo e($footerPhone); ?></small>
                        </p>
                    <?php endif; ?>
                    ...
                    <?php if($footerEmail): ?>
                        <p class="mb-0">
                            ...
                            <small><a href="mailto:<?php echo e($footerEmail); ?>" class="text-white-50 text-decoration-none"><?php echo e($footerEmail); ?></a></small>
                        </p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="mb-0">&copy; 2024 <?php echo e(\App\Models\Setting::get('school_name', 'SMK PGRI 2 PONOROGO')); ?>. All rights reserved.</p>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/layouts/public.blade.php ENDPATH**/ ?>