            ...
            <div class="card shadow-lg border-0" style="border-radius: 20px; backdrop-filter: blur(10px); background: rgba(255, 255, 255, 0.95);">
                <div class="card-body p-5 text-center">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-primary btn-lg px-4" style="border-radius: 25px;">
                            <i class="fas fa-home me-2"></i>
                            Kembali ke Beranda
                        </a>
                        <a href="<?php echo e(route('contact')); ?>" class="btn btn-primary btn-lg px-4" style="border-radius: 25px; background: linear-gradient(135deg, #667eea, #764ba2); border: none;">
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/auth/registration-pending.blade.php ENDPATH**/ ?>