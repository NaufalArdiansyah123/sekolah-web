        ...
        <div class="stats-grid">
            <div class="stat-card stat-primary" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="stat-content">
                    <div class="stat-number"><?php echo e($stats['total_posts'] ?? 0); ?></div>
                    <div class="stat-label">Total Post</div>
                    <div class="stat-sublabel"><?php echo e($stats['published_posts'] ?? 0); ?> dipublikasikan</div>
                </div>
            </div>
            ...
            <div class="stat-card stat-warning" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="stat-content">
                    <div class="stat-number"><?php echo e($recentActivities ? $recentActivities->count() : 0); ?></div>
            ...
            <div class="stat-card stat-info" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="stat-content">
                    <div class="stat-number"><?php echo e($stats['extracurriculars_managed'] ?? 0); ?></div>
                ...
                <div class="dashboard-card" data-aos="fade-right">
                    ...
                    <div class="card-body">
                        <div class="activity-timeline">
                            <?php if($recentActivities && $recentActivities->count() > 0): ?>
                                <?php $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="activity-item">
                                    <div class="activity-icon" style="background: linear-gradient(135deg, <?php echo e($activity['color']); ?>, <?php echo e($activity['color']); ?>dd);">
                            ...
                            <?php else: ?>
                                <div class="empty-state">
                                    ...
                                    <div class="mt-3">
                                        <a href="<?php echo e(route('teacher.posts.blog.create')); ?>" class="btn btn-primary btn-sm">
                ...
                <div class="dashboard-card" data-aos="fade-right" data-aos-delay="200">
                    <div class="card-header">
                        <div class="header-content">
                            ...
                            <a href="<?php echo e(route('teacher.learning.materials.create')); ?>" class="btn btn-sm btn-primary">
                    ...
                    <div class="card-body">
                        <div class="extracurricular-grid">
                            <?php if($learningMaterials && $learningMaterials->count() > 0): ?>
                                ...
                                <div class="extracurricular-item">
                                    <div class="extracurricular-header">
                                        <div class="extracurricular-icon">
                                            ...
                                            <?php elseif($material['type'] == 'powerpoint'): ?>
                                        ...
                                        <div class="extracurricular-info">
                                            <div class="extracurricular-name"><?php echo e($material['title']); ?></div>
                                            <div class="extracurricular-desc"><?php echo e($material['description']); ?></div>
                                        </div>
                                    </div>
                                    <div class="extracurricular-stats">
                                        <div class="stat-item">
                                            <?php if($material['type'] == 'video'): ?>
                                                ...
                                                <span><?php echo e($material['downloads']); ?> views</span>
                                            <?php else: ?>
                                                <i class="fas fa-download me-1"></i>
                                                <span><?php echo e($material['downloads']); ?> unduhan</span>
                                            <?php endif; ?>
                                        </div>
                                        <div class="stat-item">
                                            <i class="fas fa-calendar me-1"></i>
                                            <span><?php echo e($material['created_at']->diffForHumans()); ?></span>
                                        </div>
                                    </div>
                                    <div class="extracurricular-actions">
                                        <a href="<?php echo e(route('teacher.learning.materials.index')); ?>" class="btn btn-sm btn-primary">
                                            <i class="fas fa-edit me-1"></i>Edit
                                        </a>
                                        <a href="<?php echo e(route('teacher.learning.materials.index')); ?>" class="btn btn-sm btn-outline-secondary">
                            ...
                            <?php else: ?>
                                <div class="empty-state">
                                    ...
                                    <div class="mt-3">
                                        <a href="<?php echo e(route('teacher.learning.materials.create')); ?>" class="btn btn-primary btn-sm">
                        ...
                        <div class="text-center" style="margin-top: 1rem;">
                            <a href="<?php echo e(route('teacher.learning.materials.index')); ?>" class="btn btn-outline-primary btn-sm">
                ...
                <div class="dashboard-card" data-aos="fade-right" data-aos-delay="400">
                    <div class="card-header">
                        <div class="header-content">
                            ...
                            <span class="badge bg-warning"><?php echo e($assignmentsToGrade ? $assignmentsToGrade->count() : 0); ?></span>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="registration-list">
                            <?php if($assignmentsToGrade && $assignmentsToGrade->count() > 0): ?>
                                <?php $__currentLoopData = $assignmentsToGrade; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="registration-item">
                                    <div class="registration-avatar">
                                        <div class="avatar-img d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, <?php echo e($assignment['color']); ?>, <?php echo e($assignment['color']); ?>dd); color: white; font-weight: bold;">
                                            <?php echo e($assignment['initials']); ?>

                                        </div>
                                    </div>
                                    <div class="registration-info">
                                        <div class="registration-name"><?php echo e($assignment['student_name']); ?></div>
                                        <div class="registration-email">Tugas: <?php echo e($assignment['assignment_title']); ?></div>
                                        <div class="registration-extracurricular">
                                            <i class="fas fa-clock me-1"></i>Dikumpulkan <?php echo e($assignment['submitted_at']->diffForHumans()); ?>

                                        </div>
                                    </div>
                                    <div class="registration-actions">
                                        <a href="<?php echo e(route('teacher.assignments.show', $assignment['assignment_id'])); ?>" class="btn btn-sm btn-primary" title="Nilai">
                                            <i class="fas fa-star"></i>
                                        </a>
                                        <a href="<?php echo e(route('teacher.assignments.show', $assignment['assignment_id'])); ?>" class="btn btn-sm btn-outline-secondary" title="Lihat">
                            ...
                            <?php else: ?>
                                <div class="empty-state">
                                    ...
                                    <div class="mt-3">
                                        <a href="<?php echo e(route('teacher.assignments.create')); ?>" class="btn btn-primary btn-sm">
                        ...
                        <div class="text-center" style="margin-top: 1rem;">
                            <a href="<?php echo e(route('teacher.assignments.index')); ?>" class="btn btn-outline-primary btn-sm me-2">
                                <i class="fas fa-eye me-1"></i>Lihat Semua Tugas
                            </a>
                            <a href="<?php echo e(route('teacher.grades.index')); ?>" class="btn btn-outline-success btn-sm">
                ...
                <div class="dashboard-card" data-aos="fade-left">
                    ...
                    <div class="card-body">
                        <div class="quick-actions-grid" style="grid-template-columns: repeat(3, 1fr); gap: 0.75rem;">
                            <a href="<?php echo e(route('teacher.posts.blog.create')); ?>" class="quick-action-btn primary">
                            ...
                            <a href="<?php echo e(route('teacher.learning.materials.create')); ?>" class="quick-action-btn success">
                                <div class="action-icon">
                            ...
                            <a href="<?php echo e(route('teacher.assignments.create')); ?>" class="quick-action-btn info">
                                <div class="action-icon">
                            ...
                            <a href="<?php echo e(route('teacher.students.index')); ?>" class="quick-action-btn warning">
                                <div class="action-icon">
                                    <i class="fas fa-users"></i>
                                </div>
                                <div class="action-text">
                            ...
                            <a href="<?php echo e(route('teacher.grades.index')); ?>" class="quick-action-btn primary">
                                <div class="action-icon">
                            ...
                            <a href="<?php echo e(route('teacher.attendance.index')); ?>" class="quick-action-btn success">
                                <div class="action-icon">
                ...
                <div class="dashboard-card" data-aos="fade-left" data-aos-delay="100">
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            <!-- Learning Management -->
                            <div class="col-6">
                                <a href="<?php echo e(route('teacher.learning.materials.index')); ?>" class="main-menu-card text-decoration-none d-block h-100">
                            ...
                            <!-- Assignments -->
                            <div class="col-6">
                                <a href="<?php echo e(route('teacher.assignments.index')); ?>" class="main-menu-card text-decoration-none d-block h-100">
                                    <div class="card-body text-center p-4">
                            ...
                            <!-- Quizzes -->
                            <div class="col-6">
                                <a href="<?php echo e(route('teacher.quizzes.index')); ?>" class="main-menu-card text-decoration-none d-block h-100">
                                    <div class="card-body text-center p-4">
                            ...
                            <!-- Daily Tests -->
                            <div class="col-6">
                                <a href="<?php echo e(route('teacher.daily-tests.index')); ?>" class="main-menu-card text-decoration-none d-block h-100">
                                    <div class="card-body text-center p-4">
                        ...
                        <div class="content-management-section mt-4">
                            ...
                            <div class="row g-3">
                                <div class="col-6">
                                    <a href="<?php echo e(route('teacher.posts.blog.index')); ?>" class="content-btn w-100">
                                        <i class="fas fa-blog"></i>
                                        <span>Blog Post</span>
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="<?php echo e(route('teacher.posts.announcement')); ?>" class="content-btn w-100">
                ...
                <div class="dashboard-card" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <div class="card-body">
                        <div class="agenda-timeline">
                            <?php if($upcomingAgenda && $upcomingAgenda->count() > 0): ?>
                                <?php $__currentLoopData = $upcomingAgenda; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="agenda-item">
                                    <div class="agenda-date">
                                        <div class="date-day"><?php echo e($agenda->tanggal->format('d')); ?></div>
                                        <div class="date-month"><?php echo e($agenda->tanggal->format('M')); ?></div>
                                    </div>
                                    <div class="agenda-content">
                                        <div class="agenda-title"><?php echo e($agenda->judul); ?></div>
                                        <div class="agenda-details">
                                            <?php if($agenda->waktu): ?>
                                            <p class="agenda-time">
                                                <i class="fas fa-clock me-1"></i>
                                                <?php echo e($agenda->waktu); ?>
                ...
                <div class="dashboard-card" data-aos="fade-left" data-aos-delay="400">
                    <div class="card-header">
                        <div class="header-content">
                            ...
                            <a href="<?php echo e(route('teacher.posts.announcement')); ?>" class="btn btn-sm btn-outline-primary">
                    ...
                    <div class="card-body">
                        <div class="announcement-list">
                            <?php if($recentAnnouncements && $recentAnnouncements->count() > 0): ?>
                                ...
                                <div class="announcement-item">
                                    ...
                                    <div class="announcement-content">
                                        ...
                                        <div class="announcement-excerpt">
                                            <?php echo e(Str::limit(strip_tags($announcement->content), 100)); ?>
                            ...
                            <?php else: ?>
                                <div class="empty-state">
                                    ...
                                    <div class="mt-3">
                                        <a href="<?php echo e(route('teacher.posts.announcement.create')); ?>" class="btn btn-primary btn-sm">
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/teacher/dashboard.blade.php ENDPATH**/ ?>