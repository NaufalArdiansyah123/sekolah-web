            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="stats-card card h-100 shadow-sm fade-in-up">
                    <div class="card-body p-4">
                        ...
                        <h2 class="stats-number display-4 fw-bold text-primary mb-2" data-target="<?php echo e($totalAgenda); ?>">0</h2>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="stats-card card h-100 shadow-sm fade-in-up" style="animation-delay: 0.2s;">
                    <div class="card-body p-4">
                        ...
                        <h2 class="stats-number display-4 fw-bold text-warning mb-2" data-target="<?php echo e($upcomingAgenda); ?>">0</h2>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="stats-card card h-100 shadow-sm fade-in-up" style="animation-delay: 0.4s;">
                    <div class="card-body p-4">
                        ...
                        <h2 class="stats-number display-4 fw-bold text-success mb-2" data-target="<?php echo e($todayAgenda); ?>">0</h2>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="stats-card card h-100 shadow-sm fade-in-up" style="animation-delay: 0.6s;">
                    <div class="card-body p-4">
                        ...
                        <h2 class="stats-number display-4 fw-bold text-info mb-2" data-target="<?php echo e($agendaWithLocation); ?>">0</h2>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="filter-section fade-in-up">
            ...
            <form method="GET" action="<?php echo e(route('agenda.index')); ?>" id="filterForm">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <select name="period" class="form-control form-control-enhanced" onchange="handlePeriodChange()">
                            ...
                            <option value="upcoming" <?php echo e(request('period') == 'upcoming' ? 'selected' : ''); ?>>Mendatang</option>
                            <option value="today" <?php echo e(request('period') == 'today' ? 'selected' : ''); ?>>Hari Ini</option>
                            <option value="this_week" <?php echo e(request('period') == 'this_week' ? 'selected' : ''); ?>>Minggu Ini</option>
                            <option value="this_month" <?php echo e(request('period') == 'this_month' ? 'selected' : ''); ?>>Bulan Ini</option>
                        ...
                        <select name="month" class="form-control form-control-enhanced">
                            ...
                            <?php for($i = 1; $i <= 12; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e(request('month') == $i ? 'selected' : ''); ?>>
                                    <?php echo e(\Carbon\Carbon::create()->month($i)->locale('id')->format('F')); ?>
                ...
                <?php if(request()->hasAny(['search', 'period', 'month', 'year'])): ?>
                    <div class="mt-3">
                        <small class="text-muted">Filter aktif:</small>
                        <div class="d-flex flex-wrap gap-2 mt-2">
                            <?php if(request('search')): ?>
                                <span class="badge bg-primary">Pencarian: "<?php echo e(request('search')); ?>"</span>
                            <?php endif; ?>
                            <?php if(request('period')): ?>
                                <span class="badge bg-success">Periode: <?php echo e(ucfirst(str_replace('_', ' ', request('period')))); ?></span>
                            <?php endif; ?>
                            <?php if(request('month')): ?>
                                <span class="badge bg-info">Bulan: <?php echo e(\Carbon\Carbon::create()->month(request('month'))->locale('id')->format('F')); ?></span>
                            <?php endif; ?>
                            <?php if(request('year')): ?>
                                <span class="badge bg-warning">Tahun: <?php echo e(request('year')); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endif; ?>
        ...
        <?php if($agendas->count() > 0): ?>
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="mb-0">Ditemukan <?php echo e($agendas->total()); ?> agenda</h4>
                    <small class="text-muted">Menampilkan <?php echo e($agendas->firstItem()); ?>-<?php echo e($agendas->lastItem()); ?> dari <?php echo e($agendas->total()); ?> agenda</small>
                </div>
                <div class="d-flex align-items-center gap-3">
                    ...
                    <select name="sort" class="form-control form-control-enhanced" style="width: auto;" onchange="handleSortChange(this.value)">
                        ...
                        <option value="date_asc" <?php echo e(request('sort') == 'date_asc' ? 'selected' : ''); ?>>Tanggal (Terdekat)</option>
                        <option value="date_desc" <?php echo e(request('sort') == 'date_desc' ? 'selected' : ''); ?>>Tanggal (Terjauh)</option>
        ...
        <?php if($agendas->count() > 0): ?>
            <div class="row">
                <div class="col-12">
                    <?php $__currentLoopData = $agendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="agenda-card fade-in-up" style="animation-delay: <?php echo e($index * 0.1); ?>s;">
                            <!-- Date Badge -->
                            <div class="agenda-date-badge">
                                <div class="agenda-day"><?php echo e($agenda->event_date ? $agenda->event_date->format('d') : '?'); ?></div>
                                <div class="agenda-month"><?php echo e($agenda->event_date ? $agenda->event_date->format('M') : 'TBD'); ?></div>
                            </div>
                            
                            <!-- Content -->
                            <div class="agenda-content">
                                <h3 class="agenda-title"><?php echo e($agenda->title); ?></h3>
                                
                                <div class="agenda-meta">
                                    <?php if($agenda->event_date): ?>
                                        <div class="agenda-meta-item">
                                            <i class="fas fa-clock text-primary"></i>
                                            <span><?php echo e($agenda->event_date->format('H:i')); ?> WIB</span>
                                        </div>
                                        <div class="agenda-meta-item">
                                            <i class="fas fa-calendar text-success"></i>
                                            <span><?php echo e($agenda->event_date->format('l, d F Y')); ?></span>
                                        </div>
                                    <?php endif; ?>
                                ...
                                <?php if($agenda->content): ?>
                                    <div class="agenda-description">
                                        <?php echo Str::limit(strip_tags($agenda->content), 200); ?>

                                    </div>
                                <?php endif; ?>
                                
                                <div class="agenda-actions">
                                    <a href="<?php echo e(route('agenda.show', $agenda->id)); ?>" class="btn-agenda btn-primary-agenda">
                                        <i class="fas fa-eye"></i>
                                        Lihat Detail
                                    </a>
                                    
                                    <?php if($agenda->event_date): ?>
                                        <?php if($agenda->event_date->isToday()): ?>
                                            <span class="status-badge status-today">Hari Ini</span>
                                        <?php elseif($agenda->event_date->isFuture()): ?>
            ...
            <div class="d-flex justify-content-center mt-5">
                <?php echo e($agendas->appends(request()->query())->links()); ?>
        ...
        <?php else: ?>
            ...
            <div class="empty-state fade-in-up">
                ...
                <a href="<?php echo e(route('agenda.index')); ?>" class="btn btn-filter">
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/public/agenda/index.blade.php ENDPATH**/ ?>