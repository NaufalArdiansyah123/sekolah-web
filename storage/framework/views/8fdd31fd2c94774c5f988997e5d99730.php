...
<div class="space-y-6">
    ...
    <div class="upload-container">
        <form method="POST" action="<?php echo e(route('admin.videos.store')); ?>" enctype="multipart/form-data" id="uploadForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="file-upload-area" id="fileUploadArea">
                    ...
                    <div class="file-upload-content">
                        ...
                        <div class="file-upload-hint">
                            ...
                            <strong>Max: <?php echo e(ini_get('upload_max_filesize')); ?> per file, <?php echo e(ini_get('post_max_size')); ?> total</strong>
                        </div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <textarea name="description" 
                          ...
                          placeholder="Masukkan deskripsi video (opsional)"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/videos/create.blade.php ENDPATH**/ ?>