...
<div class="space-y-6">
    ...
    <form action="<?php echo e(route('teacher.quizzes.update', $quiz->id)); ?>" method="POST" id="quiz-form">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="subject" 
                               name="subject" 
                               value="<?php echo e(old('subject', $quiz->subject)); ?>"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-colors"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" 
                               id="start_time" 
                               name="start_time" 
                               value="<?php echo e(old('start_time', $quiz->start_time->format('Y-m-d\TH:i'))); ?>"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-colors"
                               required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" 
                               id="end_time" 
                               name="end_time" 
                               value="<?php echo e(old('end_time', $quiz->end_time->format('Y-m-d\TH:i'))); ?>"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-colors"
                               required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="max_attempts" 
                                ...
                                required>
                            <?php for($i = 1; $i <= 10; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e(old('max_attempts', $quiz->max_attempts) == $i ? 'selected' : ''); ?>>
                                    <?php echo e($i); ?> kali
                                </option>
                            <?php endfor; ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" 
                                  ...
                                  rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-colors"
                                  placeholder="Deskripsi singkat tentang kuis ini"><?php echo e(old('description', $quiz->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="instructions" 
                                  ...
                                  rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white transition-colors"
                                  placeholder="Instruksi khusus untuk mengerjakan kuis ini"><?php echo e(old('instructions', $quiz->instructions)); ?></textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       name="show_results" 
                                       value="1"
                                       <?php echo e(old('show_results', $quiz->show_results) ? 'checked' : ''); ?>
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    Kelola Soal (<?php echo e($quiz->questions->count()); ?>)
                </h3>
                <button type="button" 
                        onclick="addQuestion()" 
        ...
        <div class="p-6">
            <div id="questions-container" class="space-y-6">
                <?php $__currentLoopData = $quiz->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="question-item p-6" data-question-index="<?php echo e($index); ?>">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <button type="button" 
                                    onclick="removeQuestion(<?php echo e($index); ?>)" 
                        ...
                        <div class="mb-4">
                            ...
                            <select name="questions[<?php echo e($index); ?>][type]" 
                                    ...
                                    onchange="updateQuestionType(<?php echo e($index); ?>, this.value)">
                                <option value="multiple_choice" <?php echo e($question->type === 'multiple_choice' ? 'selected' : ''); ?>>Pilihan Ganda</option>
                                <option value="true_false" <?php echo e($question->type === 'true_false' ? 'selected' : ''); ?>>Benar/Salah</option>
                                <option value="essay" <?php echo e($question->type === 'essay' ? 'selected' : ''); ?>>Essay</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="questions[<?php echo e($index); ?>][question]" 
                                      rows="3"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" 
                                   ...
                                   value="<?php echo e($question->points); ?>"
                                   min="1" 
                                   max="100"
                        ...
                        <?php if($question->type === 'multiple_choice'): ?>
                            <div class="options-container mb-4">
                                ...
                                <div class="space-y-3">
                                    <?php $__currentLoopData = ['A', 'B', 'C', 'D']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center space-x-3">
                                            <input type="radio" 
                                                   name="questions[<?php echo e($index); ?>][correct_answer]" 
                                                   value="<?php echo e($optionKey); ?>"
                                                   <?php echo e($question->correct_answer === $optionKey ? 'checked' : ''); ?>
                                            ...
                                            <span class="w-8 h-8 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center text-sm font-medium">
                                                <?php echo e($optionKey); ?>

                                            </span>
                                            <input type="text" 
                                                   name="questions[<?php echo e($index); ?>][options][<?php echo e($optionKey); ?>]" 
                                                   value="<?php echo e($question->options[$optionKey] ?? ''); ?>"
                                                   ...
                                                   placeholder="Masukkan pilihan <?php echo e($optionKey); ?>"
                                                   required>
                                        </div>
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        <input type="radio" 
                                               name="questions[<?php echo e($index); ?>][correct_answer]" 
                                               value="true"
                                               <?php echo e($question->correct_answer === 'true' ? 'checked' : ''); ?>
                                    ...
                                    <div class="flex items-center">
                                        <input type="radio" 
                                               name="questions[<?php echo e($index); ?>][correct_answer]" 
                                               value="false"
                                               <?php echo e($question->correct_answer === 'false' ? 'checked' : ''); ?>
                        ...
                        <?php else: ?>
                            <div class="options-container mb-4">
                                ...
                                <input type="hidden" name="questions[<?php echo e($index); ?>][correct_answer]" value="manual">
                            </div>
                        <?php endif; ?>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/teacher/quizzes/edit.blade.php ENDPATH**/ ?>