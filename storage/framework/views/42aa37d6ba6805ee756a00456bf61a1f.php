...
<div class="student-sidebar-nav w-full h-full flex flex-col student-sidebar-content">
    ...
    <div class="student-nav-section flex-1">
        ...
        <a href="<?php echo e(route('student.materials.popular')); ?>" 
           class="student-sidebar-nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('student.materials.popular') ? 'active' : ''); ?>"
           @click="isMobile && (sidebarOpen = false)">
            <svg class="student-nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="<?php echo e(route('student.materials.recent')); ?>" 
           class="student-sidebar-nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('student.materials.recent') ? 'active' : ''); ?>"
           @click="isMobile && (sidebarOpen = false)">
            <svg class="student-nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="<?php echo e(route('student.attendance.index')); ?>" 
           class="student-sidebar-nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('student.attendance*') ? 'active' : ''); ?>"
           @click="isMobile && (sidebarOpen = false)">
            <svg class="student-nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="<?php echo e(route('student.grades.index')); ?>" 
           class="student-sidebar-nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('student.grades*') ? 'active' : ''); ?>"
           @click="isMobile && (sidebarOpen = false)">
            <svg class="student-nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Pencarian Materi -->
        <a href="<?php echo e(route('student.materials.search')); ?>" 
           class="student-sidebar-nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg <?php echo e(request()->routeIs('student.materials.search') ? 'active' : ''); ?>"
           @click="isMobile && (sidebarOpen = false)">
            <svg class="student-nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
