                            ...
                            <div class="relative" x-data="{ open: false }">
                                <button @click="open = !open" 
                                    ...
                                    <div class="hidden md:block text-left">
                                        <p class="text-sm font-medium" style="color: var(--text-primary);"><?php echo e(auth()->user()->name ?? 'Administrator'); ?></p>
                                        <p class="text-xs" style="color: var(--text-secondary);"><?php echo e(auth()->user()->email ?? ''); ?></p>
                                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/layouts/admin/app.blade.php ENDPATH**/ ?>