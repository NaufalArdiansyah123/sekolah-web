...
<div class="teacher-container">
    ...
    <div class="stats-container">
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e($teachers->total()); ?></div>
        ...
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e($teachers->where('status', 'active')->count()); ?></div>
        ...
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e($teachers->where('status', 'inactive')->count()); ?></div>
        ...
        <div class="stat-item">
            ...
            <div class="stat-value"><?php echo e($teachers->pluck('subject')->unique()->count()); ?></div>
    ...
    <div class="filters-container">
        ...
        <form method="GET" action="<?php echo e(route('admin.teachers.index')); ?>">
            <div class="filters-row">
                ...
                <div class="filter-group">
                    ...
                    <select name="subject" class="filter-input">
                        ...
                        <?php $__currentLoopData = $teachers->pluck('subject')->unique()->sort(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="filter-group">
                    ...
                    <div style="display: flex; gap: 0.5rem;">
                        ...
                        <a href="<?php echo e(route('admin.teachers.index')); ?>" class="btn-reset">Reset</a>
                    </div>
                </div>
            </div>
        </form>
            ...
            <div class="teacher-card">
                ...
                <div class="card-body">
                    ...
                    <div class="subject-tags">
                        <?php $__currentLoopData = explode(',', $teacher->subject); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="subject-tag"><?php echo e(trim($subject)); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>

                    <div class="card-actions">
                        <a href="<?php echo e(route('admin.teachers.edit', $teacher->id)); ?>" class="action-btn btn-edit">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/>
                            </svg>
                            Edit
                        </a>
                        <form action="<?php echo e(route('admin.teachers.destroy', $teacher->id)); ?>" method="POST" style="flex: 1;" class="delete-form">
                            <?php echo csrf_field(); ?>
        ...
        <?php else: ?>
            ...
            <div class="empty-state">
                ...
                <p class="empty-description">
                    <?php if(request()->hasAny(['search', 'status', 'subject'])): ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('admin.teachers.index')); ?>" class="btn-reset">
                        Clear Filters
                    </a>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sekolah-web\resources\views/admin/teachers/index.blade.php ENDPATH**/ ?>