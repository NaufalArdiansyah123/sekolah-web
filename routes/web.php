...
Route::get('/facilities', function() {
    try {
        ...
        $query = App\Models\Facility::active();
        ...
        // If no facilities found, create sample data
        if ($facilities->isEmpty()) {
            $facilities = collect([
                (object) [
                    'id' => 1,
                    'name' => 'Laboratorium Komputer',
                    'description' => 'Laboratorium komputer modern dengan 40 unit PC terbaru, dilengkapi dengan software programming dan design terkini.',
                    'category' => 'technology',
                    'status' => 'active',
                    'capacity' => 40,
                    'location' => 'Lantai 2, Gedung A',
                    'is_featured' => true,
                    'image' => 'laboratorium-komputer.svg',
                    'image_url' => asset('storage/facilities/laboratorium-komputer.svg'),
                    'category_label' => 'Teknologi'
                ],
                (object) [
                    'id' => 2,
                    'name' => 'Perpustakaan Digital',
                    'description' => 'Perpustakaan modern dengan koleksi buku digital dan fisik yang lengkap, ruang baca yang nyaman.',
                    'category' => 'academic',
                    'status' => 'active',
                    'capacity' => 100,
                    'location' => 'Lantai 1, Gedung B',
                    'is_featured' => true,
                    'image' => 'perpustakaan-digital.svg',
                    'image_url' => asset('storage/facilities/perpustakaan-digital.svg'),
                    'category_label' => 'Akademik'
                ],
                (object) [
                    'id' => 3,
                    'name' => 'Lapangan Basket',
                    'description' => 'Lapangan basket outdoor dengan standar internasional, dilengkapi dengan ring basket berkualitas.',
                    'category' => 'sport',
                    'status' => 'active',
                    'capacity' => 200,
                    'location' => 'Area Olahraga',
                    'is_featured' => false,
                    'image' => 'lapangan-basket.svg',
                    'image_url' => asset('storage/facilities/lapangan-basket.svg'),
                    'category_label' => 'Olahraga'
                ],
                (object) [
                    'id' => 4,
                    'name' => 'Studio Musik',
                    'description' => 'Studio musik dengan peralatan lengkap untuk pembelajaran seni musik, termasuk piano, gitar, drum set.',
                    'category' => 'arts',
                    'status' => 'active',
                    'capacity' => 25,
                    'location' => 'Lantai 1, Gedung C',
                    'is_featured' => true,
                    'image' => 'studio-musik.svg',
                    'image_url' => asset('storage/facilities/studio-musik.svg'),
                    'category_label' => 'Seni & Budaya'
                ],
                (object) [
                    'id' => 5,
                    'name' => 'Aula Serbaguna',
                    'description' => 'Aula besar yang dapat digunakan untuk berbagai kegiatan seperti seminar, pertunjukan seni, upacara.',
                    'category' => 'other',
                    'status' => 'active',
                    'capacity' => 500,
                    'location' => 'Gedung Utama',
                    'is_featured' => true,
                    'image' => 'aula-serbaguna.svg',
                    'image_url' => asset('storage/facilities/aula-serbaguna.svg'),
        ...
        $stats = [
            ...
            'academic_facilities' => $facilities->where('category', 'academic')->count(),
            'sport_facilities' => $facilities->where('category', 'sport')->count(),
            'technology_facilities' => $facilities->where('category', 'technology')->count(),
        ];
        ...
        return view('public.facilities.index-simple', compact(
            'facilities',
            'stats',
            'categories'
        ));
        ...
        // If table doesn't exist or other critical error, return sample data
        $facilities = collect([
            (object) [
                'id' => 1,
                'name' => 'Laboratorium Komputer',
                'description' => 'Laboratorium komputer modern dengan fasilitas terkini untuk pembelajaran teknologi.',
                'category' => 'technology',
                'status' => 'active',
                'capacity' => 40,
                'image' => null,
                'image_url' => asset('images/default-facility.svg'),
                'category_label' => 'Teknologi'
            ],
            (object) [
                'id' => 2,
        ...
        $stats = [
            'total_facilities' => 2,
            'academic_facilities' => 1,
            'sport_facilities' => 0,
            'technology_facilities' => 1,
        ];
...
Route::get('/facilities/{facility}', [App\Http\Controllers\Public\FacilityController::class, 'show'])->name('facilities.show');
Route::get('/api/facilities/category', [App\Http\Controllers\Public\FacilityController::class, 'getByCategory'])->name('api.facilities.category');
Route::get('/api/facilities/search', [App\Http\Controllers\Public\FacilityController::class, 'search'])->name('api.facilities.search');
