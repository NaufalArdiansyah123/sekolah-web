...
class SimpleBlogSeeder extends Seeder
{
    ...
    {
        $this->command->info('🚀 Starting Simple Blog Seeder...');

        // Get or create user
        $userId = DB::table('users')->first()->id ?? $this->createUser();

        // Clear existing blog posts
        DB::table('blog_posts')->truncate();
        $this->command->info('🗑️ Cleared existing blog posts');
...
"Kurikulum Merdeka memberikan ruang yang lebih luas bagi guru untuk berinovasi dalam pembelajaran. Siswa juga lebih termotivasi karena bisa belajar sesuai passion mereka," ungkap Kepala Sekolah.',
        ...
        $this->command->info("🎉 Successfully created " . count($blogPosts) . " blog posts!");
